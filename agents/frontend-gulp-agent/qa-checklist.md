...
- [ ] **Style scale gate (mandatory):** compact `--pad-*` scale reused; no selector-specific spacing tokens; no alias chains; physical padding/margin — [universal-style-scale-law-v1.md](../../projects/mars-website-factory/universal-style-scale-law-v1.md). REPORT: `STYLE SCALE GATE — PASS | FAIL | SAFE UNKNOWN`.
