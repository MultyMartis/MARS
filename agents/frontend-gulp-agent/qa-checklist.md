...
- [ ] **JS hook gate:** behavior via `data-*` only when JS exists — [data-attribute-js-hook-law-v1.md](../../projects/mars-website-factory/data-attribute-js-hook-law-v1.md). REPORT: `JS HOOK GATE — PASS | FAIL | NOT APPLICABLE`.
