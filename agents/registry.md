...
| `wordpress_implementation_agent` | WordPress Implementation Agent (`AG-WP-001`) | draft | mars_website_factory | Forge WordPress / Agent Layer | [../projects/mars-website-factory/subsystems/forge-wordpress/agents/AG-WP-001-WORDPRESS-IMPLEMENTATION-AGENT-CARD-v1.md](../projects/mars-website-factory/subsystems/forge-wordpress/agents/AG-WP-001-WORDPRESS-IMPLEMENTATION-AGENT-CARD-v1.md) | [cards/wordpress-implementation-agent-v1.md](cards/wordpress-implementation-agent-v1.md); [agents pack](../projects/mars-website-factory/subsystems/forge-wordpress/agents/README.md). **Meaning:** controlled WordPress implementation agent — explicit contracts, typed ops (contract level), validation gates, human approval; **inherits** [FORGE-WORDPRESS-IMPLEMENTATION-SPECIALIST-v1.md](../projects/mars-website-factory/subsystems/forge-wordpress/capability/primary-specialist/FORGE-WORDPRESS-IMPLEMENTATION-SPECIALIST-v1.md) for Cursor execution; **not** autonomous runtime, **not** production authority, **not** `active`. Pilot: FP-0002 **BLOCKED** until Production Pass + FW-06B. Registered FW-07A. |
