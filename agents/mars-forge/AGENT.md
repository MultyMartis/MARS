...
- **Rhythm governance** — typography cadence and vertical section rhythm must remain deterministic per [`rhythm-governance-checklist.md`](rhythm-governance-checklist.md); record `RHYTHM FINDINGS`, not silent random line-height / spacing fixes.  
