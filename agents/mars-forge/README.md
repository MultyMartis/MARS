...
| [`rhythm-governance-checklist.md`](rhythm-governance-checklist.md) | **Rhythm governance** — typography cadence, **RU no word-splitting**, section spacing, density continuity, CTA/mobile rhythm; records `RHYTHM FINDINGS` ([typography](../../projects/mars-website-factory/typography-rhythm-governance.md), [RU word-splitting](../../projects/mars-website-factory/russian-no-word-splitting-typography-v1.md), [vertical](../../projects/mars-website-factory/vertical-rhythm-governance.md)) |
