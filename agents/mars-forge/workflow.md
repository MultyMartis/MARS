...
**RU commercial landings:** RU typography governance always in scope — use [ru-landing-qa-preset-v1.md](../../projects/mars-website-factory/ru-landing-qa-preset-v1.md); Lite flow cannot skip typography validation.
...
| **Validation** | Spot widths (e.g. 375 / 768 / 1280) or documented defaults — **supplementary generic responsive validation only**; **RU commercial:** [ru-landing-qa-preset-v1.md](../../projects/mars-website-factory/ru-landing-qa-preset-v1.md) mandatory; overflow; tap targets; responsive intent preservation when source exists |
