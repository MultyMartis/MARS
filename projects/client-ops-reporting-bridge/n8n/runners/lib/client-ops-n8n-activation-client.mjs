...
const D1_ACTIVATE_CONFIRM = 'ACTIVATE CLIENT OPS DURABLE DEDUPE TEST BZPM';
const D1_DEACTIVATE_CONFIRM = 'DEACTIVATE CLIENT OPS DURABLE DEDUPE TEST BZPM';
const D3_ACTIVATE_CONFIRM = 'ACTIVATE CLIENT OPS CONTROLLED PRODUCER TEST D3 BZPM';
const D3_DEACTIVATE_CONFIRM = 'DEACTIVATE CLIENT OPS CONTROLLED PRODUCER TEST D3 BZPM';
const D3_EMERGENCY_DEACTIVATE_CONFIRM =
  'EMERGENCY DEACTIVATE CLIENT OPS PRODUCER D3 BZPM';
const D5_ACTIVATE_CONFIRM = 'ACTIVATE CLIENT OPS MANUAL REAL SOURCE D5 BZPM';
const D5_DEACTIVATE_CONFIRM = 'DEACTIVATE CLIENT OPS MANUAL REAL SOURCE D5 BZPM';
const D5_EMERGENCY_DEACTIVATE_CONFIRM =
  'EMERGENCY DEACTIVATE CLIENT OPS MANUAL REAL SOURCE D5 BZPM';
const D6A2_ACTIVATE_CONFIRM =
  'ACTIVATE CLIENT OPS D6A2 DELIVERY LEDGER SYNTHETIC BZPM';
const D6A2_DEACTIVATE_CONFIRM =
  'DEACTIVATE CLIENT OPS D6A2 DELIVERY LEDGER SYNTHETIC BZPM';
const D6A2_EMERGENCY_DEACTIVATE_CONFIRM =
  'EMERGENCY DEACTIVATE CLIENT OPS D6A2 DELIVERY LEDGER BZPM';
const D6C_ACTIVATE_CONFIRM =
  'ACTIVATE CLIENT OPS D6C BOUNDED LIFECYCLE BZPM';
const D6C_DEACTIVATE_CONFIRM =
  'DEACTIVATE CLIENT OPS D6C BOUNDED LIFECYCLE BZPM';
const D6C_EMERGENCY_DEACTIVATE_CONFIRM =
...
export async function activateAllowlistedWorkflow(creds, confirm) {
  if (
    confirm !== ACTIVATE_CONFIRM &&
    confirm !== C1_ACTIVATE_CONFIRM &&
    confirm !== D1_ACTIVATE_CONFIRM &&
    confirm !== D3_ACTIVATE_CONFIRM &&
    confirm !== D5_ACTIVATE_CONFIRM &&
    confirm !== D6A2_ACTIVATE_CONFIRM &&
    confirm !== D6C_ACTIVATE_CONFIRM
  ) {
...
export async function deactivateAllowlistedWorkflow(creds, confirm) {
  if (
    ...
    confirm !== C1_DEACTIVATE_CONFIRM &&
    confirm !== D1_DEACTIVATE_CONFIRM &&
    confirm !== D3_DEACTIVATE_CONFIRM &&
    confirm !== D3_EMERGENCY_DEACTIVATE_CONFIRM &&
    confirm !== D5_DEACTIVATE_CONFIRM &&
    confirm !== D5_EMERGENCY_DEACTIVATE_CONFIRM &&
    confirm !== D6A2_DEACTIVATE_CONFIRM &&
    confirm !== D6A2_EMERGENCY_DEACTIVATE_CONFIRM &&
    confirm !== D6C_DEACTIVATE_CONFIRM &&
    confirm !== D6C_EMERGENCY_DEACTIVATE_CONFIRM
  ) {
...
export const D1_ACTIVATION_CONFIRM_PHRASE = D1_ACTIVATE_CONFIRM;
export const D1_DEACTIVATION_CONFIRM_PHRASE = D1_DEACTIVATE_CONFIRM;
export const D3_ACTIVATION_CONFIRM_PHRASE = D3_ACTIVATE_CONFIRM;
export const D3_DEACTIVATION_CONFIRM_PHRASE = D3_DEACTIVATE_CONFIRM;
export const D3_EMERGENCY_DEACTIVATION_CONFIRM_PHRASE =
  D3_EMERGENCY_DEACTIVATE_CONFIRM;
export const D5_ACTIVATION_CONFIRM_PHRASE = D5_ACTIVATE_CONFIRM;
export const D5_DEACTIVATION_CONFIRM_PHRASE = D5_DEACTIVATE_CONFIRM;
export const D5_EMERGENCY_DEACTIVATION_CONFIRM_PHRASE =
  D5_EMERGENCY_DEACTIVATE_CONFIRM;
export const D6A2_ACTIVATION_CONFIRM_PHRASE = D6A2_ACTIVATE_CONFIRM;
export const D6A2_DEACTIVATION_CONFIRM_PHRASE = D6A2_DEACTIVATE_CONFIRM;
export const D6A2_EMERGENCY_DEACTIVATION_CONFIRM_PHRASE =
  D6A2_EMERGENCY_DEACTIVATE_CONFIRM;
export const D6C_ACTIVATION_CONFIRM_PHRASE = D6C_ACTIVATE_CONFIRM;
export const D6C_DEACTIVATION_CONFIRM_PHRASE = D6C_DEACTIVATE_CONFIRM;
export const D6C_EMERGENCY_DEACTIVATION_CONFIRM_PHRASE =
  D6C_EMERGENCY_DEACTIVATE_CONFIRM;
