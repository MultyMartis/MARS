...
**Evidence cutoff:** 2026-07-23/24 (SITE-002 Run **4.298** / `SITE-002-PROD-ELEKTROMEHANICHESKOE-CATEGORY-IMAGE-APPLY-01` — category **375** tile image live; prior Run **4.297** importer patch still awaiting post-import persistence check; baseline still **1737**)
