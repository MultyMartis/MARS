...
**Evidence cutoff:** 2026-07-09 (SITE-002 Run **4.234** — category Lari reparent discovery; Лари id **88** parent **79** → target parent **358**; implementation charter ready; 0 Production mutation; checkpoint unchanged `SITE-002-STABLE-PROD-INFO-PAGE-FORMS-01`)
...
| Current SITE-002 focus | **Category Lari reparent discovery (Run 4.234)** — **COMPLETE — IMPLEMENTATION CHARTER READY**; Лари **88** currently `parent_id=79` (wrong); target `parent_id=358` (Шкафы и лари); old `/lari` indexed in sitemap; nested `/shkafy-i-lari/lari` resolves to old path; hybrid reparent + 301 recommended · [SITE-002-PROD-CATEGORY-LARI-REPARENT-DISCOVERY-01.md](sites/site-002/reports/SITE-002-PROD-CATEGORY-LARI-REPARENT-DISCOVERY-01.md) · checkpoint unchanged `SITE-002-STABLE-PROD-INFO-PAGE-FORMS-01` |
...
| Current Production checkpoint | **ISSUED** — [SITE-002-STABLE-PROD-INFO-PAGE-FORMS-01.md](sites/site-002/baselines/SITE-002-STABLE-PROD-INFO-PAGE-FORMS-01.md) (parent [SITE-002-STABLE-PROD-MAIL-CUSTOMER-FORMS-01.md](sites/site-002/baselines/SITE-002-STABLE-PROD-MAIL-CUSTOMER-FORMS-01.md)) |
