...
**Evidence cutoff:** 2026-06-28 (SITE-002 M9.14–M9.18 Corporate Pages **IMPLEMENTED** on TEST; **M9.18 Custom Manufacturing** checkpoint `SITE-002-STABLE-LIVE-M9.18-CUSTOM-01`; BZPM recovery **CLOSED**; site authority M9.13 About Restored + M9.14–M9.18 corp page checkpoints)  
...
| Current SITE-002 focus | **Authority** `SITE-002-STABLE-LIVE-M9.13-ABOUT-COMPANY-RESTORED-01` + **M9.14–M9.18** corp page checkpoints — BZPM recovery **CLOSED**; **PRODUCTION PREPARATION**; catalog UX **complete**; About **restored**; **Corporate Pages Program implementation COMPLETE on TEST**; operator gates B6/B8/B1; **B3 OPEN** (governance-only; PLP unchanged) |
