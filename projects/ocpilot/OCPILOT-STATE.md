...
**Evidence cutoff:** 2026-08-19 (SITE-002 Run **4.327** / `SITE-002-PROD-NEW-SECTIONS-WAVE-A-ONBOARDING-APPLY-01` — Wave A applied for `hlebopekarnoe` and `holodilnoe`; bounded DB meta/description mutation only; no structural moves; baseline refresh still blocked; mapping charter and monitor diagnostic next)
...
| Current SITE-002 focus | **Wave A onboarding applied (Run 4.327)** — `hlebopekarnoe` and `holodilnoe` now have bounded live meta/description onboarding without DB placement moves; `barnoe` still non-promoted empty/live, `posuda` placement unchanged, `upakovochnoe` remains XML-only/404; baseline refresh still blocked; next = Wave B mapping charter + Wave C monitor diagnostic · [apply 4.327](sites/site-002/reports/SITE-002-PROD-NEW-SECTIONS-WAVE-A-ONBOARDING-APPLY-01.md) · [charter 4.326](sites/site-002/reports/SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01.md) · [healthcheck 4.325](sites/site-002/reports/SITE-002-PROD-POST-1C-OFFERS-RECOVERY-AND-NEW-SECTIONS-HEALTHCHECK-01.md) |
