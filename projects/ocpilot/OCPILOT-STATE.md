...
**Evidence cutoff:** 2026-08-19 (SITE-002 Run **4.326** / `SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01` — apply waves ready; safe default = no DB moves; mapping charter and monitor diagnostic next; baseline refresh still blocked; no production mutation)
...
| Current SITE-002 focus | **New sections onboarding / placement charter complete (Run 4.326)** — safe default = keep DB placement stable, separate UI from structure, and keep baseline refresh blocked; `barnoe` empty/live, `hlebopekarnoe` and `holodilnoe` ready for onboarding, `posuda` needs placement decision, `upakovochnoe` remains XML-only; next = Wave A onboarding + Wave B mapping charter + monitor diagnostic · [charter 4.326](sites/site-002/reports/SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01.md) · [healthcheck 4.325](sites/site-002/reports/SITE-002-PROD-POST-1C-OFFERS-RECOVERY-AND-NEW-SECTIONS-HEALTHCHECK-01.md) · [cleanup apply 4.324](sites/site-002/reports/MARS-LOCAL-STORAGE-CLEANUP-APPLY-01.md) · [stable checkpoint 4.322](sites/site-002/reports/SITE-002-PROD-STABLE-CHECKPOINT-AFTER-SPAM-GUARD-AND-CLEANUP-INVENTORY-01.md) |
