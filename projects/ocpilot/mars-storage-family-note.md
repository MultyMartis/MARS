...
This is the **general MARS bulk-data root** for artifacts that should not live permanently in the git repository at `C:\AI MARS`.
...
| **Metadata in repo** | Passports, manifests, policies, and reports stay in `C:\AI MARS` |
...
4. **Root README** — `C:\AI MARS STORAGE\README.md` for operator onboarding.
...
- Whether `C:\AI MARS STORAGE` will use cloud sync, NAS, or second-machine mirror — operator infrastructure.
