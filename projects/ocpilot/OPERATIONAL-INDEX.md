...
| 4.301 | **SITE-002 Legacy Category Cleanup Charter 01** | **COMPLETE — APPLY PLAN READY** (2026-07-27; read-only; legacy **154/159/165** empty + in sitemap; recommend Option A **301+disable** → **378/379/380**; keep parent **153** temporarily; production mutation **0**; Client Ops untouched) | [sites/site-002/reports/SITE-002-PROD-LEGACY-CATEGORY-CLEANUP-CHARTER-01.md](sites/site-002/reports/SITE-002-PROD-LEGACY-CATEGORY-CLEANUP-CHARTER-01.md), Storage `deployments/SITE-002-PROD-LEGACY-CATEGORY-CLEANUP-CHARTER-01/`, [OCPILOT-STATE.md](OCPILOT-STATE.md) |
