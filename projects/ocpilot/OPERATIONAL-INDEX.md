...
| 4.302 | **SITE-002 Demo Catalog Cleanup Charter 01** | **ATTENTION — OPERATOR REVIEW REQUIRED** (2026-07-27; read-only; Group A DELETE_READY categories **154–170** (17); parent **153** KEEP_PARENT_PENDING; product DELETE_READY **0** (all 1598 have xml_id); ambiguous empty cats **119**; redirect plan superseded; apply **not** executed; mutation **0**; Client Ops untouched) | [sites/site-002/reports/SITE-002-PROD-DEMO-CATALOG-CLEANUP-CHARTER-01.md](sites/site-002/reports/SITE-002-PROD-DEMO-CATALOG-CLEANUP-CHARTER-01.md), Storage `deployments/SITE-002-PROD-DEMO-CATALOG-CLEANUP-CHARTER-01/`, [OCPILOT-STATE.md](OCPILOT-STATE.md) |
