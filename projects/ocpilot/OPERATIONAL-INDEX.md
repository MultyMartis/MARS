...
| 4.306 | **SITE-002 Parent 153 Delete Apply 01** | **COMPLETE — LEGACY PARENT REMOVED** (2026-07-27; physical delete category **153**; **6** category-related rows; 154–170 remain deleted; products **0**; redirects **0**; sitemap **1837→1836**; baseline still **1837**; next = baseline refresh 07; Client Ops untouched) | [sites/site-002/reports/SITE-002-PROD-PARENT-153-DELETE-APPLY-01.md](sites/site-002/reports/SITE-002-PROD-PARENT-153-DELETE-APPLY-01.md), Storage `deployments/SITE-002-PROD-PARENT-153-DELETE-APPLY-01/`, [OCPILOT-STATE.md](OCPILOT-STATE.md) |
