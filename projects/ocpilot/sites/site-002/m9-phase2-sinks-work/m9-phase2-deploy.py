#!/usr/bin/env python3
"""BZPM M9 Phase 2 — FTP deploy to TEST only (Sink filter profile 80)."""
import ftplib
import hashlib
import io
import json
...
BASE = r"C:\AI MARS\projects\ocpilot\sites\site-002\m9-phase2-sinks-work"
...
def main():
    ...
    for rel in REMOTE_FILES:
        ...
        try:
            ...
            pre_path = os.path.join(BACKUP_DIR, f"pre-m9-phase2-{rel.replace('/', '__')}")
    ...
    manifest = {
        "task": "M9 Phase 2 Sink filter profile (80)",
        "site": "SITE-002",
        "test_url": "https://zpm.new-site.space/",
        "rollback_source": "SITE-002-STABLE-M8.3-BEFORE-M9-20260615-0159",
        "phase1_rollback": "m9-phase1-tables-work/backups/m9-phase1-deploy-20260614-193725.json",
    ...
    out = os.path.join(BACKUP_DIR, f"m9-phase2-deploy-{STAMP}.json")
