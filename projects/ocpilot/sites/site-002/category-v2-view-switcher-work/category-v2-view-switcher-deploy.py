#!/usr/bin/env python3
"""SITE-002 CATEGORY V2 view switcher — FTP deploy (category.twig, style.css, main.js)."""
import ftplib
import hashlib
import io
import json
...
WORK_DIR = os.path.join(BASE, "category-v2-view-switcher-work")
STAMP = datetime.now(timezone.utc).strftime("%Y%m%d-%H%M%S")
ROLLBACK = {
    "category.twig": os.path.join(BACKUP_DIR, "category.twig"),
    "style.css": os.path.join(BACKUP_DIR, "style.css"),
    "main.js": os.path.join(BACKUP_DIR, "main.js"),
}
...
def main():
    ...
    manifest = {
        "stamp": STAMP,
        "task": "category-v2-view-switcher-pass",
        "baseline_rollback": "SITE-002-STABLE-CATEGORY-V2-PRE-VIEW-SWITCHER",
        "deployed": deployed,
    ...
    manifest_path = os.path.join(BACKUP_DIR, f"category-v2-view-switcher-deploy-manifest-{STAMP}.json")
