...
/* ==========================================================================
   M9.14 — Corp FAQ accordion (delivery + payment + warranty + dealers corp pages)
   ========================================================================== */
(function () {
  "use strict";
  ...
  function bootCorpAccordions() {
    document
      .querySelectorAll("[data-delivery-faq], [data-payment-faq], [data-warranty-faq], [data-dealers-faq]")
