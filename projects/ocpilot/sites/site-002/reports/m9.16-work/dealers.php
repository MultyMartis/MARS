...
class ControllerInformationDealers extends Controller {
	...
	public function index() {
		...
		$pageintro->description = '<p>ООО «Завод пищевого машиностроения» (ЗПМ) — российский производитель нейтрального оборудования из&nbsp;нержавеющей стали для общепита и&nbsp;пищевых производств. Работаем с&nbsp;дилерами, оптовыми и&nbsp;проектными партнёрами <strong>напрямую с&nbsp;завода</strong>.</p>'
