...
class ControllerInformationDelivery extends Controller {
	...
	public function index() {
		...
		$pageintro->description = '<p>ООО «Завод пищевого машиностроения» (ЗПМ) поставляет нейтральное оборудование из нержавеющей стали предприятиям общепита и пищевых производств по всей России. Отгрузка выполняется с производственной площадки в Барнауле или со склада партнёра в Московской области — в зависимости от состава заказа и согласованного способа получения.</p>'
