#!/usr/bin/env python3
"""M9.8.9-06H — getCategoryPriceRange exclude zero deploy."""
...
BACKUP_PATH = ROOT / "backups" / "product.php.pre-m9.8.9-06h-price-range-exclude-zero.bak"
WORK_DIR = ROOT / "reports" / "m9.8.9-06h-work"
