#!/usr/bin/env python3
"""M9.8.9-06F — import_1C_offers price index hook deploy."""
...
REMOTE_PATH = "catalog/controller/common/import_1C_offers.php"

ROOT = Path(r"C:\AI MARS\projects\ocpilot\sites\site-002")
BACKUP_PATH = ROOT / "backups" / "import_1C_offers.php.pre-m9.8.9-06f-price-index-hook.bak"
WORK_DIR = ROOT / "reports" / "m9.8.9-06f-work"
PATCHED_PATH = WORK_DIR / "import_1C_offers.php.patched"
CAPTURE_PATH = WORK_DIR / "live-capture" / "catalog__controller__common__import_1C_offers.php"
