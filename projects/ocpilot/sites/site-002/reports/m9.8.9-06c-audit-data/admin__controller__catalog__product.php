...
class ControllerCatalogProduct extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$id = $this->model_catalog_product->addProduct($this->request->post);
			$this->model_catalog_product->refreshPriceIndex($id);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_catalog_product->refreshPriceIndex($this->request->get['product_id']);
	...
	protected function getForm() {
		...
		if (!empty($product_info)) {
			$data['link'] = HTTP_CATALOG . 'index.php?route=product/product&product_id=' . $product_info['product_id'];
		...
		if (isset($this->request->post['discount1c'])) {
			...
			if (isset($this->request->post['discount1c'])) {
			$data['discount1c'] = $this->request->post['discount1c'];
		} elseif (!empty($product_info)) {
			$data['discount1c'] = $product_info['discount1c'];
		} else {
			$data['discount1c'] = '';
		}
