...
| Post-1C catalog monitor (Production) | **ONBOARDING 05 + HOTFIX/TILES/POLISH 4.282–4.286 — BASELINE REFRESH PENDING** (Runs **4.281**–**4.286**) — tehnologicheskoe allowlisted + Catalog Section Tiles polished (name/images/all-link); baseline still **1714**; next baseline refresh 04 · [polish 4.286](../reports/SITE-002-PROD-CATALOG-TILE-POLISH-01.md) · [tiles 4.285](../reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md) · [cache button 4.284](../reports/SITE-002-PROD-ADMIN-CACHE-CLEANER-BUTTON-RESTORE-01.md) · [megamenu 4.283](../reports/SITE-002-PROD-MEGAMENU-AND-CACHE-PLUGIN-DIAGNOSTIC-01.md) · [hotfix](../reports/SITE-002-PROD-REGRESSION-HOTFIX-01.md) · [onboarding 05](../reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) · [baseline 1714-03](../baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03.md) |
...
- **Catalog Section Tiles automation (Run 4.285) + polish (Run 4.286):** EN **Catalog Section Tiles** / RU **Плитки разделов каталога**; Launch Mode roots **79** + **362**; home + `/katalog` dual section blocks; tech children DB-driven (`getCategories(362)`); tech root name normalized to `Технологическое оборудование` (DB name + meta); tile images `catalog/Category-image/` for **368/373/369/371/372/370**; `.btn.zpm-catalog__all-link` in `megamenu.twig` must be `/katalog/`; **364** posuda may still use `placeholder.png`; baseline still **1714** · [polish](../reports/SITE-002-PROD-CATALOG-TILE-POLISH-01.md) · [tiles](../reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md)
