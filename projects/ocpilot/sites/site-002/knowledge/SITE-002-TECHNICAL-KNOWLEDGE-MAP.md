...
| Post-1C catalog monitor (Production) | **CLEAN AFTER 4.275** — manual `2026-07-16_15-03-50` **`NO_ACTION_REQUIRED`**; baseline **1714**; needs **0** · [refresh 03](../reports/SITE-002-MONITOR-BASELINE-REFRESH-03.md) · [onboarding 04](../reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-04.md) · [monitor baseline](../baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03.md) |
| Custom blog / scheduled publishing (Production) | **ACTIVE — FINAL SMOKE GREEN** (Runs **4.270–4.279**) — `CUSTOM_BLOG`; SEO full-path via `seo_url.php`; `getSliderPosts($exclude, 24)`; brand **`Завод`**; `reading_time_minutes` / `.reading-time`; gate `active=1 AND date_added <= NOW()` · [final smoke 4.279](../reports/SITE-002-PROD-BLOG-WAVE-FINAL-SMOKE-01.md) · [brand/slider 4.276](../reports/SITE-002-PROD-BRAND-CAPS-AND-BLOG-SLIDER-ORDER-01.md) |
