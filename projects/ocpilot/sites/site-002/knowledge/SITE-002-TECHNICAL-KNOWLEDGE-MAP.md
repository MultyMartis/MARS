...
| **Catalog structure normalization plan (Production)** | **PLAN-ONLY COMPLETE (Run 4.341)** — Hybrid Option C recommended; operator decisions required before apply (Posuda/Upakovochnoe/Teplovoe/Hlebo/empty roots/Zapchasti); no apply · [normalization plan](../reports/SITE-002-CATALOG-STRUCTURE-NORMALIZATION-PLAN-01.md) |
