...
| Product PDP meta generator | **DEPLOYED** (Run 4.201) — runtime fallback in `product.php`: preserve manual meta (≥80 chars, not import-stub); generate description/keywords when empty/weak; import-time unchanged in `import_1C_process.php`; 24 PDP sample after: 0 empty description, keywords on deep PDPs; keyword length tuning recommended · [fix report](../reports/SITE-002-PROD-SEO-PRODUCT-META-GENERATOR-FIX-01.md) · [discovery](../reports/SITE-002-PROD-SEO-PRODUCT-META-GENERATOR-DISCOVERY-01.md) |
