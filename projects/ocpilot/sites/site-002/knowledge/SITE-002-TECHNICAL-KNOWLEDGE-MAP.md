...
| **New sections onboarding / placement charter (Production)** | **MONITOR BASELINE REFRESH 09 COMPLETE** (Run **4.335**) — pretty-URL baseline **1887** accepted; Wave B1 `95`/`364` mapped; observe next natural 1C import for mapping persistence; `upakovochnoe` remains separate 404 · [refresh 4.335](../reports/SITE-002-MONITOR-BASELINE-REFRESH-09.md) · [validation 4.334](../reports/SITE-002-POST-RUNTIME-SYNC-SCHEDULED-MONITOR-VALIDATION-01.md) · [sync 4.333](../reports/SITE-002-MONITOR-RUNTIME-CHECKOUT-SYNC-01.md) · [apply 4.331](../reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C2-MONITOR-FIX-APPLY-01.md) |
...
| Next | Observe next natural 1C import for `95`/`364`; keep `upakovochnoe` 404 as open/separate; continue scheduled monitoring |
