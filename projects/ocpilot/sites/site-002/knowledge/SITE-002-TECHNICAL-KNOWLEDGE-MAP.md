...
| **Catalog structure / 1C category mapping (Production)** | **MAPPING BACKFILL COMPLETE** (Run **4.296**) — table `oc_mars_1c_category_map` with **7** active GUID/path rows → **362/373/375/376/378/379/380**; leaves from Run **4.295** (**378/379/380**); products **4707/4708→378**, **4710→379**, **4712→380**, **4709→376**; legacy **154/159/165** not active map targets; next = importer GUID map → full path → create under parent → collision guard (never leaf-name→legacy); baseline still **1737** · [mapping backfill](../reports/SITE-002-PROD-1C-CATEGORY-MAPPING-BACKFILL-01.md) · [leaf apply](../reports/SITE-002-PROD-1C-CANONICAL-LEAF-APPLY-01.md) · [leaf charter](../reports/SITE-002-PROD-1C-CANONICAL-LEAF-CREATION-CHARTER-01.md) · [harness](../reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-HARNESS-01.md) · [identity charter](../reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-FIX-CHARTER-01.md) · [postcheck](../reports/SITE-002-PROD-CANONICAL-REPARENT-POSTCHECK-01.md) · [reparent](../reports/SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01.md) |
...
Run **4.296** created Production mapping table `oc_mars_1c_category_map` and backfilled **7** confirmed tech GUID/path rows (**362/373/375/376/378/379/380**). Run **4.295** leaves and product placements remain unchanged by this operation. Without the importer GUID/path patch, a future import could still risk legacy **154/159/165** by leaf-name. Next: importer patch (GUID map → full path → create under parent → collision guard). Tool: [site-002-prod-1c-category-mapping-backfill-01.py](../tools/site-002-prod-1c-category-mapping-backfill-01.py). See [SITE-002-PROD-1C-CATEGORY-MAPPING-BACKFILL-01.md](../reports/SITE-002-PROD-1C-CATEGORY-MAPPING-BACKFILL-01.md), [SITE-002-PROD-1C-CANONICAL-LEAF-APPLY-01.md](../reports/SITE-002-PROD-1C-CANONICAL-LEAF-APPLY-01.md), [SITE-002-PROD-1C-CATEGORY-IDENTITY-HARNESS-01.md](../reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-HARNESS-01.md).
...
| Post-1C catalog monitor (Production) | **BASELINE 1737 — NO_ACTION_REQUIRED** (Run **4.288**) — refreshed after tech equipment wave; manual `2026-07-20_22-32-43` **NO_ACTION_REQUIRED**; checkpoint `SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1737-04` · [baseline refresh 4.288](../reports/SITE-002-MONITOR-BASELINE-REFRESH-04.md) · [baseline 1737-04](../baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1737-04.md) · prior [megamenu children 4.287](../reports/SITE-002-PROD-MEGAMENU-CHILDREN-AUTOMATION-01.md) · [onboarding 05](../reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) |
...
- **Catalog Section Tiles automation (Run 4.285) + polish (Run 4.286) + mega children (Run 4.287):** EN **Catalog Section Tiles** / RU **Плитки разделов каталога**; Launch Mode roots **79** + **362**; home + `/katalog` dual section blocks; tech children DB-driven (`getCategories(362)`); tech root name normalized to `Технологическое оборудование`; tile images `catalog/Category-image/` for **368/373/369/371/372/370** (+ regen **373/364/369/368**); `.btn.zpm-catalog__all-link` → `/katalog/`; mega menu section-hub children rebuilt via `buildHubChildCards` so tech mega pane matches tiles (**4**); baseline later refreshed in Run **4.288** · [megamenu children](../reports/SITE-002-PROD-MEGAMENU-CHILDREN-AUTOMATION-01.md) · [image regen](../reports/SITE-002-PROD-TECH-CATEGORY-IMAGES-REGEN-01.md) · [polish](../reports/SITE-002-PROD-CATALOG-TILE-POLISH-01.md) · [tiles](../reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md)
