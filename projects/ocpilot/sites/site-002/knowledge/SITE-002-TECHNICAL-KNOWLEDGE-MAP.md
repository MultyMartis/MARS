...
| **New sections onboarding / placement charter (Production)** | **WAVE B1 MAPPING BACKFILL COMPLETE** (Run **4.329**) — `holodilnoe` (`95`) and `posuda` (`364`) GUID-mapped in `oc_mars_1c_category_map`; `364` remains DB-child under `362`; `hlebopekarnoe`/`barnoe`/`upakovochnoe` still unmapped; baseline refresh still blocked; next = Wave C monitor diagnostic + post-B1 import observation · [apply 4.329](../reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B1-MAPPING-BACKFILL-APPLY-01.md) · [charter 4.328](../reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B-MAPPING-CHARTER-01.md) · [apply 4.327](../reports/SITE-002-PROD-NEW-SECTIONS-WAVE-A-ONBOARDING-APPLY-01.md) · [charter 4.326](../reports/SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01.md) |
...
| Next | Wave C monitor diagnostic; observe next natural 1C import for GUID resolution on `95`/`364`; **do not baseline-refresh yet** |
