...
| **Catalog structure / 1C category mapping (Production)** | **REPARENTED TO CANONICAL HUBS** (Run **4.290**) — products **4707/4708/4710→373**, **4712→375**; JG 210A under myaso; legacy **154/159/165** emptied not deleted; `oc_category` still has **no** GUID/`xml_id` — next import may re-collide by name until GUID mapping · [reparent](../reports/SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01.md) · forensic [4.289](../reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) |
