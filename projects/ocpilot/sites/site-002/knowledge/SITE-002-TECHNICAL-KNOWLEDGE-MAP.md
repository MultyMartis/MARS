...
| **New sections onboarding / placement charter (Production)** | **COMPLETE — SAFE APPLY PLAN READY** (Run **4.326**) — classification complete for `barnoe`, `hlebopekarnoe`, `holodilnoe`, `posuda`, `upakovochnoe`; recommended default = keep DB placement stable, separate UI from structure, no structural moves in Wave A; mapping charter and monitor diagnostic remain separate next waves · [charter 4.326](../reports/SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01.md) |
