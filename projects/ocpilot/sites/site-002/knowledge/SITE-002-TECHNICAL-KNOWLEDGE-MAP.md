...
| Tile authority | `system/library/zpm/category_visibility.php` — Catalog Section Tiles (`buildCatalogSectionTileBlocks`); neutral `$neutral_hub_branch_ids`; tech root **362** DB children; Launch Mode visible roots **79+362** |
