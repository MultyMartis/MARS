...
| UX task intake (Production) | Task 01 **PARTIAL** Run 4.219 — image assets required before lari/konditerskiy tiles · Task 02 **DONE** Run 4.218 · [intake report](../reports/SITE-002-PROD-UX-TASK-INTAKE-01.md) · [entrypoints report](../reports/SITE-002-PROD-NEW-SECTIONS-ENTRYPOINTS-01.md) |
...
| Future implementation | Extend `$neutral_hub_branch_ids` + **exact-slug** Category-image WebP masters for IDs **88** (`lari`) and **360** (`konditerskiy-inventar`) — Run 4.219 **PARTIAL** (G2 image gate fail; do not deploy with placeholder) · [report](../reports/SITE-002-PROD-NEW-SECTIONS-ENTRYPOINTS-01.md) · [tool](../tools/site-002-prod-new-sections-entrypoints-01.py) |
