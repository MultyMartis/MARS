...
| **Catalog structure / 1C category mapping (Production)** | **POST-IMPORT PERSISTENCE CONFIRMED; PRETTY-URL MONITOR BASELINE 1887 ACCEPTED** — natural import `2026-08-19` succeeded with real offers step after Run **4.297** GUID/path patch; sitemap live **1887**; monitor baseline refreshed **1879→1887** (Run **4.335**); `barnoe-oborudovanie`, `hlebopekarnoe-oborudovanie`, `holodilnoe-oborudovanie` live as pretty roots; `posuda-i-inventar` nested under tech; `Упаковочное оборудование` present in XML but absent in DB/site/sitemap; post-refresh monitor `NO_ACTION_REQUIRED` · [refresh 4.335](../reports/SITE-002-MONITOR-BASELINE-REFRESH-09.md) · [healthcheck 4.325](../reports/SITE-002-PROD-POST-1C-OFFERS-RECOVERY-AND-NEW-SECTIONS-HEALTHCHECK-01.md) · [baseline refresh 4.312](../reports/SITE-002-MONITOR-BASELINE-REFRESH-08.md) · [forensic 4.319](../reports/SITE-002-PROD-1C-FIRST-LEVEL-CATEGORY-PLACEMENT-FORENSIC-01.md) |
| **New sections onboarding / placement charter (Production)** | **POST-BASELINE WORKSPACE CLOSEOUT COMPLETE** (Run **4.336**) — pretty-URL baseline **1887** accepted; Wave B1 `95`/`364` mapped; observe next natural 1C import for mapping persistence; `upakovochnoe` remains separate 404; docs/git tails closed · [closeout 4.336](../reports/SITE-002-POST-BASELINE-WORKSPACE-CLOSEOUT-01.md) · [refresh 4.335](../reports/SITE-002-MONITOR-BASELINE-REFRESH-09.md) · [validation 4.334](../reports/SITE-002-POST-RUNTIME-SYNC-SCHEDULED-MONITOR-VALIDATION-01.md) · [sync 4.333](../reports/SITE-002-MONITOR-RUNTIME-CHECKOUT-SYNC-01.md) · [apply 4.331](../reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C2-MONITOR-FIX-APPLY-01.md) |
...
| Sitemap | live `1887`; baseline `1887` (Run **4.335**); `/upakovochnoe-oborudovanie` absent; `/assum` present; `/brands/assum` absent |
| Monitor | runtime healthy; post-refresh **`NO_ACTION_REQUIRED`** 1887→1887; route churn vs old 1879 **resolved**; prior scheduled validation `2026-08-20_13-29-44` confirmed semantic/exact split |
