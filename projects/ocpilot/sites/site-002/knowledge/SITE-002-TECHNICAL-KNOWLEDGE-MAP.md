...
Post-patch natural imports (2026-07-24..27) kept critical products on canonical leaves **378/379/380/376**. Wrapper TXT reports SUCCESS; product `date_modified` 2026-07-27 confirms import touch. Live sitemap **1854**; monitor baseline **1854** (Run **4.300**). Run **4.303** physically deleted Group A **154–170** (no redirects); parent **153** kept with 0 children; sitemap **1854→1837**; monitor baseline still **1854** pending refresh 06; no product deletes.
...
| Post-1C catalog monitor (Production) | **BASELINE 1854 (stale vs live sitemap 1837 after Run 4.303)** — Run **4.300** was clean; demo delete expects onboarding until refresh 06; checkpoint `SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1854-05` · [delete apply 4.303](../reports/SITE-002-PROD-DEMO-CATEGORY-DELETE-APPLY-01.md) · [baseline refresh 4.300](../reports/SITE-002-MONITOR-BASELINE-REFRESH-05.md) · [baseline 1854-05](../baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1854-05.md) · prior [refresh 4.288](../reports/SITE-002-MONITOR-BASELINE-REFRESH-04.md) · prior [persistence 4.299](../reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) |
...
- **Demo category delete apply 01 (Run 4.303):** physical delete **154–170**; **119** rows; parent **153** kept; sitemap **1854→1837**; baseline still **1854**; next refresh 06 · [report](../reports/SITE-002-PROD-DEMO-CATEGORY-DELETE-APPLY-01.md)
