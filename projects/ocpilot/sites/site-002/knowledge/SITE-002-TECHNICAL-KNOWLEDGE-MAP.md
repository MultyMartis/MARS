...
| Post-1C catalog monitor (Production) | **ONBOARDING 05 + HOTFIX 4.282 + MEGAMENU 4.283 — BASELINE REFRESH PENDING** (Runs **4.281**–**4.283**) — tehnologicheskoe allowlisted; PDP+notices restored; mega menu `cat-list-header` rebuild-on-miss in `header.php`; baseline still **1714**; live sitemap **1737**; next baseline refresh 04 · [megamenu 4.283](../reports/SITE-002-PROD-MEGAMENU-AND-CACHE-PLUGIN-DIAGNOSTIC-01.md) · [hotfix](../reports/SITE-002-PROD-REGRESSION-HOTFIX-01.md) · [onboarding 05](../reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) · [baseline 1714-03](../baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03.md) |
