...
| Post-1C catalog monitor (Production) | **ONBOARDING 05 + HOTFIX 4.282 — BASELINE REFRESH PENDING** (Run **4.281** + **4.282**) — 6 flat `tehnologicheskoe-oborudovanie/*` paths allowlisted; parent-path PDP restored + `has_children` notices removed; baseline still **1714**; live sitemap **1737**; next **`SITE-002-MONITOR-BASELINE-REFRESH-04`** · [hotfix](../reports/SITE-002-PROD-REGRESSION-HOTFIX-01.md) · [onboarding 05](../reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) · prior [multiday healthcheck 4.280](../reports/SITE-002-PROD-MULTIDAY-HEALTHCHECK-01.md) · [baseline 1714-03](../baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03.md) |
