...
| **New sections onboarding / placement charter (Production)** | **WAVE C2 MONITOR FIX APPLIED** (Run **4.331**) — semantic route-churn layer + runner artifact fix; Wave B1 `95`/`364` mapped; baseline refresh still blocked; next = scheduled monitor validation + post-B1 import observation · [apply 4.331](../reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C2-MONITOR-FIX-APPLY-01.md) · [diagnostic 4.330](../reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C-MONITOR-DIAGNOSTIC-01.md) · [apply 4.329](../reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B1-MAPPING-BACKFILL-APPLY-01.md) |
...
| Next | Scheduled monitor validation run; observe next natural 1C import for `95`/`364`; **do not baseline-refresh yet** (`SITE-002-MONITOR-BASELINE-REFRESH-09` after explicit approval) |
