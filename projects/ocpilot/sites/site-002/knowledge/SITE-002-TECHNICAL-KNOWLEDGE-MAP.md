...
| Post-1C catalog monitor (Production) | **ONBOARDING 05 + HOTFIX 4.282 + MEGAMENU 4.283 + CACHE BUTTON 4.284 + TILES 4.285 — BASELINE REFRESH PENDING** (Runs **4.281**–**4.285**) — tehnologicheskoe allowlisted + Catalog Section Tiles peer root **362**; PDP+notices restored; mega menu rebuild-on-miss; admin cache button restored; baseline still **1714**; live sitemap **1737**; next baseline refresh 04 · [tiles 4.285](../reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md) · [cache button 4.284](../reports/SITE-002-PROD-ADMIN-CACHE-CLEANER-BUTTON-RESTORE-01.md) · [megamenu 4.283](../reports/SITE-002-PROD-MEGAMENU-AND-CACHE-PLUGIN-DIAGNOSTIC-01.md) · [hotfix](../reports/SITE-002-PROD-REGRESSION-HOTFIX-01.md) · [onboarding 05](../reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) · [baseline 1714-03](../baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03.md) |
...
- **Catalog Section Tiles automation (Run 4.285):** EN **Catalog Section Tiles** / RU **Плитки разделов каталога**; Launch Mode visible roots expanded to **79** + **362** (`tehnologicheskoe-oborudovanie`); home + `/katalog` dual section blocks; tech children DB-driven (`getCategories(362)`); neutral still curated `$neutral_hub_branch_ids`; missing images → `placeholder.png`; after PHP/Twig/CSS deploy clear `storage/modification/` + `cache.*` then **OCMOD refresh** (admin cache button overlays); baseline still **1714** · [report](../reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md)
