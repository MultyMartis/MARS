...
| llms.txt (AI agent guide) | **DEPLOYED** (Run 4.203) — `/public_html/llms.txt` · https://bzpm.ru/llms.txt — plain Markdown site summary for AI/LLM crawlers; catalog + key pages map; does not replace robots.txt or sitemap.xml; no `/llm.txt` alias · [report](../reports/SITE-002-PROD-LLMS-TXT-01.md) |
