...
| Post-1C catalog monitor (Production) | **NATURAL RUN CONFIRMED — ONBOARDING 2** (Runs 4.251–**4.259**) — natural artifact `2026-07-12_12-30-02` from runtime checkout; classification **ONBOARDING_REQUIRED** (needs **2** new branches; old Lari FPs did not return); Run **4.254** meta + Run **4.255** allowlist + Run **4.256–4.257** runtime split · [natural run verify](../../mars-infrastructure/reports/MARS-INFRA-RUNTIME-SPLIT-SITE-002-NATURAL-RUN-VERIFY-01.md) · [runtime sync](../reports/SITE-002-LOCAL-RUNTIME-MONITOR-SYNC-01.md) · [entrypoint onboarding](../reports/SITE-002-PROD-CATEGORY-ENTRYPOINT-ONBOARDING-01.md) · [meta onboarding](../reports/SITE-002-PROD-CATEGORY-META-ONBOARDING-01.md) · [runbook](../runbooks/SITE-002-POST-1C-MONITOR-AUTOMATION-RUNBOOK.md) · [monitor](../tools/site-002-prod-post-1c-catalog-onboarding-monitor-02.py) |
...
- Post-import monitoring: diff sitemap for new CATEGORY_PLP with missing meta — tool `site-002-prod-post-1c-catalog-onboarding-monitor-02.py`; **local scheduler verified** (Run 4.216) via `site-002-post-1c-monitor-runner.ps1` + Windows Task `MARS_SITE_002_Post_1C_Catalog_Monitor` — **enabled**; natural scheduled run **CONFIRMED** Run **4.259** artifact `2026-07-12_12-30-02` from runtime checkout `X:\AI MARS STORAGE\runtime-checkouts\site-002-monitor\repo` @ `bd3021bf`; classification **ONBOARDING_REQUIRED**, onboarding needs **2** (new branches; old Lari FPs did not return); Run **4.255** allowlist nested Lari + ids **362/363**; Run **4.257** scheduler detached from dirty `X:\AI MARS` · [natural run verify](../../mars-infrastructure/reports/MARS-INFRA-RUNTIME-SPLIT-SITE-002-NATURAL-RUN-VERIFY-01.md) · [Git brief](../../mars-infrastructure/GIT-RUNTIME-BRIEF-FOR-PROJECT-CHATS.md) · [infra runtime split report](../../mars-infrastructure/reports/MARS-INFRA-RUNTIME-SPLIT-SITE-002-01.md) · [runtime checkouts](../../mars-infrastructure/runtime-checkouts.md) · [runbook](../runbooks/SITE-002-POST-1C-MONITOR-AUTOMATION-RUNBOOK.md)
...
### Post-1C monitor scheduler (Run 4.215 / 4.216 / **4.257 runtime split** / **4.258 spotcheck** / **4.259 natural verify**)
