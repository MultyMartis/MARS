...
| **Catalog structure / 1C category mapping (Production)** | **POSTCHECK CONFIRMED — PERSISTENCE NOT YET PROVEN** (Run **4.291**) — full confirmed group still **4707/4708/4710→373**, **4712→375**, **4709→376**; legacy leaves empty; latest 1C import predates reparent; `oc_category` still has **no** GUID/`xml_id` — importer identity fix required before safe legacy disable · [postcheck](../reports/SITE-002-PROD-CANONICAL-REPARENT-POSTCHECK-01.md) · [reparent](../reports/SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01.md) · forensic [4.289](../reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) |
