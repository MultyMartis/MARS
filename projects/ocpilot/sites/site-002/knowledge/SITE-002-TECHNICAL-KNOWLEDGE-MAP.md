...
### Post-1C monitor scheduler (Run 4.215 / 4.216 / **4.257 runtime split** / **4.258 spotcheck** / **4.259 natural verify** / **4.260 onboarding 02** / **4.261 baseline refresh**)
...
- **Runtime checkout (Run 4.257):** `X:\AI MARS STORAGE\runtime-checkouts\site-002-monitor\repo` @ `origin/mars/canonical-post-recovery` (`bd3021bf`) — **do not** run scheduled monitor from dirty `X:\AI MARS`
