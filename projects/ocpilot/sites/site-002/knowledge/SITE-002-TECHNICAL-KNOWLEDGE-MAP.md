...
| Public brand policy (Production) | **ACTIVE** (Run 4.205) — correct public Russian brand: **ЗПМ** · forbidden in public content: **БЗПМ** · domain remains **bzpm.ru** · product generator emits **ЗПМ** · fixed files: llms.txt, product.php, katalog.php, blog/category.php, 6 information controllers; admin category SEO 331/354/358 |
