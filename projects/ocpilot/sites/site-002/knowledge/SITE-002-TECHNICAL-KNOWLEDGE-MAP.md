...
| **Catalog structure / 1C category mapping (Production)** | **POST-IMPORT PERSISTENCE CONFIRMED** (Run **4.299**) — natural imports 2026-07-24..27 SUCCESS after Run **4.297** GUID/path patch; critical stay **378/379/380/376**; legacy **154/159/165** empty; map table **7/7** active; sitemap live **1854**; monitor baseline **1854** (Run **4.300**); Run **4.301** Option A **301+disable superseded** by operator; **demo catalog cleanup charter (Run 4.302)** — Group A DELETE_READY **154–170**; parent **153** KEEP_PARENT_PENDING; product DELETE_READY **0**; apply **not** executed · [demo cleanup 4.302](../reports/SITE-002-PROD-DEMO-CATALOG-CLEANUP-CHARTER-01.md) · [legacy charter 4.301](../reports/SITE-002-PROD-LEGACY-CATEGORY-CLEANUP-CHARTER-01.md) · [baseline refresh 4.300](../reports/SITE-002-MONITOR-BASELINE-REFRESH-05.md) · [persistence check](../reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) · [importer patch](../reports/SITE-002-PROD-1C-IMPORTER-GUID-PATH-PATCH-01.md) · [mapping backfill](../reports/SITE-002-PROD-1C-CATEGORY-MAPPING-BACKFILL-01.md) · [leaf apply](../reports/SITE-002-PROD-1C-CANONICAL-LEAF-APPLY-01.md) · [harness](../reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-HARNESS-01.md) |
...
Post-patch natural imports (2026-07-24..27) kept critical products on canonical leaves **378/379/380/376**. Wrapper TXT reports SUCCESS; product `date_modified` 2026-07-27 confirms import touch. Live sitemap **1854**; monitor baseline **1854** (Run **4.300**). Legacy empty branch **153** + 17 children remain in sitemap as thin 200 pages. Operator superseded Run **4.301** Option A redirects: target is physical demo delete (Run **4.302**) — Group A **154–170** DELETE_READY; parent **153** pending HITL; no product deletes; apply not executed.
...
| Post-1C catalog monitor (Production) | **BASELINE 1854 — NO_ACTION_REQUIRED** (Run **4.300**) — refreshed after confirmed post-import persistence; manual `2026-07-27_15-24-48` **NO_ACTION_REQUIRED**; checkpoint `SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1854-05` · [baseline refresh 4.300](../reports/SITE-002-MONITOR-BASELINE-REFRESH-05.md) · [baseline 1854-05](../baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1854-05.md) · prior [refresh 4.288](../reports/SITE-002-MONITOR-BASELINE-REFRESH-04.md) · prior [persistence 4.299](../reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) |
...
- **Demo catalog cleanup charter 01 (Run 4.302):** read-only; Group A DELETE_READY **154–170**; parent **153** KEEP_PARENT_PENDING; product DELETE_READY **0**; ambiguous empty cats **119**; no 301; physical delete apply not executed · [report](../reports/SITE-002-PROD-DEMO-CATALOG-CLEANUP-CHARTER-01.md)
