...
class ControllerBlogCategory extends Controller {
	...
	public function index() {
		...
		if ($category_info) {
			...
			// SITE-002-SEO-BLOG-CANONICAL-SITEMAP-GO1: clean theme hub canonical (no ?page=)
			$this->document->addLink($this->url->link('blog/category', 'blog_category_id=' . $category_id), 'canonical');
			...
			// SITE-002-SEO-BLOG-CANONICAL-SITEMAP-GO1: clean blog hub canonical (no ?page=)
			$this->document->addLink($this->url->link('blog/category'), 'canonical');
        }
