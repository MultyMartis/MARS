...
- **`ONBOARDED_CATEGORY_PATHS`** (Run 4.255 + **4.260**): nested Lari under `shkafy-i-lari/lari/*` plus `tehnologicheskoe-oborudovanie`, `tehnologicheskoe-oborudovanie/posuda-i-inventar`, `shkafy-dlya-hleba`, and `stellazhi/stellazhi-standart/stellazhi-standart-vysota-1600`; flat `/lari/*` removed from allowlist (retained in `SANITY_URLS` only).
