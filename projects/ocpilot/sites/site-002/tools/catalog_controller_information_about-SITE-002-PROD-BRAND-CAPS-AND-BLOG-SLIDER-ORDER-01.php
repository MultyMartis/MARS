...
class ControllerInformationAbout extends Controller {
	...
	public function index() {
		...
		$this->document->setDescription('Производство нейтрального оборудования из нержавеющей стали для общепита и пищевых предприятий. ЗПМ: собственный завод в Барнауле, поставки по России.');
