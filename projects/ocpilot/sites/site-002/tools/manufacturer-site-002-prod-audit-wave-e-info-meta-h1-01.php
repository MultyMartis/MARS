	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			if ($manufacturer_id === 11) {
				$this->document->setDescription('Оборудование Assum на сайте ЗПМ: информация о бренде, доступных позициях и подборе решений для профессиональной кухни и производства.');
			}
