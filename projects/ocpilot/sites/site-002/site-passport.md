...
| **Custom blog / scheduled news** | **ACTIVE** (Run **4.278**) — SEO URLs `/blog/news` + `/blog/news/{slug}` fixed; prior **4.277** literal `\n` cleanup · [SEO routing](reports/SITE-002-PROD-BLOG-SEO-URL-ROUTING-FIX-01.md) · [newline cleanup](reports/SITE-002-PROD-BLOG-LITERAL-NEWLINE-CLEANUP-01.md) |
