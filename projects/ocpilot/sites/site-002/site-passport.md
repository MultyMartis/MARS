...
| **Catalog structure forensic** | **IDENTITY FIX CHARTER READY (Run 4.292)** after postcheck **4.291** / reparent **4.290** / forensic **4.289** — importer leaf-name collision confirmed; hybrid GUID map recommended; persistence after 1C import **not yet proven**; legacy leaves empty; cleanup deferred · [charter](reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-FIX-CHARTER-01.md) · [postcheck](reports/SITE-002-PROD-CANONICAL-REPARENT-POSTCHECK-01.md) · [reparent](reports/SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01.md) · [forensic](reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) |
