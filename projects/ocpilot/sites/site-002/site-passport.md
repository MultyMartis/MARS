...
| **Contacts URL routing** | **REVIEWED — CHARTER READY** (Run 4.237) — `/kontakty` **404**; live contacts **`/contact`** (`information/contact`, `oc_seo_url` **846**); target `/kontakty` via Option E · [report](reports/SITE-002-PROD-CONTACTS-URL-ROUTING-REVIEW-01.md) |
