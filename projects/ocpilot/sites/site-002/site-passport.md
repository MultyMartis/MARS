...
| **Catalog structure forensic** | **IMPORTER GUID/PATH PATCH DEPLOYED (Run 4.297)** after mapping backfill **4.296** / leaf apply **4.295** — resolution precedence GUID→path→collision guard active; leaves **378/379/380**; critical dry-run canonical; post-import persistence check next; baseline still **1737** · [importer patch](reports/SITE-002-PROD-1C-IMPORTER-GUID-PATH-PATCH-01.md) · [mapping backfill](reports/SITE-002-PROD-1C-CATEGORY-MAPPING-BACKFILL-01.md) · [leaf apply](reports/SITE-002-PROD-1C-CANONICAL-LEAF-APPLY-01.md) · [leaf charter](reports/SITE-002-PROD-1C-CANONICAL-LEAF-CREATION-CHARTER-01.md) · [harness](reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-HARNESS-01.md) · [identity charter](reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-FIX-CHARTER-01.md) |
| **Elektromehanicheskoe category image** | **LIVE (Run 4.298)** — category **375** `catalog/Category-image/elektromehanicheskoe.webp`; legacy **153** untouched; baseline still **1737** · [report](reports/SITE-002-PROD-ELEKTROMEHANICHESKOE-CATEGORY-IMAGE-APPLY-01.md) |
