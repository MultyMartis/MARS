...
| **New catalog branch onboarding** | **COMPLETE** (Run 4.210 + 4.211 + **4.260** + **4.268**) — konditerskiy-inventar/formy-konditerskie (360/361); lari (88/141/140); **364** posuda-i-inventar + **365** stellazhi-standart-vysota-1600 + **366** stellazhi-premium-vysota-1600 meta+allowlist · [Run 4.268](reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-03.md) · [Run 4.260](reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-02.md) · [follow-up](reports/SITE-002-PROD-CATALOG-BRANCH-ONBOARDING-FOLLOWUP-01.md) · [Run 4.210](reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-01.md) |
...
| **Post-1C catalog monitor** | **CLEAN AFTER 4.269** — baseline **1530→1615**; manual 2026-07-15_15-53-13 **`NO_ACTION_REQUIRED`**; needs **0**; allowlist includes stellazhi-premium-vysota-1600 · [refresh 02](reports/SITE-002-MONITOR-BASELINE-REFRESH-02.md) · prior [onboarding 03](reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-03.md) · monitor baseline [SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1615-02](baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1615-02.md) · [runtime pin](../../mars-infrastructure/reports/MARS-INFRA-RUNTIME-CHECKOUT-PIN-SITE-002-01.md) · [runtime checkouts](../../mars-infrastructure/runtime-checkouts.md) · [runbook](runbooks/SITE-002-POST-1C-MONITOR-AUTOMATION-RUNBOOK.md) |
| **Custom blog / scheduled news** | **ACTIVE — POST 13 PUBLISHED** (Run **4.273** verifies; **4.272** datetime/readtime) — post_id **13** live; related slider meta fixed; gate `date_added <= NOW()` · [postpublish](reports/SITE-002-PROD-BLOG-POSTPUBLISH-1C-HEALTHCHECK-RELARTICLES-META-01.md) · [readtime](reports/SITE-002-PROD-BLOG-PUBLISH-DATETIME-READTIME-01.md) |
