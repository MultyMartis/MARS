...
| **Custom blog / scheduled news** | **ACTIVE — SLIDER ORDER + BRAND CAPS** (Run **4.276**) — `getSliderPosts` max **24** newest-first; post **13** capitalization; reading time in slider meta · [report](reports/SITE-002-PROD-BRAND-CAPS-AND-BLOG-SLIDER-ORDER-01.md) · [postpublish](reports/SITE-002-PROD-BLOG-POSTPUBLISH-1C-HEALTHCHECK-RELARTICLES-META-01.md) |
