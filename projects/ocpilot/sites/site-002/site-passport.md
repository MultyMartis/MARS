...
| **Post-1C catalog monitor** | **BASELINE 1737 — LIVE 1854 / ONBOARDING_REQUIRED** (Run **4.299**) — monitor `2026-07-27_12-30-02` needs **7**; artifacts agree; prior summary/classification conflict not present in latest run; baseline refresh next charter · [persistence check 4.299](reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) · [forensic 4.289](reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) · checkpoint [1737-04](baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1737-04.md) · [baseline refresh 4.288](reports/SITE-002-MONITOR-BASELINE-REFRESH-04.md) · [runtime checkouts](../../mars-infrastructure/runtime-checkouts.md) |
| **Catalog structure forensic** | **POST-IMPORT PERSISTENCE CONFIRMED (Run 4.299)** after importer patch **4.297** / mapping **4.296** / leaves **4.295** — natural imports SUCCESS; critical stay **378/379/380/376**; legacy **154/159/165** empty; sitemap **1854**; baseline still **1737** · [persistence check](reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) · [importer patch](reports/SITE-002-PROD-1C-IMPORTER-GUID-PATH-PATCH-01.md) · [mapping backfill](reports/SITE-002-PROD-1C-CATEGORY-MAPPING-BACKFILL-01.md) · [leaf apply](reports/SITE-002-PROD-1C-CANONICAL-LEAF-APPLY-01.md) · [harness](reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-HARNESS-01.md) |
