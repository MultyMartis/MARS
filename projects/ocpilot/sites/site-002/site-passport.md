...
**Status:** **SITE-002 NEW SECTIONS WAVE B1 MAPPING BACKFILL COMPLETE — 95 AND 364 MAPPED, BASELINE REFRESH BLOCKED** (Run 4.329; bounded mapping-table apply only; no structural moves)
**Run:** 4.329 — SITE-002 New Sections Wave B1 Mapping Backfill Apply 01 (2026-08-19)
...
| **New sections onboarding / placement charter** | **WAVE B1 MAPPING BACKFILL COMPLETE** (Run **4.329**) — `holodilnoe` (`95`) and `posuda` (`364`) GUID-mapped in `oc_mars_1c_category_map`; `364` remains DB-child under `362`; `hlebopekarnoe`/`barnoe`/`upakovochnoe` still unmapped by design; baseline refresh remains blocked · [apply 4.329](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B1-MAPPING-BACKFILL-APPLY-01.md) · [charter 4.328](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B-MAPPING-CHARTER-01.md) · [apply 4.327](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-A-ONBOARDING-APPLY-01.md) · [charter 4.326](reports/SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01.md) |
