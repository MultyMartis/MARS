...
| **Custom blog / scheduled news** | **ACTIVE** (Run **4.277**) — post **13** literal `\n` cleanup; prior **4.276** slider + brand caps · [report](reports/SITE-002-PROD-BLOG-LITERAL-NEWLINE-CLEANUP-01.md) · [postpublish](reports/SITE-002-PROD-BLOG-POSTPUBLISH-1C-HEALTHCHECK-RELARTICLES-META-01.md) |
