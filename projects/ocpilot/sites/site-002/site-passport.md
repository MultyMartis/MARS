...
| **Category Lari reparent** | **ACTIVE — LARI CONFIRMED** (Run 4.235 + Run 4.248) — Лари **88** under **358**; category_path nested; flat `/lari` **301**; Run **4.248** DB+HTTP+sitemap **PASS** · [verification 02](reports/SITE-002-PROD-POST-1C-LARI-REPARENT-AND-DURATION-VERIFICATION-02.md) · [reparent](reports/SITE-002-PROD-CATEGORY-LARI-REPARENT-IMPLEMENTATION-01.md) · [parent tiles](reports/SITE-002-PROD-PARENT-CATEGORY-TILES-LARI-REMOVAL-01.md) |
...
| **MARS 1C cron reports** | **PATCHED — CONFIRMATION PENDING** (Run 4.239) — wrapper v1.1.1 deployed `2026-07-09T17:07:52+00:00`; Run **4.248 PARTIAL** — no post-patch import TXT yet · [verification 02](reports/SITE-002-PROD-POST-1C-LARI-REPARENT-AND-DURATION-VERIFICATION-02.md) · [duration fix](reports/SITE-002-PROD-CRON-RUN-REPORTS-DURATION-FIX-01.md) |
