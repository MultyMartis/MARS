...
| **Catalog structure forensic** | **POSTCHECK CONFIRMED (Run 4.291)** after reparent **4.290** / forensic **4.289** — full confirmed group on hubs **373/375**; persistence after 1C import **not yet proven**; legacy leaves empty; importer GUID fix still required · [postcheck](reports/SITE-002-PROD-CANONICAL-REPARENT-POSTCHECK-01.md) · [reparent](reports/SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01.md) · [forensic](reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) |
