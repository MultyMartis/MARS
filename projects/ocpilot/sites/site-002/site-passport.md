...
| **Current Production checkpoint** | **ISSUED** — [baselines/SITE-002-STABLE-PROD-MAIL-DESIGN-SYSTEM-01.md](baselines/SITE-002-STABLE-PROD-MAIL-DESIGN-SYSTEM-01.md) (parent [SITE-002-STABLE-PROD-CATEGORY-ENTRYPOINTS-SORT-AZ-01.md](baselines/SITE-002-STABLE-PROD-CATEGORY-ENTRYPOINTS-SORT-AZ-01.md)) |
...
| **Mail design system (Production)** | **ACTIVE — ANKETA INTEGRATED** (Run 4.224) — `checkout/anketa.php` + `ZpmMailRenderer`; service info in admin mail; test submit `ok: true`; mailbox visual pending · [report](reports/SITE-002-PROD-MAIL-ADMIN-FORMS-01.md) · [checkpoint](baselines/SITE-002-STABLE-PROD-MAIL-ADMIN-FORMS-01.md) |
