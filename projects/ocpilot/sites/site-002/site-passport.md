...
| **Custom blog / scheduled news** | **ACTIVE — DATETIME + READING TIME** (Run **4.272**) — `CUSTOM_BLOG`; admin date+time publish UI; `reading_time_minutes`; gate `date_added <= NOW()`; post_id **13** Barnaul **2026-07-16 07:00** (+ hero/logo Run **4.271**) · [report](reports/SITE-002-PROD-BLOG-PUBLISH-DATETIME-READTIME-01.md) |
