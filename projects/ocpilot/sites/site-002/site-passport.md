...
| **Post-1C catalog monitor** | **BASELINE 1737 — LIVE GROWTH / ARTIFACT CONFLICT NOTED** (Run **4.289**) — live sitemap **1817**; needs **4**; prefer `monitor-classification.json` over conflicting `run-summary.json` · [forensic 4.289](reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) · checkpoint [1737-04](baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1737-04.md) · [baseline refresh 4.288](reports/SITE-002-MONITOR-BASELINE-REFRESH-04.md) · prior [megamenu children 4.287](reports/SITE-002-PROD-MEGAMENU-CHILDREN-AUTOMATION-01.md) · [onboarding 05](reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) · [runtime checkouts](../../mars-infrastructure/runtime-checkouts.md) |
| **Catalog structure forensic** | **MAPPING BACKFILL COMPLETE (Run 4.296)** after leaf apply **4.295** / charter **4.294** / harness **4.293** / identity charter **4.292** / postcheck **4.291** / reparent **4.290** / forensic **4.289** — `oc_mars_1c_category_map` + **7** GUIDs; leaves **378/379/380** live; legacy **154/159/165** kept but not active map targets; importer patch next · [mapping backfill](reports/SITE-002-PROD-1C-CATEGORY-MAPPING-BACKFILL-01.md) · [leaf apply](reports/SITE-002-PROD-1C-CANONICAL-LEAF-APPLY-01.md) · [leaf charter](reports/SITE-002-PROD-1C-CANONICAL-LEAF-CREATION-CHARTER-01.md) · [harness](reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-HARNESS-01.md) · [identity charter](reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-FIX-CHARTER-01.md) · [postcheck](reports/SITE-002-PROD-CANONICAL-REPARENT-POSTCHECK-01.md) · [reparent](reports/SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01.md) |
