...
| **Catalog Section Tiles** | **ACTIVE + POLISHED + MEGA PARITY** (Runs **4.285**–**4.287**) — roots **Нейтральное** (79) + **Технологическое** (362); tile images for tech **368/373/369/371/372/370**; mega children for section hubs match tiles via `buildHubChildCards`; all-link `/katalog/` · [megamenu children](reports/SITE-002-PROD-MEGAMENU-CHILDREN-AUTOMATION-01.md) · [polish](reports/SITE-002-PROD-CATALOG-TILE-POLISH-01.md) · [tiles](reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md) |
