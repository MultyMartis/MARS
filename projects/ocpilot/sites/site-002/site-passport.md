...
**Status:** **STABLE PRODUCTION CHECKPOINT — BRAND ZPM 01** (public brand remediation Run 4.205; final meta inventory next)
...
| **Public brand policy** | **ЗПМ** — correct public Russian brand · **БЗПМ** forbidden in public copy/meta/llms/generated output · domain `bzpm.ru` unchanged (Run 4.205) |
