...
| **Conflict resolution (Production)** | Current operational website authority = https://bzpm.ru/; cron checkpoint `SITE-002-STABLE-PROD-CRON-SCHEDULED-RUN-01`; SEO checkpoint `SITE-002-STABLE-PROD-SEO-INFORMATION-META-01` (parent sitemap `SITE-002-STABLE-PROD-SITEMAP-01`); daily 1C import **OPERATIONAL** (Run 4.194); non-product information meta **COMPLETE** (Run 4.199); product PDP meta deferred; valid XML sitemap at `/sitemap.xml` (Run 4.191); duplicate body fixed (Run 4.190); Yandex **VERIFIED** (Run 4.189) — header/footer **DO NOT OVERWRITE** |
