...
| **Notes** | TEST площадка. **MANUAL UI / CSS / TWIG / JS REFINEMENTS ARE CANONICAL**. Catalog UX cluster complete. **About page restored** to pre-M9.13 state. **Corporate Pages Visual Polish Pass 1** — **REJECTED BY OPERATOR** (2026-06-28); rolled back to **Pre-Pass-1** visual authority; **Pass 1.1 rules** registered ([Knowledge Map §24](knowledge/SITE-002-TECHNICAL-KNOWLEDGE-MAP.md#24-corporate-pages-visual-polish-pass-11--operator-rules)). EC-01 mitigated by subcategories hide (07). M10 not authorized. |
