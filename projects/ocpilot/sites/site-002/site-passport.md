...
**Status:** **SITE-002 NEW SECTIONS WAVE B MAPPING CHARTER COMPLETE — BOUNDED BACKFILL READY, BASELINE REFRESH BLOCKED** (Run 4.328; read-only XML/DB/map/importer review only; no structural moves; B1 narrowed to `95` and `364`)
**Run:** 4.328 — SITE-002 New Sections Wave B Mapping Charter 01 (2026-08-19)
...
| **Post-1C catalog monitor** | **BASELINE FILE 1879 — DO NOT REFRESH YET**; latest scheduled `2026-08-19_12-30-05` has effective classification **ONBOARDING_REQUIRED** although `run-summary.json` says `NO_ACTION_REQUIRED`; sitemap current **1887** vs baseline **1879**; onboarding still needed for `barnoe-oborudovanie`, `hlebopekarnoe-oborudovanie`, `holodilnoe-oborudovanie`, `posuda-i-inventar`, `Упаковочное оборудование`; resolve artifact consistency before trusting monitor summary · [healthcheck 4.325](reports/SITE-002-PROD-POST-1C-OFFERS-RECOVERY-AND-NEW-SECTIONS-HEALTHCHECK-01.md) · checkpoint [1879-08](baselines/SITE-002-STABLE-PROD-POST-1C-IMPORT-20260728-MONITOR-BASELINE-1879-08.md) · [baseline refresh 4.312](reports/SITE-002-MONITOR-BASELINE-REFRESH-08.md) · [forensic 4.319](reports/SITE-002-PROD-1C-FIRST-LEVEL-CATEGORY-PLACEMENT-FORENSIC-01.md) |
| **New sections onboarding / placement charter** | **WAVE B CHARTER COMPLETE; SAFE B1 SCOPE = `95` + `364`** (Run **4.328**) — Wave A onboarding of `hlebopekarnoe` and `holodilnoe` remains intact, but fresh XML/DB/map/importer review narrows mapping-ready scope to `holodilnoe` (`95`) and `posuda` (`364`) only; `hlebopekarnoe` root mapping deferred because current XML proves nested Tech `Хлебопекарное` overlap with `368`; `barnoe` current XML proof absent; `upakovochnoe` remains XML-only/404 and blocked from create/map while auto-create is disabled; baseline refresh remains blocked · [charter 4.328](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B-MAPPING-CHARTER-01.md) · [apply 4.327](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-A-ONBOARDING-APPLY-01.md) · [charter 4.326](reports/SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01.md) |
| **Catalog structure forensic** | **POST-IMPORT PERSISTENCE CONFIRMED (Run 4.299)** after importer patch **4.297** / mapping **4.296** / leaves **4.295** — natural imports SUCCESS; critical stay **378/379/380/376**; **demo Group A 154–170 deleted (Run 4.303)**; **legacy parent 153 physically deleted (Run 4.306)**; sitemap live **1879**; baseline file **1879** (Run **4.312**); import 2026-07-28 SUCCESS (Run **4.311**); no redirects; **ambiguous empties reviewed (Run 4.308)** — **119**=**99** leaves + **20** parents; discrepancy **RESOLVED**; DELETE_READY **0**; operator review **97** · **HITL triage (Run 4.309)** — decision sheet ready; WAIT **96** / KEEP **1** / DELETE_CAND **0**; apply not executed · **Neutral visibility diagnostic (Run 4.310)** — **60** empty leaves under **79** are DB+sitemap+HTTP but **UI sitemap-only** (Launch Mode product gates; intentional vs tech **362**) · [visibility diagnostic 4.310](reports/SITE-002-PROD-NEUTRAL-NEW-CATEGORIES-VISIBILITY-DIAGNOSTIC-01.md) · [HITL triage 4.309](reports/SITE-002-PROD-EMPTY-CATEGORIES-HITL-TRIAGE-01.md) · [review 4.308](reports/SITE-002-PROD-AMBIGUOUS-EMPTY-CATEGORIES-REVIEW-CHARTER-01.md) · [baseline refresh 4.307](reports/SITE-002-MONITOR-BASELINE-REFRESH-07.md) · [parent 153 delete apply 4.306](reports/SITE-002-PROD-PARENT-153-DELETE-APPLY-01.md) · [parent 153 review 4.305](reports/SITE-002-PROD-PARENT-153-REVIEW-CHARTER-01.md) · [baseline refresh 4.304](reports/SITE-002-MONITOR-BASELINE-REFRESH-06.md) · [delete apply](reports/SITE-002-PROD-DEMO-CATEGORY-DELETE-APPLY-01.md) · [demo cleanup](reports/SITE-002-PROD-DEMO-CATALOG-CLEANUP-CHARTER-01.md) · [legacy charter](reports/SITE-002-PROD-LEGACY-CATEGORY-CLEANUP-CHARTER-01.md) · [persistence check](reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) · [baseline refresh 4.300](reports/SITE-002-MONITOR-BASELINE-REFRESH-05.md) · [importer patch](reports/SITE-002-PROD-1C-IMPORTER-GUID-PATH-PATCH-01.md) · [mapping backfill](reports/SITE-002-PROD-1C-CATEGORY-MAPPING-BACKFILL-01.md) · [leaf apply](reports/SITE-002-PROD-1C-CANONICAL-LEAF-APPLY-01.md) |
| **Elektromehanicheskoe category image** | **LIVE (Run 4.298)** — category **375** `catalog/Category-image/elektromehanicheskoe.webp`; legacy **153** untouched; reconfirmed in Run **4.300** · [report](reports/SITE-002-PROD-ELEKTROMEHANICHESKOE-CATEGORY-IMAGE-APPLY-01.md) |
| **Catalog Section Tiles** | **ACTIVE + POLISHED + MEGA PARITY + ALL-15 FIRST-LEVEL** (Runs **4.285**–**4.287** + **4.314** + **4.316** + **4.317**, accepted **4.318**) — roots **Нейтральное** (79) + **Технологическое** (362); tile images for tech **368/373/369/371/372/370** + empty Neutral **82/83/85/87/89** (Run **4.317**); mega children via `buildHubChildCards` (neutral product gate for mega); ALL-15 Neutral tiles; empty copy on PLP only; no further image/copy apply · [healthcheck 4.318](reports/SITE-002-PROD-POST-IMAGE-WAVE-VISUAL-ACCEPTANCE-AND-1C-HEALTHCHECK-01.md) · [empty-copy+images](reports/SITE-002-PROD-EMPTY-CATEGORY-COPY-RELOCATE-AND-NEW-FIRSTLEVEL-IMAGES-01.md) · [all15 correction](reports/SITE-002-PROD-FIRST-LEVEL-BLOCK-ALL15-CORRECTION-APPLY-01.md) · [closeout](reports/SITE-002-PROD-FIRST-LEVEL-BLOCK-HYBRID-CLOSEOUT-01.md) · [hybrid apply](reports/SITE-002-PROD-FIRST-LEVEL-BLOCK-HYBRID-APPLY-01.md) · [scope decision](reports/SITE-002-PROD-FIRST-LEVEL-BLOCK-SCOPE-DECISION-01.md) · [first-level block charter](reports/SITE-002-PROD-POST-1C-NEUTRAL-FIRST-LEVEL-BLOCK-CHARTER-01.md) · [visibility diagnostic](reports/SITE-002-PROD-NEUTRAL-NEW-CATEGORIES-VISIBILITY-DIAGNOSTIC-01.md) · [megamenu children](reports/SITE-002-PROD-MEGAMENU-CHILDREN-AUTOMATION-01.md) · [polish](reports/SITE-002-PROD-CATALOG-TILE-POLISH-01.md) · [tiles](reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md) |
| **Custom blog / scheduled news** | **ACTIVE — STABLE** (Run **4.280** confirms Run **4.279**) — post **13** SEO+list+sliders+brand+readtime **OK**; mutation **0** · [multiday healthcheck](reports/SITE-002-PROD-MULTIDAY-HEALTHCHECK-01.md) · [final smoke 4.279](reports/SITE-002-PROD-BLOG-WAVE-FINAL-SMOKE-01.md) |
...
| **Offers XML / price-list form** | **RECOVERED / INTACT** — latest natural import `mars_1c_import_2026-08-19_080010.txt` includes real offers step with `offers0_1.xml`; product enablement recovered; price-list form fix + spam guard remain intact · [healthcheck 4.325](reports/SITE-002-PROD-POST-1C-OFFERS-RECOVERY-AND-NEW-SECTIONS-HEALTHCHECK-01.md) · prior [diagnostic 4.320](reports/SITE-002-PROD-1C-OFFERS-MISSING-AND-PRICE-FORM-DIAGNOSTIC-01.md) |
| **Price form spam guard (Run 4.321)** | **ACTIVE** layered anti-spam for dialog7 (honeypot/timestamp/risk/rate-limit); empty-lead + FormData fix preserved · [report](reports/SITE-002-PROD-PRICE-FORM-SPAM-GUARD-01.md) |
| **Stable checkpoint after spam guard (Run 4.322)** | Git tag `site-002/stable-prod-after-spam-guard-20260812`; operator spam observation **PRELIMINARY OK**; dealer form OK; later Run **4.325** closes the 1C offers gap and reclassifies next work to onboarding / placement / importer-mapping follow-up · [report](reports/SITE-002-PROD-STABLE-CHECKPOINT-AFTER-SPAM-GUARD-AND-CLEANUP-INVENTORY-01.md) · [healthcheck 4.325](reports/SITE-002-PROD-POST-1C-OFFERS-RECOVERY-AND-NEW-SECTIONS-HEALTHCHECK-01.md) |
| **Mail recipients** | **TEMP TEST — ONLY `client.leads@polygon-ws.ru`** (Run 4.264 DB confirm · Run 4.265 guard re-verify · Run 4.266 full form mail rerun) — `info@bzpm.ru` not restored; handler `checkout/anketa.php` + empty-lead guard OK · [full rerun](reports/SITE-002-PROD-FORM-MAIL-FULL-TEST-RERUN-01.md) · [follow-up](reports/SITE-002-PROD-FORM-EMPTY-LEAD-GUARD-FOLLOWUP-01.md) · [audit](reports/SITE-002-PROD-1C-LOGS-AND-FORM-MAIL-AUDIT-01.md) · [discovery](reports/SITE-002-PROD-MAIL-RECIPIENTS-DISCOVERY-01.md) · [confirmation](reports/SITE-002-PROD-MAIL-RECIPIENTS-ADMIN-ADD-01.md) |
...
| **Info page corporate intro images** | **ACTIVE — DELIVERY RESTORED** (Run **4.263**) — `/delivery` `.zpm-corp-intro` + `/assets/img/corporate/delivery-intro.jpg`; 1 FTP twig; 0 image/CSS; siblings unchanged · [restore](reports/SITE-002-PROD-INFO-PAGE-HERO-IMAGES-RESTORE-01.md) · [discovery](reports/SITE-002-PROD-INFO-PAGE-HERO-IMAGES-DISCOVERY-01.md) |
...
| **MARS 1C cron reports** | **DAILY HEALTHY — OFFERS STEP RECOVERED** — latest `mars_1c_import_2026-08-19_080010.txt` / `mars-20260819-080002-61559c39` SUCCESS; catalog PASS `4.07s`; offers PASS `3.86s`; total `7.98s`; category `364` recovered; category `95` no longer empty · [healthcheck 4.325](reports/SITE-002-PROD-POST-1C-OFFERS-RECOVERY-AND-NEW-SECTIONS-HEALTHCHECK-01.md) · prior [healthcheck 2026-07-15](reports/SITE-002-PROD-1C-DAILY-HEALTHCHECK-20260715-01.md) |
