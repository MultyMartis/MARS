...
| **Catalog structure forensic** | **1C MAPPING REVIEW REQUIRED** (Run **4.289**) — JG 210A placement mismatch (1C myaso vs legacy elektro public path); empty tech elektro **375**; dry-run cleanup plan only · [report](reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) |
