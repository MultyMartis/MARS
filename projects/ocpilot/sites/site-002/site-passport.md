...
| **Catalog structure forensic** | **REPARENTED (Run 4.290)** after forensic **4.289** — products moved to 1C hubs **373/375**; JG 210A now myaso; legacy leaves emptied not deleted; importer GUID fix still required · [reparent](reports/SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01.md) · [forensic](reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) |
