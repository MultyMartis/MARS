...
**Status:** **SITE-002 NEW SECTIONS ONBOARDING AND PLACEMENT CHARTER COMPLETE — APPLY WAVES READY, BASELINE REFRESH BLOCKED** (docs-only Run 4.326; safe default = no DB moves; onboarding/mapping/monitor waves split; baseline refresh blocked)
**Run:** 4.326 — SITE-002 New Sections Onboarding and Placement Charter 01 (2026-08-19)
...
| **New sections onboarding / placement charter** | **COMPLETE — SAFE APPLY PLAN READY** (Run **4.326**) — `barnoe` empty/live; `hlebopekarnoe` live with products; `holodilnoe` live with 1 product; `posuda` live but still DB-child under `362`; `upakovochnoe` XML-only/404; recommended default = keep DB placement stable, separate UI from structure, no structural moves in Wave A · [charter 4.326](reports/SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01.md) |
