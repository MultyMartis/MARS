...
| **Custom blog / scheduled news** | **ACTIVE — AUTOPUBLISH GATE** (Run **4.270**) — `CUSTOM_BLOG`; tables `oc_blog_posts`/`oc_blog_themes`; routes `/blog`, `/blog/news`, `/blog/news/{slug}`; gate `date_added <= NOW()` (Moscow); post_id **13** scheduled Barnaul **2026-07-16 07:00**; image logo **missing** · [report](reports/SITE-002-PROD-BLOG-SCHEDULED-NEWS-RCK-PRODUCTIVITY-01.md) |
