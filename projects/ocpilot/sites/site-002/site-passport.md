...
| **Post-1C catalog monitor** | **BASELINE FILE 1879 — DO NOT REFRESH YET**; run `2026-08-19_12-30-05`: **`monitor-classification.json` authoritative** (`ONBOARDING_REQUIRED`); `run-summary.json` wrong (runner merge bug); raw diff 1873/1865 = route churn, net +8; raw onboarding 219 inflated; Wave C diagnostic complete · [diagnostic 4.330](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C-MONITOR-DIAGNOSTIC-01.md) · [healthcheck 4.325](reports/SITE-002-PROD-POST-1C-OFFERS-RECOVERY-AND-NEW-SECTIONS-HEALTHCHECK-01.md) · checkpoint [1879-08](baselines/SITE-002-STABLE-PROD-POST-1C-IMPORT-20260728-MONITOR-BASELINE-1879-08.md) |
| **New sections onboarding / placement charter** | **WAVE C MONITOR DIAGNOSTIC COMPLETE** (Run **4.330**) — route churn explained; Wave B1 `95`/`364` mapped; baseline refresh blocked; next = Wave C2 monitor fix · [diagnostic 4.330](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C-MONITOR-DIAGNOSTIC-01.md) · [apply 4.329](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B1-MAPPING-BACKFILL-APPLY-01.md) · [charter 4.328](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B-MAPPING-CHARTER-01.md) · [apply 4.327](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-A-ONBOARDING-APPLY-01.md) · [charter 4.326](reports/SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01.md) |
