...
| **Category Lari reparent** | **ACTIVE — PARTIAL** (Run 4.235) — Лари **88** under **358**; canonical `/shkafy-i-lari/lari`; old `/lari` 301; post-1C verification pending · [implementation](reports/SITE-002-PROD-CATEGORY-LARI-REPARENT-IMPLEMENTATION-01.md) · [checkpoint](baselines/SITE-002-STABLE-PROD-CATEGORY-LARI-REPARENT-01.md) |
