...
| **Mail design system (Production)** | **FOUNDATION ACTIVE** (Run 4.223) — `ZpmMailRenderer` at `system/library/zpm/mail_renderer.php`; inactive; previews in Storage; next `SITE-002-PROD-MAIL-ADMIN-FORMS-01` · [report](reports/SITE-002-PROD-MAIL-DESIGN-SYSTEM-01.md) · [checkpoint](baselines/SITE-002-STABLE-PROD-MAIL-DESIGN-SYSTEM-01.md) |
