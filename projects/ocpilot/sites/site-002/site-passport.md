...
| **Category Lari reparent** | **DISCOVERY COMPLETE — CHARTER READY** (Run 4.234) — Лари id **88** `parent_id=79` (wrong); target parent **358**; hybrid reparent + 301 recommended · [discovery](reports/SITE-002-PROD-CATEGORY-LARI-REPARENT-DISCOVERY-01.md) |
