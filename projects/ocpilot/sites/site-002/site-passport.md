...
| **Mail design system (Production)** | **ACTIVE — ANKETA INTEGRATED — OPERATOR-VERIFIED** (Run 4.224 + Run 4.225) — `checkout/anketa.php` + `ZpmMailRenderer`; service info in admin mail; mailbox delivery/design confirmed by operator · [report](reports/SITE-002-PROD-MAIL-ADMIN-FORMS-01.md) · [inbox confirmation](reports/SITE-002-PROD-MAIL-ADMIN-FORMS-INBOX-CONFIRMATION-01.md) · [checkpoint](baselines/SITE-002-STABLE-PROD-MAIL-ADMIN-FORMS-01.md) |
