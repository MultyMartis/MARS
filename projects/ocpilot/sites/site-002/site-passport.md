...
| **Notes** | TEST площадка. **MANUAL UI / CSS / TWIG / JS REFINEMENTS ARE CANONICAL**. **Corporate intro blocks** — `.zpm-corp-intro` on 6 corp pages (2026-06-29) · [Knowledge Map §29](knowledge/SITE-002-TECHNICAL-KNOWLEDGE-MAP.md#29-corporate-intro-image-blocks-01--partial) · **`delivery-intro.jpg` HITL pending**. **Home CTA** — `zpm-commercial-trust` active (2026-06-29). **M9.13 About redesign RE-ACTIVATED** (2026-06-29). Local Fonts 01 **retained**. |
