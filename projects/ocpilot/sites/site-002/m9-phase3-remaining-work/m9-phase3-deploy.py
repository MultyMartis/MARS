#!/usr/bin/env python3
"""BZPM M9 Phase 3 — FTP deploy to TEST only (profiles 322, 207, 326)."""
import ftplib
import hashlib
import io
import json
...
BASE = r"C:\AI MARS\projects\ocpilot\sites\site-002\m9-phase3-remaining-work"
...
REMOTE_FILES = [
    ...
    "system/library/zpm/filter_profiles/80_moechnye_vanny.php",
    "system/library/zpm/filter_profiles/322_podtovarniki.php",
    "system/library/zpm/filter_profiles/207_zonty.php",
    "system/library/zpm/filter_profiles/326_telezhki.php",
...
def main():
    ...
    for rel in REMOTE_FILES:
        ...
        try:
            ...
            pre_path = os.path.join(BACKUP_DIR, f"pre-m9-phase3-{rel.replace('/', '__')}")
    ...
    manifest = {
        "task": "M9 Phase 3 remaining neutral branches (322, 207, 326)",
        "site": "SITE-002",
        "test_url": "https://zpm.new-site.space/",
        "rollback_source": "SITE-002-STABLE-M8.3-BEFORE-M9-20260615-0159",
        "phase2_rollback": "m9-phase2-sinks-work/backups/m9-phase2-deploy-20260614-195231.json",
    ...
    out = os.path.join(BACKUP_DIR, f"m9-phase3-deploy-{STAMP}.json")
