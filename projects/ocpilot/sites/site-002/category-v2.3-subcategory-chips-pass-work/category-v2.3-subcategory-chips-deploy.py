#!/usr/bin/env python3
"""SITE-002 CATEGORY V2.3 subcategory chips pass — FTP deploy."""
import ftplib
import hashlib
import io
import json
...
WORK_DIR = os.path.join(BASE, "category-v2.3-subcategory-chips-pass-work")
...
ROLLBACK = {
    "category.twig": os.path.join(BACKUP_DIR, "category.twig.pre-subcategory-chips-pass.bak"),
    "style.css": os.path.join(BACKUP_DIR, "style.css.pre-subcategory-chips-pass.bak"),
    "main.js": os.path.join(BACKUP_DIR, "main.js.pre-subcategory-chips-pass.bak"),
}
...
def main():
    ...
    manifest = {
        "stamp": STAMP,
        "task": "category-v2.3-subcategory-chips-pass",
    ...
    manifest_path = os.path.join(
        BACKUP_DIR, f"category-v2.3-subcategory-chips-deploy-manifest-{STAMP}.json"
    )
