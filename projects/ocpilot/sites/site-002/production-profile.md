...
**Last updated:** 2026-07-09 (Run 4.237 — contacts URL routing review; `/kontakty` 404; live `/contact`; implementation charter ready; checkpoint `SITE-002-STABLE-PROD-PARENT-CATEGORY-TILES-LARI-REMOVAL-01`)
...
| Contacts URL routing (Production) | **REVIEWED — CHARTER READY** (Run 4.237) — `/kontakty` **404**; live contacts **`/contact`** via native `information/contact` + `oc_seo_url` id **846** keyword `contact`; no `Контакты` information page; header/footer/corp links use `/contact` (working); sitemap omits contact route; target `/kontakty` via **Option E** charter · [report](reports/SITE-002-PROD-CONTACTS-URL-ROUTING-REVIEW-01.md) |
