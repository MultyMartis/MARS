...
| Catalog structure / 1C placement (Production) | **POSTCHECK CONFIRMED — PERSISTENCE NOT YET PROVEN** (Run **4.291**) — full confirmed group still **4707/4708/4710→373**, **4712→375**, **4709→376**; legacy **154/159/165** + **153** subtree products **0**; public/sitemap tech paths OK; latest 1C `2026-07-23_080010` predates reparent; importer GUID fix still required · [postcheck 4.291](reports/SITE-002-PROD-CANONICAL-REPARENT-POSTCHECK-01.md) · [reparent 4.290](reports/SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01.md) · forensic [4.289](reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) |
