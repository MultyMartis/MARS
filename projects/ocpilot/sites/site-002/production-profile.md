...
**Last updated:** 2026-07-27 (Run 4.301 — SITE-002-PROD-LEGACY-CATEGORY-CLEANUP-CHARTER-01 — read-only; Option A apply plan ready; no cleanup apply)
...
| Catalog structure / 1C placement (Production) | **POST-IMPORT PERSISTENCE CONFIRMED** (Run **4.299**) after importer GUID/path patch **4.297** / mapping **4.296** / leaves **4.295** — natural imports 2026-07-24..27 SUCCESS; critical **4707/4708→378**, **4710→379**, **4712→380**, **4709→376**; legacy **154/159/165** empty; sitemap **1854**; monitor baseline **1854** (Run **4.300**); **legacy cleanup charter READY** (Run **4.301**) — Option A 154/159/165 → 378/379/380; keep **153** temporarily; **apply not executed** · [cleanup charter 4.301](reports/SITE-002-PROD-LEGACY-CATEGORY-CLEANUP-CHARTER-01.md) · [persistence check 4.299](reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) · [baseline refresh 4.300](reports/SITE-002-MONITOR-BASELINE-REFRESH-05.md) · [importer patch 4.297](reports/SITE-002-PROD-1C-IMPORTER-GUID-PATH-PATCH-01.md) |
