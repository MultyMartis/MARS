...
**Last updated:** 2026-07-09 (Run 4.229 — info page corp CTA forms discovery; checkpoint `SITE-002-STABLE-PROD-MAIL-CUSTOMER-FORMS-01`)
...
| Info page corp CTA forms (Production) | **DISCOVERED — BROKEN / INTEGRATION CHARTER READY** (Run 4.229) — 5 corp footer forms on `/custom-equipment`, `/payment-methods`, `/delivery`, `/dealers`, `/guarantee` have markup but **no JS handler**; popup success-state reuse mapped; next task `SITE-002-PROD-INFO-PAGE-FORMS-INTEGRATION-01` · [discovery report](reports/SITE-002-PROD-INFO-PAGE-FORMS-DISCOVERY-01.md) · [audit baseline](baselines/SITE-002-INFO-PAGE-FORMS-DISCOVERY-01.md) |
