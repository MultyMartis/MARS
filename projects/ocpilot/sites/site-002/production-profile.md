...
| Catalog structure / 1C placement (Production) | **IDENTITY HARNESS COMPLETE — LEAF CREATION NEEDED** (Run **4.293**) — read-only XML↔DB harness; tech leaves missing for Мясорубки / Пилы / Хлеборезки; hubs **362/373/375/376** mappable; **4707/4708/4710/4712** still at risk of old-importer revert to **154/159/165**; persistence after next import **not proven**; legacy cleanup deferred · [harness 4.293](reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-HARNESS-01.md) · [charter 4.292](reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-FIX-CHARTER-01.md) · [postcheck 4.291](reports/SITE-002-PROD-CANONICAL-REPARENT-POSTCHECK-01.md) · [reparent 4.290](reports/SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01.md) |
