...
| Current Production checkpoint | [baselines/SITE-002-STABLE-PROD-NEW-SECTIONS-ENTRYPOINTS-02.md](baselines/SITE-002-STABLE-PROD-NEW-SECTIONS-ENTRYPOINTS-02.md) (parent [SITE-002-STABLE-PROD-PDP-EXTRA-INFO-LAYOUT-01.md](baselines/SITE-002-STABLE-PROD-PDP-EXTRA-INFO-LAYOUT-01.md)) |
...
| Neutral parent category tiles (Production) | **ACTIVE** (Run 4.195 + **4.220**) — **11** branches on homepage/hub `zpm-cat-card`; IDs `322,331,301,326,354,358,207,80,86,88,360`; WebP images incl. `lari`, `konditerskiy-inventar` (Run 4.220); `category_visibility.php`; **COMPOSER_ONLY_NO_API** · [4.195 report](reports/SITE-002-PROD-NEUTRAL-PARENT-CATEGORIES-ROLLOUT-01.md) · [4.220 report](reports/SITE-002-PROD-NEW-SECTIONS-ENTRYPOINTS-02.md) |
