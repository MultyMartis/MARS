...
**Last updated:** 2026-07-20 (Run 4.281 — SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05 — 6 tehnologicheskoe branches onboarded; baseline still 1714; next baseline refresh 04)
...
| Post-1C catalog monitor (Production) | **ONBOARDING 05 COMPLETE — BASELINE REFRESH PENDING** (Run **4.281**) — 6 `tehnologicheskoe-oborudovanie/*` meta+allowlist; manual `2026-07-20_18-05-09` target needs **0**; overall needs **230** (URL-format churn vs baseline **1714**); live sitemap **1737**; next **`SITE-002-MONITOR-BASELINE-REFRESH-04`** · [onboarding 05](reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) · prior [refresh 03](reports/SITE-002-MONITOR-BASELINE-REFRESH-03.md) · baseline [SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03](baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03.md) |
...
| Custom blog / scheduled news (Production) | **ACTIVE** (Run **4.279** smoke GREEN) — post **13** live; SEO `/blog/news/{slug}` + `/blog/news` via `seo_url.php` full-path bridge; sliders newest-first + reading time; brand `Завод` caps OK; literal `\n` **0**; sitemap **1714** (blog URLs not in Google sitemap by strategy); monitor **NO_ACTION_REQUIRED** · [final smoke 4.279](reports/SITE-002-PROD-BLOG-WAVE-FINAL-SMOKE-01.md) · [SEO routing 4.278](reports/SITE-002-PROD-BLOG-SEO-URL-ROUTING-FIX-01.md) |
