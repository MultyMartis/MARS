...
**Last updated:** 2026-07-28 (Run 4.311 — SITE-002-PROD-POST-1C-NEUTRAL-FIRST-LEVEL-BLOCK-CHARTER-01 — natural import SUCCESS; first-level block plan pending operator scope; live sitemap **1879**; baseline file still **1836**)
...
| Post-1C catalog monitor (Production) | **BASELINE FILE 1836** (Run **4.307**); live sitemap after import **2026-07-28** = **1879** (monitor `2026-07-28_13-31-41` `HYGIENE_REVIEW_REQUIRED`; baseline refresh **not** done in Run **4.311**) · checkpoint `SITE-002-STABLE-PROD-POST-PARENT-153-DELETE-MONITOR-BASELINE-1836-07` · **First-level block charter (Run 4.311)** — restore first-level plan pending operator scope; empty copy `Ожидайте, товары скоро поступят.`; apply not executed · [first-level block charter 4.311](reports/SITE-002-PROD-POST-1C-NEUTRAL-FIRST-LEVEL-BLOCK-CHARTER-01.md) · **Ambiguous empty review (Run 4.308)** — **119** = **99** leaves + **20** empty parents; 119 vs 99 **RESOLVED**; DELETE_READY **0**; operator review **97** · **HITL triage (Run 4.309)** — decision sheet ready; proposed WAIT **96** / KEEP **1** / DELETE_CAND **0**; apply not executed · **Neutral visibility diagnostic (Run 4.310)** — **60** empty leaves under **79** are DB+sitemap+HTTP but **UI sitemap-only** (product gates; intentional vs tech **362**) · [visibility diagnostic 4.310](reports/SITE-002-PROD-NEUTRAL-NEW-CATEGORIES-VISIBILITY-DIAGNOSTIC-01.md) · [HITL triage 4.309](reports/SITE-002-PROD-EMPTY-CATEGORIES-HITL-TRIAGE-01.md) · [review charter 4.308](reports/SITE-002-PROD-AMBIGUOUS-EMPTY-CATEGORIES-REVIEW-CHARTER-01.md) · [baseline refresh 4.307](reports/SITE-002-MONITOR-BASELINE-REFRESH-07.md) · [parent 153 delete apply 4.306](reports/SITE-002-PROD-PARENT-153-DELETE-APPLY-01.md) · [baseline refresh 4.304](reports/SITE-002-MONITOR-BASELINE-REFRESH-06.md) · [demo delete apply 4.303](reports/SITE-002-PROD-DEMO-CATEGORY-DELETE-APPLY-01.md) · prior [baseline refresh 4.300](reports/SITE-002-MONITOR-BASELINE-REFRESH-05.md) · prior [persistence check 4.299](reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) |
| Catalog structure / 1C placement (Production) | **POST-IMPORT PERSISTENCE CONFIRMED** (Run **4.299**) after importer GUID/path patch **4.297** / mapping **4.296** / leaves **4.295** — natural imports 2026-07-24..27 SUCCESS; critical **4707/4708→378**, **4710→379**, **4712→380**, **4709→376**; **demo Group A 154–170 physically deleted (Run 4.303)**; **legacy parent 153 physically deleted (Run 4.306)**; no redirects; sitemap live **1879** (post-import 2026-07-28); monitor baseline file still **1836** (Run **4.307**; refresh separate); critical canonical after import (Run **4.311**); ambiguous empties inventoried in Run **4.308** (**119** charter-style / **99** leaves; DELETE_READY **0**; operator review **97**); HITL triage Run **4.309** — decision sheet ready (WAIT **96** / KEEP **1** / DELETE_CAND **0**; apply not executed); **Run 4.310** — empty neutral leaves under **79** intentionally UI-hidden until products (not a data bug) · [visibility diagnostic 4.310](reports/SITE-002-PROD-NEUTRAL-NEW-CATEGORIES-VISIBILITY-DIAGNOSTIC-01.md) · [HITL triage 4.309](reports/SITE-002-PROD-EMPTY-CATEGORIES-HITL-TRIAGE-01.md) · [review charter 4.308](reports/SITE-002-PROD-AMBIGUOUS-EMPTY-CATEGORIES-REVIEW-CHARTER-01.md) · [baseline refresh 4.307](reports/SITE-002-MONITOR-BASELINE-REFRESH-07.md) · [parent 153 delete apply 4.306](reports/SITE-002-PROD-PARENT-153-DELETE-APPLY-01.md) · [parent 153 review 4.305](reports/SITE-002-PROD-PARENT-153-REVIEW-CHARTER-01.md) · [delete apply 4.303](reports/SITE-002-PROD-DEMO-CATEGORY-DELETE-APPLY-01.md) · [demo cleanup 4.302](reports/SITE-002-PROD-DEMO-CATALOG-CLEANUP-CHARTER-01.md) · [legacy charter 4.301](reports/SITE-002-PROD-LEGACY-CATEGORY-CLEANUP-CHARTER-01.md) · [persistence check 4.299](reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) · [baseline refresh 4.300](reports/SITE-002-MONITOR-BASELINE-REFRESH-05.md) · [importer patch 4.297](reports/SITE-002-PROD-1C-IMPORTER-GUID-PATH-PATCH-01.md) |
| Catalog Section Tiles (Production) | **ACTIVE + POLISHED + MEGA PARITY** (Runs **4.285**–**4.287** + **4.298**) — EN/RU Catalog Section Tiles; roots **79** + **362**; tech name `Технологическое оборудование`; tile images for **368/373/369/371/372/370** (+ regen **373/364/369/368**) + **375** `elektromehanicheskoe.webp` (Run **4.298**); `.btn.zpm-catalog__all-link` → `/katalog/`; mega menu children for section hubs via `buildHubChildCards`; **neutral product gate still live**; Run **4.311** plans optional first-level restore (apply not executed) · [first-level block charter 4.311](reports/SITE-002-PROD-POST-1C-NEUTRAL-FIRST-LEVEL-BLOCK-CHARTER-01.md) · [visibility diagnostic 4.310](reports/SITE-002-PROD-NEUTRAL-NEW-CATEGORIES-VISIBILITY-DIAGNOSTIC-01.md) · [elektro image 4.298](reports/SITE-002-PROD-ELEKTROMEHANICHESKOE-CATEGORY-IMAGE-APPLY-01.md) · [megamenu children 4.287](reports/SITE-002-PROD-MEGAMENU-CHILDREN-AUTOMATION-01.md) · [polish 4.286](reports/SITE-002-PROD-CATALOG-TILE-POLISH-01.md) · [tiles 4.285](reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md) |
