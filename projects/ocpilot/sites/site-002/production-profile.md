...
| Post-1C catalog monitor (Production) | **WAVE C2 FIX APPLIED (Run 4.331)** — runner merge precedence fixed; semantic route-churn layer; exact diff preserved for SEO audit; baseline file **1879 — DO NOT REFRESH YET**; fixture regression PASS; runtime scheduled validation pending · [apply 4.331](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C2-MONITOR-FIX-APPLY-01.md) · [diagnostic 4.330](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C-MONITOR-DIAGNOSTIC-01.md) · [baseline refresh 4.312](reports/SITE-002-MONITOR-BASELINE-REFRESH-08.md) |
| New sections onboarding / placement charter (Production) | **WAVE C2 MONITOR FIX APPLIED** (Run **4.331**) — semantic onboarding filter + expanded `ONBOARDED_CATEGORY_PATHS`; Wave B1 `95`/`364` complete; `barnoe`/`upakovochnoe` still open; baseline refresh blocked · [apply 4.331](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C2-MONITOR-FIX-APPLY-01.md) · [diagnostic 4.330](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C-MONITOR-DIAGNOSTIC-01.md) · [apply 4.329](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B1-MAPPING-BACKFILL-APPLY-01.md) |
