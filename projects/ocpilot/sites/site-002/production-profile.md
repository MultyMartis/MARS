...
**Last updated:** 2026-07-23 (Run 4.290 — SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01 — products moved to 1C canonical hubs; baseline still 1737)
...
| Catalog structure / 1C placement (Production) | **REPARENTED TO 1C CANONICAL HUBS** (Run **4.290**) — products **4707/4708/4710→373** (myaso), **4712→375** (tech elektro); JG 210A public/canonical under myaso; legacy leaves **154/159/165** emptied not deleted; **375** now has 1 product; importer GUID/name-collision fix still required · [reparent 4.290](reports/SITE-002-PROD-1C-CANONICAL-CATEGORY-REPARENT-01.md) · forensic [4.289](reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) |
