...
**Last updated:** 2026-07-09 (Run 4.235 — category Lari reparent implementation; checkpoint `SITE-002-STABLE-PROD-CATEGORY-LARI-REPARENT-01`; post-1C import verification pending)
...
| Category Lari reparent (Production) | **ACTIVE — PARTIAL** (Run 4.235) — Лари id **88** `parent_id=358` (under Шкафы и лари); canonical `/katalog/nejtralnoe-oborudovanie/shkafy-i-lari/lari`; old flat `/lari` **301**; sitemap nested only; `seo_pro` `category.seopath` cache + `getPathByCategory` patched; homepage Лари marketing tile href nested; **post-1C import verification pending** · [implementation report](reports/SITE-002-PROD-CATEGORY-LARI-REPARENT-IMPLEMENTATION-01.md) · [checkpoint](baselines/SITE-002-STABLE-PROD-CATEGORY-LARI-REPARENT-01.md) · [discovery](reports/SITE-002-PROD-CATEGORY-LARI-REPARENT-DISCOVERY-01.md) |
