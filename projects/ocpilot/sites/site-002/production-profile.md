...
**Last updated:** 2026-08-25 (Run 4.344 — SITE-002-CATALOG-NORMALIZATION-UI-REPAIR-01 — catalog root UI aligned to 8-root model; sitemap live **1861** vs baseline **1887**)
...
| Catalog normalization UI repair (Production) | **COMPLETE (Run 4.344)** — `category_visibility.php` Launch Mode aligned to 8 approved roots; home + `/katalog/` show 8 root tiles; DB unchanged · [repair 4.344](reports/SITE-002-CATALOG-NORMALIZATION-UI-REPAIR-01.md) |
