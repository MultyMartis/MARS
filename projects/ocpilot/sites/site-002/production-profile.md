...
**Last updated:** 2026-07-20 (Run 4.282 — SITE-002-PROD-REGRESSION-HOTFIX-01 — parent-path PDP restored + has_children notices removed; blog SEO preserved; baseline still 1714; next baseline refresh 04)
...
| Post-1C catalog monitor (Production) | **ONBOARDING 05 COMPLETE — HOTFIX 4.282 APPLIED — BASELINE REFRESH PENDING** (Run **4.281** + **4.282**) — 6 `tehnologicheskoe-oborudovanie/*` meta+allowlist; Run **4.282** restored parent-path PDP + removed public `has_children` notices (FTP `seo_url.php`+`header.php`); live sitemap **1737**; baseline still **1714**; next **`SITE-002-MONITOR-BASELINE-REFRESH-04`** · [hotfix](reports/SITE-002-PROD-REGRESSION-HOTFIX-01.md) · [onboarding 05](reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) · prior [refresh 03](reports/SITE-002-MONITOR-BASELINE-REFRESH-03.md) · baseline [SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03](baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03.md) |
