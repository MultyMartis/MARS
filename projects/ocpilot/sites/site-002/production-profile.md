...
**Last updated:** 2026-07-20 (Run 4.284 — SITE-002-PROD-ADMIN-CACHE-CLEANER-BUTTON-RESTORE-01 — admin cache-cleaner top-bar restored via Modifications refresh; baseline still 1714)
...
| Post-1C catalog monitor (Production) | **ONBOARDING 05 + HOTFIX 4.282 + MEGAMENU 4.283 + CACHE BUTTON 4.284 — BASELINE REFRESH PENDING** (Runs **4.281**–**4.284**) — tehnologicheskoe meta+allowlist; PDP+notices+mega menu cold-cache fixed; admin `oc3x_storage_cleaner` top-bar restored (OCMOD refresh); live sitemap **1737**; baseline still **1714**; next **`SITE-002-MONITOR-BASELINE-REFRESH-04`** · [cache button 4.284](reports/SITE-002-PROD-ADMIN-CACHE-CLEANER-BUTTON-RESTORE-01.md) · [megamenu 4.283](reports/SITE-002-PROD-MEGAMENU-AND-CACHE-PLUGIN-DIAGNOSTIC-01.md) · [hotfix 4.282](reports/SITE-002-PROD-REGRESSION-HOTFIX-01.md) · [onboarding 05](reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) · baseline [SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03](baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03.md) |
