...
**Last updated:** 2026-07-20 (Run 4.285 — SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01 — Catalog Section Tiles; tech root 362; baseline still 1714)
...
| Post-1C catalog monitor (Production) | **ONBOARDING 05 + HOTFIX 4.282 + MEGAMENU 4.283 + CACHE BUTTON 4.284 + TILES 4.285 — BASELINE REFRESH PENDING** (Runs **4.281**–**4.285**) — tehnologicheskoe meta+allowlist; PDP+notices+mega menu cold-cache fixed; admin cache button restored; Catalog Section Tiles peer roots **79+362**; live sitemap **1737**; baseline still **1714**; next **`SITE-002-MONITOR-BASELINE-REFRESH-04`** · [tiles 4.285](reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md) · [cache button 4.284](reports/SITE-002-PROD-ADMIN-CACHE-CLEANER-BUTTON-RESTORE-01.md) · [megamenu 4.283](reports/SITE-002-PROD-MEGAMENU-AND-CACHE-PLUGIN-DIAGNOSTIC-01.md) · [hotfix 4.282](reports/SITE-002-PROD-REGRESSION-HOTFIX-01.md) · [onboarding 05](reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) · baseline [SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03](baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03.md) |
| Catalog Section Tiles (Production) | **ACTIVE** (Run **4.285**) — EN: Catalog Section Tiles / RU: Плитки разделов каталога; Launch Mode visible roots **79** + **362**; home + `/katalog` dual blocks; tech children DB-driven; neutral children still `$neutral_hub_branch_ids`; fallback `placeholder.png`; authority `system/library/zpm/category_visibility.php` · [report](reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md) |
