...
**Last updated:** 2026-07-28 (Run 4.313 — SITE-002-PROD-FIRST-LEVEL-BLOCK-SCOPE-DECISION-01 — HYBRID recommended; baseline **1879** current; UI apply not executed)
...
| Post-1C catalog monitor (Production) | **BASELINE FILE 1879** (Run **4.312**); after `2026-07-28_15-23-10` **NO_ACTION_REQUIRED** · checkpoint `SITE-002-STABLE-PROD-POST-1C-IMPORT-20260728-MONITOR-BASELINE-1879-08` · **First-level block scope decision (Run 4.313)** — **HYBRID RECOMMENDED**; SHOW **80/86/207/301/322/326/331/354/358/360**; HIDE/WAIT **82/83/85/87/89**; empty copy `Ожидайте, товары скоро поступят.`; apply not executed · [scope decision 4.313](reports/SITE-002-PROD-FIRST-LEVEL-BLOCK-SCOPE-DECISION-01.md) · [first-level block charter 4.311](reports/SITE-002-PROD-POST-1C-NEUTRAL-FIRST-LEVEL-BLOCK-CHARTER-01.md) · [visibility diagnostic 4.310](reports/SITE-002-PROD-NEUTRAL-NEW-CATEGORIES-VISIBILITY-DIAGNOSTIC-01.md) · [HITL triage 4.309](reports/SITE-002-PROD-EMPTY-CATEGORIES-HITL-TRIAGE-01.md) · [review charter 4.308](reports/SITE-002-PROD-AMBIGUOUS-EMPTY-CATEGORIES-REVIEW-CHARTER-01.md) · [baseline refresh 4.312](reports/SITE-002-MONITOR-BASELINE-REFRESH-08.md) |
