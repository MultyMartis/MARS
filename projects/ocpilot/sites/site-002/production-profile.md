...
**Last updated:** 2026-07-27 (Run 4.299 — SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01 — post-patch persistence CONFIRMED; sitemap live 1854; baseline still 1737)
...
| Post-1C catalog monitor (Production) | **BASELINE 1737 — LIVE 1854 / ONBOARDING_REQUIRED** (Run **4.299** persistence check; monitor `2026-07-27_12-30-02`: added **119**, needs **7**; artifacts agree `ONBOARDING_REQUIRED` — prior summary/classification conflict **not** present in latest run); baseline **not** refreshed in 4.299 · [persistence check 4.299](reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) · prior forensic [4.289](reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) · checkpoint `SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1737-04` |
| Catalog structure / 1C placement (Production) | **POST-IMPORT PERSISTENCE CONFIRMED** (Run **4.299**) after importer GUID/path patch **4.297** / mapping **4.296** / leaves **4.295** — natural imports 2026-07-24..27 SUCCESS; critical **4707/4708→378**, **4710→379**, **4712→380**, **4709→376**; legacy **154/159/165** empty; sitemap **1854**; baseline still **1737**; next = baseline refresh charter · [persistence check 4.299](reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) · [importer patch 4.297](reports/SITE-002-PROD-1C-IMPORTER-GUID-PATH-PATCH-01.md) · [mapping backfill 4.296](reports/SITE-002-PROD-1C-CATEGORY-MAPPING-BACKFILL-01.md) · [leaf apply 4.295](reports/SITE-002-PROD-1C-CANONICAL-LEAF-APPLY-01.md) |
...
| Elektromehanicheskoe category image (Production) | **ACTIVE** (Run **4.298**) — category **375** under **362**; `catalog/Category-image/elektromehanicheskoe.webp` + `300×300` cache; DB image bind; legacy **153** untouched; **COMPOSER_ONLY_NO_API**; baseline still **1737** · [report](reports/SITE-002-PROD-ELEKTROMEHANICHESKOE-CATEGORY-IMAGE-APPLY-01.md) |
