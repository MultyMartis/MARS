...
**Last updated:** 2026-07-10 (Run 4.242 — Audit Wave C Redirect Hygiene **NO-OP COMPLETE**; AUDIT-006 resolved; Run 4.240 post-1C verification **still BLOCKED**; checkpoint `SITE-002-STABLE-PROD-CRON-RUN-REPORTS-DURATION-FIX-01`)
...
| MARS 1C cron wrapper | **OPERATIONAL — DURATION REPORTING FIX DEPLOYED** (Run 4.239) — wrapper v**1.1.1**; TXT total `Duration` uses run wall start; first scheduled run verified Run 4.194; schedule `0 8 * * *` Moscow; Sergey legacy **preserved**; **next import TXT confirmation pending** · [duration fix report](reports/SITE-002-PROD-CRON-RUN-REPORTS-DURATION-FIX-01.md) |
| MARS 1C cron reports | **PATCHED — CONFIRMATION PENDING** (Run 4.239) — wrapper v**1.1.1**; fix deployed `2026-07-09T17:07:52+00:00`; latest TXT `mars_1c_import_2026-07-09_080009.txt` is **pre-patch** (`Duration: 0 seconds`); Run **4.240** gate **BLOCKED** — await **2026-07-10+** scheduled import · [verification Run 4.240](reports/SITE-002-PROD-POST-1C-LARI-REPARENT-AND-DURATION-VERIFICATION-01.md) · [duration fix](reports/SITE-002-PROD-CRON-RUN-REPORTS-DURATION-FIX-01.md) |
...
| Category Lari reparent (Production) | **ACTIVE — PARTIAL** (Run 4.235) — Лари id **88** `parent_id=358` (under Шкафы и лари); canonical `/katalog/nejtralnoe-oborudovanie/shkafy-i-lari/lari`; old flat `/lari` **301**; sitemap nested only; parent tile **88** removed Run 4.236; **post-1C import verification pending** — Run **4.240 BLOCKED** (no post-patch import yet) · [verification Run 4.240](reports/SITE-002-PROD-POST-1C-LARI-REPARENT-AND-DURATION-VERIFICATION-01.md) · [implementation report](reports/SITE-002-PROD-CATEGORY-LARI-REPARENT-IMPLEMENTATION-01.md) · [parent tiles report](reports/SITE-002-PROD-PARENT-CATEGORY-TILES-LARI-REMOVAL-01.md) · [checkpoint](baselines/SITE-002-STABLE-PROD-PARENT-CATEGORY-TILES-LARI-REMOVAL-01.md) |
