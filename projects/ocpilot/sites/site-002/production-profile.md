...
**Last updated:** 2026-07-23 (Run 4.289 — SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01 — catalog structure forensic; 1C mapping review required; baseline still 1737)
...
| Catalog structure / 1C placement (Production) | **FORENSIC COMPLETE — 1C MAPPING REVIEW REQUIRED** (Run **4.289**) — JG 210A (`product_id=4710`) in 1C under Мясоперерабатывающее→Пилы для мяса, but DB/public under legacy Электромеханическое оборудование (**153/159**); empty tech elektro **375** in menu/sitemap; dry-run cleanup only · [report](reports/SITE-002-PROD-CATALOG-STRUCTURE-FORENSIC-01.md) |
