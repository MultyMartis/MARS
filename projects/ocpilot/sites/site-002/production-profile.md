...
**Last updated:** 2026-07-20 (Run 4.286 — SITE-002-PROD-CATALOG-TILE-POLISH-01 — tech name + tile images + all-link `/katalog/`; baseline still 1714)
...
| Post-1C catalog monitor (Production) | **ONBOARDING 05 + HOTFIX 4.282–4.286 POLISH — BASELINE REFRESH PENDING** (Runs **4.281**–**4.286**) — tehnologicheskoe onboarded + tiles + name/images/all-link polish; live sitemap churn vs baseline **1714**; next **`SITE-002-MONITOR-BASELINE-REFRESH-04`** · [polish 4.286](reports/SITE-002-PROD-CATALOG-TILE-POLISH-01.md) · [tiles 4.285](reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md) · [cache button 4.284](reports/SITE-002-PROD-ADMIN-CACHE-CLEANER-BUTTON-RESTORE-01.md) · [megamenu 4.283](reports/SITE-002-PROD-MEGAMENU-AND-CACHE-PLUGIN-DIAGNOSTIC-01.md) · [hotfix 4.282](reports/SITE-002-PROD-REGRESSION-HOTFIX-01.md) · [onboarding 05](reports/SITE-002-PROD-CATALOG-NEW-BRANCH-ONBOARDING-05.md) · baseline [SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03](baselines/SITE-002-STABLE-PROD-POST-1C-MONITOR-BASELINE-1714-03.md) |
| Catalog Section Tiles (Production) | **ACTIVE + POLISHED** (Runs **4.285** + **4.286**) — EN/RU Catalog Section Tiles; roots **79** + **362**; tech name `Технологическое оборудование`; tile images for **368/373/369/371/372/370** under `catalog/Category-image/`; `.btn.zpm-catalog__all-link` → `/katalog/` (`megamenu.twig`); fallback `placeholder.png` remains for **364** posuda · [polish 4.286](reports/SITE-002-PROD-CATALOG-TILE-POLISH-01.md) · [tiles 4.285](reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md) |
