...
**Last updated:** 2026-07-23/24 (Run 4.298 — SITE-002-PROD-ELEKTROMEHANICHESKOE-CATEGORY-IMAGE-APPLY-01 — category 375 tile image live; baseline still 1737)
...
| Catalog structure / 1C placement (Production) | **IMPORTER GUID/PATH PATCH DEPLOYED** (Run **4.297**) after mapping backfill **4.296** — `import_1C.php` + `import_1C_process.php`; GUID map → path → collision guard; auto-create disabled; dry-run critical products **378/379/380/376**; post-import persistence check next; baseline still **1737** · [importer patch 4.297](reports/SITE-002-PROD-1C-IMPORTER-GUID-PATH-PATCH-01.md) · [mapping backfill 4.296](reports/SITE-002-PROD-1C-CATEGORY-MAPPING-BACKFILL-01.md) · [leaf apply 4.295](reports/SITE-002-PROD-1C-CANONICAL-LEAF-APPLY-01.md) · [leaf charter 4.294](reports/SITE-002-PROD-1C-CANONICAL-LEAF-CREATION-CHARTER-01.md) · [harness 4.293](reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-HARNESS-01.md) · [identity charter 4.292](reports/SITE-002-PROD-1C-CATEGORY-IDENTITY-FIX-CHARTER-01.md) |
