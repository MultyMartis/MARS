...
**Last updated:** 2026-07-10 (Run 4.248 — Post-1C verification **PARTIAL** — Lari **CONFIRMED**, Duration **PENDING**; checkpoint `SITE-002-STABLE-PROD-AUDIT-WAVE-E-INFO-META-H1-01` unchanged)
...
| MARS 1C cron reports | **PATCHED — CONFIRMATION PENDING** (Run 4.239) — wrapper v**1.1.1**; fix deployed `2026-07-09T17:07:52+00:00`; latest TXT still **pre-patch** (`mars_1c_import_2026-07-09_080009.txt`, `Duration: 0 seconds`); Run **4.248** re-verify **PARTIAL** — await **2026-07-10 08:00 MSK+** import · [verification Run 4.248](reports/SITE-002-PROD-POST-1C-LARI-REPARENT-AND-DURATION-VERIFICATION-02.md) · [duration fix](reports/SITE-002-PROD-CRON-RUN-REPORTS-DURATION-FIX-01.md) |
...
| Category Lari reparent (Production) | **ACTIVE — LARI CONFIRMED** (Run 4.235 + Run 4.248) — Лари id **88** `parent_id=358`; category_path nested; canonical `/shkafy-i-lari/lari`; flat `/lari` **301** (HEAD no-follow verified); sitemap nested only; Run **4.248** DB+HTTP **PASS** at current state · [verification Run 4.248](reports/SITE-002-PROD-POST-1C-LARI-REPARENT-AND-DURATION-VERIFICATION-02.md) · [implementation](reports/SITE-002-PROD-CATEGORY-LARI-REPARENT-IMPLEMENTATION-01.md) · [parent tiles](reports/SITE-002-PROD-PARENT-CATEGORY-TILES-LARI-REMOVAL-01.md) |
