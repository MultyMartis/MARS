...
**Last updated:** 2026-07-27 (Run 4.304 — SITE-002-MONITOR-BASELINE-REFRESH-06 — baseline **1854→1837** after demo delete; checkpoint `SITE-002-STABLE-PROD-POST-DEMO-CATEGORY-DELETE-MONITOR-BASELINE-1837-06`; monitor **NO_ACTION_REQUIRED**; parent **153** pending review)
...
| Post-1C catalog monitor (Production) | **BASELINE 1837 — NO_ACTION_REQUIRED** (Run **4.304**); refreshed after demo category delete apply; manual `2026-07-27_17-07-47` **NO_ACTION_REQUIRED**; needs **0**; checkpoint `SITE-002-STABLE-PROD-POST-DEMO-CATEGORY-DELETE-MONITOR-BASELINE-1837-06` · [baseline refresh 4.304](reports/SITE-002-MONITOR-BASELINE-REFRESH-06.md) · prior [baseline refresh 4.304](reports/SITE-002-MONITOR-BASELINE-REFRESH-06.md) · [delete apply 4.303](reports/SITE-002-PROD-DEMO-CATEGORY-DELETE-APPLY-01.md) · prior [baseline refresh 4.300](reports/SITE-002-MONITOR-BASELINE-REFRESH-05.md) · prior [persistence check 4.299](reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) |
| Catalog structure / 1C placement (Production) | **POST-IMPORT PERSISTENCE CONFIRMED** (Run **4.299**) after importer GUID/path patch **4.297** / mapping **4.296** / leaves **4.295** — natural imports 2026-07-24..27 SUCCESS; critical **4707/4708→378**, **4710→379**, **4712→380**, **4709→376**; **demo Group A 154–170 physically deleted (Run 4.303)**; parent **153** kept (0 children); no redirects; sitemap live **1837**; monitor baseline **1837** (Run **4.304**); ambiguous empty cats **119** untouched · [delete apply 4.303](reports/SITE-002-PROD-DEMO-CATEGORY-DELETE-APPLY-01.md) · [demo cleanup 4.302](reports/SITE-002-PROD-DEMO-CATALOG-CLEANUP-CHARTER-01.md) · [legacy charter 4.301](reports/SITE-002-PROD-LEGACY-CATEGORY-CLEANUP-CHARTER-01.md) · [persistence check 4.299](reports/SITE-002-PROD-1C-POST-IMPORT-PERSISTENCE-CHECK-01.md) · [baseline refresh 4.300](reports/SITE-002-MONITOR-BASELINE-REFRESH-05.md) · [importer patch 4.297](reports/SITE-002-PROD-1C-IMPORTER-GUID-PATH-PATCH-01.md) |
| Catalog Section Tiles (Production) | **ACTIVE + POLISHED + MEGA PARITY** (Runs **4.285**–**4.287** + **4.298**) — EN/RU Catalog Section Tiles; roots **79** + **362**; tech name `Технологическое оборудование`; tile images for **368/373/369/371/372/370** (+ regen **373/364/369/368**) + **375** `elektromehanicheskoe.webp` (Run **4.298**); `.btn.zpm-catalog__all-link` → `/katalog/`; mega menu children for section hubs via `buildHubChildCards` · [elektro image 4.298](reports/SITE-002-PROD-ELEKTROMEHANICHESKOE-CATEGORY-IMAGE-APPLY-01.md) · [megamenu children 4.287](reports/SITE-002-PROD-MEGAMENU-CHILDREN-AUTOMATION-01.md) · [polish 4.286](reports/SITE-002-PROD-CATALOG-TILE-POLISH-01.md) · [tiles 4.285](reports/SITE-002-PROD-CATALOG-TILE-BLOCKS-AUTOMATION-01.md) |
