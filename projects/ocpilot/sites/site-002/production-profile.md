...
| Post-1C catalog monitor (Production) | **BASELINE FILE 1879 — DO NOT REFRESH YET** (Run **4.312** baseline still current); latest scheduled `2026-08-19_12-30-05`: **`monitor-classification.json` authoritative = ONBOARDING_REQUIRED**; `run-summary.json` `NO_ACTION_REQUIRED` is runner merge bug (Wave C diagnostic 4.330); raw string diff `1873 added / 1865 removed` = route migration churn (`/katalog/` baseline vs root pretty current); net sitemap +8; raw onboarding 219 inflated (≤10 real); baseline refresh blocked until Wave C2 monitor fix + gate · [diagnostic 4.330](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C-MONITOR-DIAGNOSTIC-01.md) · [healthcheck 4.325](reports/SITE-002-PROD-POST-1C-OFFERS-RECOVERY-AND-NEW-SECTIONS-HEALTHCHECK-01.md) · checkpoint `SITE-002-STABLE-PROD-POST-1C-IMPORT-20260728-MONITOR-BASELINE-1879-08` · [baseline refresh 4.312](reports/SITE-002-MONITOR-BASELINE-REFRESH-08.md) |
| New sections onboarding / placement charter (Production) | **WAVE C MONITOR DIAGNOSTIC COMPLETE** (Run **4.330**) — route churn + runner artifact bug explained; Wave B1 mapping for `95`/`364` complete; `barnoe`/`upakovochnoe` still open by design; baseline refresh still blocked; next = Wave C2 monitor fix after approval + observe next natural 1C import · [diagnostic 4.330](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-C-MONITOR-DIAGNOSTIC-01.md) · [apply 4.329](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B1-MAPPING-BACKFILL-APPLY-01.md) · [charter 4.328](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B-MAPPING-CHARTER-01.md) · [apply 4.327](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-A-ONBOARDING-APPLY-01.md) · [charter 4.326](reports/SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01.md) |
