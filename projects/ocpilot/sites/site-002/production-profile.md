...
| Current Production checkpoint | [baselines/SITE-002-STABLE-PROD-POLKI-CATEGORY-IMAGE-01.md](baselines/SITE-002-STABLE-PROD-POLKI-CATEGORY-IMAGE-01.md) (parent [SITE-002-STABLE-PROD-NEUTRAL-CATEGORY-IMAGES-WHITE-BG-01.md](baselines/SITE-002-STABLE-PROD-NEUTRAL-CATEGORY-IMAGES-WHITE-BG-01.md); cron [SITE-002-STABLE-PROD-CRON-SCHEDULED-RUN-01.md](baselines/SITE-002-STABLE-PROD-CRON-SCHEDULED-RUN-01.md); SEO [SITE-002-STABLE-PROD-SITEMAP-01.md](baselines/SITE-002-STABLE-PROD-SITEMAP-01.md)) |
| SEO readiness (Production) | **META PARTIAL — RUNTIME AUTHORITY MAPPED** (Runs 4.192–4.193, discovery 4.198) — home + 3 category PLP admin OK; corp pages use **custom controllers** with hardcoded meta (admin information fields not runtime); katalog hub `product/katalog.php`; blog hub missing description; category IDs 331/354/358 mapped · [runtime discovery](reports/SITE-002-PROD-SEO-INFORMATION-META-RUNTIME-DISCOVERY-01.md) · [meta content](reports/SITE-002-PROD-SEO-META-CONTENT-FIX-01.md) |
