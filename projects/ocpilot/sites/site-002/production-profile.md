...
**Last updated:** 2026-08-19 (Run 4.329 — SITE-002-PROD-NEW-SECTIONS-WAVE-B1-MAPPING-BACKFILL-APPLY-01 — Wave B1 mapping backfill complete for `95` and `364`; excluded categories untouched; baseline refresh still blocked)
...
| New sections onboarding / placement charter (Production) | **WAVE B1 MAPPING BACKFILL COMPLETE** (Run **4.329**) — bounded `oc_mars_1c_category_map` upsert for `holodilnoe` (`95`, GUID `95bfa611-898d-11f1-aece-581122cf362c`) and `posuda` (`364`, GUID `9b37b1f1-7c19-11f1-aecc-581122cf362c`); `364` remains DB-child under `362`; `hlebopekarnoe`/`barnoe`/`upakovochnoe` still unmapped by design; baseline refresh remains blocked; next = Wave C monitor diagnostic + observe next natural 1C import · [apply 4.329](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B1-MAPPING-BACKFILL-APPLY-01.md) · [charter 4.328](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-B-MAPPING-CHARTER-01.md) · [apply 4.327](reports/SITE-002-PROD-NEW-SECTIONS-WAVE-A-ONBOARDING-APPLY-01.md) · [charter 4.326](reports/SITE-002-PROD-NEW-SECTIONS-ONBOARDING-PLACEMENT-CHARTER-01.md) · [healthcheck 4.325](reports/SITE-002-PROD-POST-1C-OFFERS-RECOVERY-AND-NEW-SECTIONS-HEALTHCHECK-01.md) |
