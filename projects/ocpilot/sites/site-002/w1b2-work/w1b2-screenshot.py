#!/usr/bin/env python3
"""Capture PDP screenshots for Wave 1B.2 QA."""
import asyncio
import os
import sys
...
OUT = r"C:\AI MARS\projects\ocpilot\sites\site-002\qa\w1b2-screenshots"
URL = (
...
SHOTS = [
    ...
    ("desktop-page-full", 1440, 900, False, None, True),
    ...
    async with async_playwright() as p:
        ...
        for name, w, h, mobile, selector, full_page in SHOTS:
            context = await browser.new_context(
                ...
                is_mobile=mobile,
                user_agent="MARS-W1B2-Screenshot/1.0",
