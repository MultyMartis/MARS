...
class ControllerInformationPayment extends Controller {
	...
	public function index() {
		...
		$pageintro->description = '<p>ООО «Завод пищевого машиностроения» (ЗПМ) работает с&nbsp;юридическими лицами и&nbsp;индивидуальными предпринимателями по&nbsp;безналичному расчёту. Оплата проходит по&nbsp;выставленному счёту — после согласования состава заказа и&nbsp;коммерческих условий с&nbsp;менеджером.</p>'
