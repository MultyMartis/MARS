# OpenCart 2.3.0 — Clean Baseline

**Purpose:** versioned reference folder for a **clean baseline** of **OpenCart 2.3.0**.
...
|--------|------------------|
| `files/` | Sanitized vendor file tree for OpenCart 2.3.0 |
