# OpenCart 3.0.3.7 — Clean Baseline

**Purpose:** versioned reference folder for a **clean baseline** of **OpenCart 3.0.3.7**.
...
|--------|------------------|
| `files/` | Sanitized vendor file tree for OpenCart 3.0.3.7 |
