# ocStore 3.0.3.7 — Clean Baseline

**Purpose:** versioned reference folder for a **clean baseline** of **ocStore 3.0.3.7**.
...
|--------|------------------|
| `files/` | Sanitized vendor file tree for ocStore 3.0.3.7 |
...
| `comparison-notes/` | Known ocStore differences vs upstream OpenCart 3.0.3.7 |
