# ocStore 3.0.3.8 (rs.2) — Priority Baseline

**Purpose:** priority baseline folder for **real OCPilot target sites** running **ocStore 3.0.3.8 (rs.2)**.
...
- Canonical source remains `incoming/baselines/opencart-3.0.3.8-rs.zip` — promoted tree is reference working baseline only.
...
|--------|------------------|
| `files/` | Sanitized vendor file tree for ocStore 3.0.3.8 (rs.2) |
