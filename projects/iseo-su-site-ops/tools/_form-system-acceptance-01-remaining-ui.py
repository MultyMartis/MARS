#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Remaining unique-UI browser tests after career handler + fill harness fixes.

Isolated test_mode only. Unique phones. No production recipient.
"""
...
OUT = EVIDENCE / "_remaining-ui.json"
SITE = acc.SITE
...
def main() -> None:
    ...
    report["summary"] = {
        "pass": [
            (b.get("label"), b.get("body"), b.get("pass"), b.get("success_ui"), b.get("request_url"), b.get("error"))
