...
**Updated:** 2026-09-04 (NICHE PAGES WAVE 04 — static inventory 132 → 139)  
**Companion evidence:** `ISEO-SU-NICHE-PAGES-WAVE-04-EVIDENCE-v1.md` · `ISEO-SU-CITY-PAGES-WAVE-02-EVIDENCE-v1.md` · `ISEO-SU-STATIC-SITEMAP-COMPLETENESS-FIX-EVIDENCE-v1.md` · historical `ISEO-SU-HIGH-FIX-WAVE-01-EVIDENCE-v1.md`
...
**Historical note:** HIGH FIX WAVE 01 shipped a valid 71-URL static sitemap whose allowlist was later shown incomplete by SEO review; completeness fix 01 expanded coverage to 127 without abandoning deny-safe allowlist discipline. **CITY PAGES WAVE 02** (2026-09-03) added five regional SEO landings under `/services/seo/prodvizhenie-v-*.html` → static inventory **127 → 132**. **NICHE PAGES WAVE 04** (2026-09-04) added seven niche SEO landings under `/services/seo/` → static inventory **132 → 139**; completeness gate still PASS.
