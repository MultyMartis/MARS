...
$username = iseo_form_first_scalar(array("rf_name"), 120);
$method = iseo_form_first_scalar(array("rf_contact", "rf_ontact"), 80);
$contact = iseo_form_first_scalar(array("rf_phone"), 120);
$comment = iseo_form_first_scalar(array("rf_comment"), 2000);
...
$msg .= "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;padding-bottom:10px;margin-bottom:10px;'>Новый отзыв со страницы</h2>\r\n";
...
$msg .= "<p><strong>Отзыв:</strong> " . iseo_form_h($comment) . "</p>\r\n";
