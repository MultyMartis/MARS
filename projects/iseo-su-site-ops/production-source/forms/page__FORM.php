...
$method = iseo_form_first_scalar(array("pf_contact", "pf_ontact"), 80);
$contact = iseo_form_first_scalar(array("pf_phone"), 120);
$site = iseo_form_first_scalar(array("pf_site"), 300);
$comment = iseo_form_first_scalar(array("pf_comment"), 2000);
if ($username === null || $method === null || $contact === null || $site === null || $comment === null) {
...
foreach (array($username, $method, $contact, $site, $comment, $page_title, $page_link) as $v) {
...
$fields = array($username, $method, $contact, $site, $comment);
...
$msg .= "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;padding-bottom:10px;margin-bottom:10px;'>Заявка обратной связи</h2>\r\n";
