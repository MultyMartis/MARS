...
| `/glossary/` | `…/glossary/` | 404 anon | WORDPRESS_CONTENT | HIGH | Glossary archive (pre-launch gated) | CPT `glossary` + `archive-glossary.php` | glossary CPT | — | archive-glossary.php | theme `archive-glossary.php` | theme+css | theme | search GET only | glossary ACF | **glossary** | no | no | slash alias | — | theme + drafts; gate constant | theme+DB | restore theme; delete glossary drafts only | anon 404 until gate | do not publish empties | publication gate |
| `/glossary/{slug}/` | same | 404 anon | WORDPRESS_CONTENT | HIGH | Glossary term | CPT `glossary` + `single-glossary.php` | glossary | slug | single-glossary.php | theme `single-glossary.php` | theme+css | theme | — | synonyms/keywords/LSI | **glossary** | no | no | — | — | WP Admin draft→publish later | DB | revisions/delete draft | preview only pre-launch | no invented definitions | `.html` suffix choice open |
...
| `/sitemap.xml` | same | 200 | HYBRID_COMPOSITE | HIGH | Sitemap index | Yoast index + static | — | — | — | WP Yoast + `sitemap-static.xml` | — | — | — | — | — | no | no | — | — | Yoast settings / static file | both | restore | index lists static+WP | SEO | child sitemap 404 probes |
| `/sitemap-static.xml` | same | 200 | STATIC_HARDCODED | HIGH | Static URL inventory | file (71 URLs) | — | — | — | `sitemap-static.xml` | — | — | — | — | — | no | no | — | — | SFTP | file | restore | count/URLs | SEO | keep in sync with pages |
