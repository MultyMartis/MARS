...
| `/sitemap-static.xml` | same | 200 | STATIC_HARDCODED | HIGH | Static URL inventory | allowlist + completeness inventory + generator (**127** URLs) | — | — | — | `sitemap-static.xml` | — | — | — | — | — | no | no | — | — | SFTP + regen | file+procedure | restore | XML/count/URLs + completeness=0 | SEO | keep allowlist≡inventory |
