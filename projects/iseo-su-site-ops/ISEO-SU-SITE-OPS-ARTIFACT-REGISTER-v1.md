...
| Sitemap architecture | `ISEO-SU-SITEMAP-ARCHITECTURE-AND-CURRENT-STATE-v1.md` | CURRENT / SPECIALIZED / CANONICAL |
| Static sitemap completeness | `ISEO-SU-STATIC-SITEMAP-COMPLETENESS-FIX-EVIDENCE-v1.md`; SEO note `reports/ISEO-SU-STATIC-SITEMAP-COMPLETENESS-FIX-FOR-SEO-TEAM.md`; REPORT `reports/REPORT-ISEO-SU-SITE-OPS-STATIC-SITEMAP-COMPLETENESS-FIX-01.md`; inventory `data/sitemaps/public-canonical-static-routes-v1.txt`; validator `tools/validate-sitemap-static-completeness.py` | CURRENT / SPECIALIZED / CANONICAL |
