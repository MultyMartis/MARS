# ORCA Semantic Intelligence Architecture

**Locus:** `projects/orca/architecture/semantic-intelligence/`  
...
1. ADR v1
2. Operator approval record (A1–A7)
3. Research promotion matrix
4. Authority model
5. Information flow and state machine
6. Admission policy
7. Quality gates
8. Component responsibility matrix
9. Contract family plan
