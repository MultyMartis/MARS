...
const FL = {
  tonn: { title: "Манипулятор 5 тонн", slug: "5-tonn.html", d1: "Борт 5 т, стрела 3 т", role: "capability_crosslink" },
  byt: { title: "Перевозка бытовок", slug: "bytovki.html", d1: "Установка на объекте", role: "use_case_crosslink" },
  stroy: { title: "Доставка стройматериалов", slug: "stroymaterialy.html", d1: "Паллеты и блоки", role: "use_case_crosslink" },
  b2b: { title: "Для юрлиц", slug: "yurlic.html", d1: "Безнал и НДС", role: "b2b_crosslink" },
  vez: { title: "Манипулятор-вездеход", slug: "vezdehod.html", d1: "Полный привод 6x6", role: "capability_crosslink" },
  obor: { title: "Перевозка оборудования", slug: "oborudovanie.html", d1: "Станки и агрегаты", role: "use_case_crosslink" },
  kont: { title: "Перевозка контейнеров", slug: "konteynery.html", d1: "Блок-контейнеры", role: "use_case_crosslink" },
  arm: { title: "Перевозка арматуры", slug: "armatura.html", d1: "Металл и длинномер", role: "use_case_crosslink" },
  kir: { title: "Кирпич и блоки", slug: "kirpich-bloki.html", d1: "Подача на объект", role: "use_case_crosslink" },
  fbs: { title: "ФБС и ЖБИ", slug: "fbs-zhbi.html", d1: "Тяжёлые элементы", role: "use_case_crosslink" },
  kray: { title: "По Краснодарскому краю", slug: "kray.html", d1: "Межгород и край", role: "geo_crosslink" },
};
...
const groups = [
  ...
  group({
    ...
    landing_type: "use_case",
    final_url: url("stroymaterialy.html"),
    ...
    ads: [
      ad({
        ...
        landing: url("stroymaterialy.html"),
  ...
  group({
    ...
    landing_type: "use_case",
    final_url: url("oborudovanie.html"),
  ...
  group({
    ...
    landing_type: "use_case",
    final_url: url("kirpich-bloki.html"),
    ...
    ads: [
      ad({
        ...
        landing: url("kirpich-bloki.html"),
