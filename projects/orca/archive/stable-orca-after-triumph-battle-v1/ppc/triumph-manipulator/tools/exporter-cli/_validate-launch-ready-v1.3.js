...
/**
 * Launch-ready QA gate v1.3 — bids, cross-negatives, hygiene, transport split.
...
const { LEGACY_NEGATIVE_PATTERNS } = require("./cross-negative-matrix-v1.3");
...
async function main() {
  ...
  for (const [groupName, bids] of bidsByGroup) {
