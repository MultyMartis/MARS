...
const DATASET_PATH = path.join(ROOT, 'production/direct-commander-production-dataset-v7.json');
const OUTPUT = path.join(ROOT, 'exports/CORVONERO-YANDEX-DIRECT-COMMANDER-v7.xlsx');
...
async function main() {
  ...
  fs.writeFileSync(
    path.join(ROOT, 'production/validation/export-run-result-v7.json'),
