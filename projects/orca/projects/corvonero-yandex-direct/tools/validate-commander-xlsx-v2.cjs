...
/**
 * Strict structural validation for Corvonero Commander XLSX v2.
 */
const fs = require('fs');
...
const XLSX = path.join(ROOT, 'exports/CORVONERO-YANDEX-DIRECT-COMMANDER-v2.xlsx');
const DATASET = path.join(ROOT, 'production/direct-commander-production-dataset-v2.json');
const OUT_JSON = path.join(ROOT, 'production/validation/direct-commander-v2-validation.json');
const OUT_MD = path.join(ROOT, 'production/validation/direct-commander-v2-validation.md');
