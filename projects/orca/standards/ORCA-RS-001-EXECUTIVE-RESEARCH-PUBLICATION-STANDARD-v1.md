# ORCA-RS-001 — Executive Research Publication Standard v1

**Standard ID:** ORCA-RS-001  
**Status:** **ACTIVE** — permanent ORCA research publication standard  
**Date:** 2026-07-02  
**Authority:** ORCA methodology (`projects/orca`); human-operated; **not** runtime enforcement  
**Provenance:** Migrated from WF-RS-001 (2026-07-02) — originally registered under Website Factory; architectural correction assigns Executive Research Publication to **ORCA**, not Website Factory. Historical registration: [../../mars-website-factory/standards/WF-RS-001-EXECUTIVE-RESEARCH-PUBLICATION-STANDARD-v1.md](../../mars-website-factory/standards/WF-RS-001-EXECUTIVE-RESEARCH-PUBLICATION-STANDARD-v1.md) (**SUPERSEDED — migrated to ORCA**).  
**Reference implementation:** BZPM Market Intelligence — Executive Presentation Package v2.1 RU  
**Path:** `projects/website-factory/execution-cases/bzpm-market-intelligence/executive-report/`

**Related:** [orca-standards-register-v1.md](../orca-standards-register-v1.md) · [research/orca-research-layer-v0.md](../research/orca-research-layer-v0.md) · [evidence/evidence-classification-system-v0.md](../evidence/evidence-classification-system-v0.md) · Website Factory consumer lane: [../../mars-website-factory/research-standards-v1.md](../../mars-website-factory/research-standards-v1.md) · [../../mars-website-factory/publication-standards-v1.md](../../mars-website-factory/publication-standards-v1.md)

---

## 1. Purpose

Fix the **two-level research model** for ORCA. From this standard forward, **no ORCA research program is complete** until an **Executive Research Package** is published.
...
| Layer | Role |
|-------|------|
| **MIG** | Acquisition — SERP, Wordstat, competitors, evidence, normalization, discovery |
| **ORCA** | Research, analytics, classification, benchmark, conclusions, **Executive Package publication**, knowledge |
| **Website Factory** | **Consumes** ORCA research publications — does **not** own or publish Executive Research |
...
Mandatory **final** deliverable of every completed ORCA research program.
...
| **Website Factory** | Strategy, IA, design, SEO, development inputs — **consumer only** |
...
**Folder convention:** `executive-report/` or `executive-research/` under the research program root (execution case or ORCA project folder).
...
| Citation as ORCA reference | Yes |
| **Website Factory consumption** | Yes — Factory may cite and use published package per Factory operational rules |

### Explicitly blocked before gate

- Marking research wave/program **COMPLETE**
- Registering research as ORCA knowledge without Executive Package path
- Client handoff of internal Registry / Presentation Pack **as final deliverable**
- Website Factory treating internal research artifacts **as** executive publication

---

## 9. Relationship to other layers

| Layer | Role relative to ORCA-RS-001 |
|-------|------------------------------|
| **MIG** | Upstream acquisition — feeds Level 1; ORCA owns interpretation and publication |
...
| **Research Canon RV-01–03** | Foundry immutable snapshots — separate lane; ORCA-RS-001 applies to **ORCA research programs** |
| **Website Factory** | **Consumer** of ORCA Executive Research Package — uses results for IA, design, SEO, development; **does not** own this standard |
| **artifact-publication-semantics-v0** (Factory) | General artifact publication classes — ORCA-RS-001 adds **research-specific mandatory package** at ORCA layer |
...
| Standard | **ORCA-RS-001** (first reference implementation) |
...
ORCA-RS-001 applies to **all ORCA research programs** including:
...
- Client discovery research feeding IA, design, SEO, or development (via Website Factory consumption)
...
- **Not** a Website Factory standard — Factory **consumes** ORCA publications per [../../mars-website-factory/website-factory-operational-rules-v1.md](../../mars-website-factory/website-factory-operational-rules-v1.md)
...
| Date | Change |
|------|--------|
| 2026-07-02 | v1 — initial standard from BZPM Market Intelligence executive package practice (registered as WF-RS-001 under Website Factory) |
| 2026-07-02 | **Architectural migration** — normative ownership transferred to ORCA as **ORCA-RS-001**; WF-RS-001 **SUPERSEDED** (historical registration preserved) |
