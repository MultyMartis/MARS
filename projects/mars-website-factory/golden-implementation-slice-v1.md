...
| **Conversion blocks** | `hero`, `lead_form`, `cta_band`, `pricing`, `cases`, `social_proof`, `faq`, `contact_block` + `sticky_cta` (orphan module) |
...
- **Scripts order:** lifecycle → modal → form → sticky_cta → main (fixed in page template)
