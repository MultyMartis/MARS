...
| **Subsystem** | **Forge WordPress** — [subsystems/forge-wordpress/](subsystems/forge-wordpress/README.md) (**FOUNDATION**; FW-02 complete; contracts + standards **documented**; implementation **not started**). |
