...
- **Artifact Bus Layer v0** (movement / envelope / routing / transfer / lineage / publication / consumption / governance / delivery bus / transfer QA — **documentation only**, **not** a queue, **not** an event bus, **not** runtime/Kafka-style transport): [artifact-bus-overview-v0.md](artifact-bus-overview-v0.md).
