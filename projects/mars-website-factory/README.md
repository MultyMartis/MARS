...
*Last updated: 2026-05-12 — **Artifact Bus Layer v0** doc hardening: [artifact-bus-overview-v0.md](artifact-bus-overview-v0.md) (**artifact state propagation**), [artifact-routing-rules-v0.md](artifact-routing-rules-v0.md) (**Frontend QA fail → invalidates Delivery Candidate** shorthand), [layer-map.md](layer-map.md) §8, [artifact-governance-rules-v0.md](artifact-governance-rules-v0.md) (AGENTS link). Bus layer remains **documentation only** — **not** a queue, **not** an event bus, **not** runtime transport. Earlier 2026-05-12 notes: Semantic Relationship Layer v0, Reference Project Layer v0; 2026-05-11: Execution Semantics, Prompt Standards, Artifact Architecture, workflow v0, agent cards, registries — all documentation only.*
