...
|---------|------|--------------|----------|----------------|-------------|----------------------------|---------------------|-------------|-----------------|--------------|----------|---------------|
| `MLI-TOOL-007` | WP-CLI | PROVEN | `X:\MARS-Localhost\tools\wp-cli\` | 2.12.0 | LOCAL_RUNTIME | inspect, validate read-only | prod write, arbitrary SQL | R0–R2 local | INDIRECT | CLI JSON stdout | DB restore | MLI activate |
