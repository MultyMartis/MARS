...
| SCSS | G-SCS | HTML + foundation | Scoped styles | Forge / gulp agent | `scss_authorized` | pre-SCSS checklist FAIL · **CSS Variable First Law** · **Universal Style Scale Law** · **STYLE SCALE GATE** · **TOKEN ADMISSION GATE** · **CONTAINER GATE** · **SECTION RHYTHM GATE** | Visual QA |
