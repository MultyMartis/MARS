...
| SCSS | G-SCS | HTML + foundation | Scoped styles | Forge / gulp agent | `scss_authorized` | pre-SCSS checklist FAIL · **CSS Variable First Law** arbitrary value · **CONTAINER GATE** · **SECTION RHYTHM GATE** | Visual QA |
