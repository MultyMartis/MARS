...
```bat
findstr /i /s "DB_HOST" D:\MARS-Localhost\sites\wordpress\*\*\wp-config.php
```
...
| TLS private keys | `D:\MARS-Localhost\laragon\etc\ssl\` | Git |
...
Scripts: `D:\MARS-Localhost\tools\hosts\add-mli-host.ps1`
