...
**Physical site storage (canonical):** `D:\MARS-Localhost\sites`
...
|--------|-------------|---------|
| **A — Direct document root** | Set Laragon `DocumentRoot` = `D:\MARS-Localhost\sites` | **REJECTED** — Auto Virtual Hosts would expose category folders (`wordpress.test`, `php.test`) |
...
Laragon www (registry layer):
  D:\MARS-Localhost\laragon\www\{slug}  → junction to physical path
...
**Remains:** `D:\MARS-Localhost\laragon\www`
...
| Item | Value |
|------|-------|
| Physical path | `D:\MARS-Localhost\sites\php\synthetic\mli-smoke-001` |
