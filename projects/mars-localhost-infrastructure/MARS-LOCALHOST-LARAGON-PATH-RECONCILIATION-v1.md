...
| Field | Value |
|-------|-------|
| **Actual install path** | `D:\MARS-Localhost\laragon` |
| **Previous preferred path (MLI-00)** | `D:\MARS-Localhost\runtime\laragon` |
| **Final canonical Laragon root** | `D:\MARS-Localhost\laragon` |
...
1. Operator installed Laragon at `D:\MARS-Localhost\laragon` before MLI-01 enablement.
...
| Field | Value |
|-------|-------|
| **Path** | `D:\MARS-Localhost\runtime\laragon` |
...
| **Forge WordPress / OCPilot** | Consumer pointers use `D:\MARS-Localhost\laragon` |
