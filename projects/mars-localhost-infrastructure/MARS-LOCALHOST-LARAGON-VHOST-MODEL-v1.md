...
Physical path: X:\MARS-Localhost\sites\{platform}\{class}\{slug}\
```
...
| Certificate storage (target) | `X:\MARS-Localhost\certificates\` |
...
```text
X:\MARS-Localhost\certificates\   # MLI target store
...
`X:\AI MARS\projects\mars-localhost-infrastructure\manifests\`
