...
| **Local runtime path** | `D:\MARS-Localhost\sites\wordpress\synthetic\fws-0001` |
| **Local URL (HTTP)** | `http://fws-0001.test/` |
| **Local URL (HTTPS)** | `https://fws-0001.test/` |
| **Canonical URL** | `http://fws-0001.test/` |
| **Junction** | `D:\MARS-Localhost\laragon\www\fws-0001` |
...
| **wp-config** | `D:\MARS-Localhost\sites\wordpress\synthetic\fws-0001\wp-config.php` |
