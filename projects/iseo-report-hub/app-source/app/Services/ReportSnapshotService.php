...
final class ReportSnapshotService
{
    ...
    {
        $gates = [
            'monthly_exists' => ['pass' => true, 'detail' => 'Месячный отчет найден.'],
            'status_finalized' => ['pass' => false, 'detail' => 'Статус должен быть «Финализирован».'],
            'finalized_at_present' => ['pass' => false, 'detail' => 'Нужна дата финализации.'],
            'preview_renderable' => ['pass' => false, 'detail' => 'Предпросмотр не собирается.'],
            'render_mode_valid' => ['pass' => false, 'detail' => 'Режим генерации некорректен.'],
            'has_non_archived_blocks' => ['pass' => false, 'detail' => 'Нет активных блоков отчета.'],
            'required_blocks_present' => ['pass' => false, 'detail' => 'Не найдены обязательные блоки.'],
            'no_draft_or_in_progress_blocks' => ['pass' => false, 'detail' => 'Остаются черновые блоки.'],
            'source_weekly_refs_resolve' => ['pass' => false, 'detail' => 'Связанные недельные заметки не найдены.'],
        ];
        ...
        $gates['status_finalized'] = [
            ...
            'detail' => $status === 'finalized'
                ...
                : 'Текущий статус: «' . \Iseo\Support\UiLabels::status($status) . '».',
        ];
        ...
        $gates['finalized_at_present'] = [
            'pass' => $hasFinalizedAt,
            'detail' => $hasFinalizedAt ? 'Дата финализации заполнена.' : 'Дата финализации не заполнена.',
        ];
        ...
        $gates['render_mode_valid'] = [
            ...
            'detail' => $modeValid
                ...
                : 'Режим генерации «' . $renderMode . '» не допускается.',
        ];
        ...
        $gates['required_blocks_present'] = [
            ...
            'detail' => $missingRequired === []
                ...
                : 'Не найдено: ' . implode(', ', $missingRequired),
        ];
