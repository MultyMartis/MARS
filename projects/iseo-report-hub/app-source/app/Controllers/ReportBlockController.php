...
final class ReportBlockController extends BaseController
{
    ...
    public function indexForMonthlyReport(int $monthlyReportId): void
    {
        ...
        $this->render('report-blocks/index', [
            'pageTitle' => 'Блоки отчета — ' . (string) ($monthly['period_key'] ?? $monthlyReportId),
            'monthly' => $monthly,
            'blocks' => $rows,
            'canCreate' => $canCreate,
    ...
    public function create(int $monthlyReportId): void
    {
        ...
        $this->render('report-blocks/create', [
            'pageTitle' => 'Создание блока отчета',
            'mode' => 'create',
            'monthly' => $monthly,
            'block' => null,
    ...
    public function show(int $id): void
    {
        ...
        $this->render('report-blocks/show', [
            'pageTitle' => 'Блок отчета — ' . ui_block_label((string) $block['block_key']),
            'block' => $block,
            'monthly' => $monthly,
    ...
    public function edit(int $id): void
    {
        ...
        $this->render('report-blocks/edit', [
            'pageTitle' => 'Редактирование блока отчета',
            'mode' => 'edit',
            'monthly' => $monthly,
            'block' => $block,
    ...
    {
        $this->renderAccessDenied('У вас нет прав на это действие с блоком отчета.');
    }
