...
final class WeeklyCheckpointController extends BaseController
{
    ...
    public function indexForPeriod(int $periodId): void
    {
        ...
        $this->render('weekly-checkpoints/index', [
            'pageTitle' => 'Еженедельные заметки — ' . (string) $period['period_key'],
            'period' => $period,
            'checkpoints' => $items,
    ...
    public function show(int $id): void
    {
        ...
        $this->render('weekly-checkpoints/show', [
            'pageTitle' => 'Недельная заметка ' . (string) $checkpoint['checkpoint_key'],
    ...
    public function create(int $periodId): void
    {
        ...
        $this->render('weekly-checkpoints/create', [
            'pageTitle' => 'Создание недельной заметки',
            'mode' => 'create',
            'period' => $period,
            'checkpoint' => null,
    ...
    public function edit(int $id): void
    {
        ...
        $this->render('weekly-checkpoints/edit', [
            'pageTitle' => 'Редактирование недельной заметки ' . (string) $checkpoint['checkpoint_key'],
            'mode' => 'edit',
            'period' => $period,
            'checkpoint' => $checkpoint,
