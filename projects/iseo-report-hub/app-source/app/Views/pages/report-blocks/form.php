...
<section class="panel">
    <p class="note">
        ...
        · <a href="<?= e(url_path('/monthly-reports/' . $monthlyId . '/blocks')) ?>">Block list</a>
    </p>
</section>
...
<section class="panel">
    <h2><?= $isEdit ? 'Edit report block' : 'Create report block' ?></h2>
    <form class="rp-form rb-form" method="post" action="<?= e($action) ?>" novalidate>
        ...
        <label>
            ...
            <span class="field-hint">Parent monthly report is immutable. No hard delete — archive via status.</span>
        </label>
        ...
        <div class="form-row">
            <label>
                ...
                <?php if ($locks['block_key']): ?><span class="field-hint">Block key locked outside draft (admin_owner may override).</span><?php endif; ?>
            ...
            <label>
                ...
                <?php if ($locks['block_type']): ?>
                    ...
                    <span class="field-hint">Block type locked outside draft.</span>
                <?php endif; ?>
        ...
        <div class="form-row">
            <label>
                ...
                <span class="field-hint">Manual integer order (no drag/drop).</span>
            </label>
            <label>
                <span>Status</span>
        ...
        <fieldset class="checkbox-fieldset"<?= $locks['source_ids'] ? ' disabled' : '' ?>>
            ...
            <?php if ($availableCheckpoints === []): ?>
                <p class="note">No weekly checkpoints in parent period.</p>
            <?php else: ?>
        ...
        <label>
            <span>data_json (object or array)</span>
        ...
        <label>
            <span>source_metric_refs (object or array)</span>
        ...
        <p class="form-actions">
            <button type="submit" class="btn"><?= $isEdit ? 'Save block' : 'Create block' ?></button>
