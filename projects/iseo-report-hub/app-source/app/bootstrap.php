...
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Support' . DIRECTORY_SEPARATOR . 'UiLabels.php';
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Support' . DIRECTORY_SEPARATOR . 'FieldHelp.php';
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Support' . DIRECTORY_SEPARATOR . 'UiTextSanitizer.php';
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Support' . DIRECTORY_SEPARATOR . 'ClientReportDocument.php';
...
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Repositories' . DIRECTORY_SEPARATOR . 'SeoWorkCategoryRepository.php';
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Repositories' . DIRECTORY_SEPARATOR . 'SeoWorkItemRepository.php';
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Repositories' . DIRECTORY_SEPARATOR . 'MonthlyReportWorkEntryRepository.php';
...
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Services' . DIRECTORY_SEPARATOR . 'MonthlyReportWorkEntryService.php';
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Services' . DIRECTORY_SEPARATOR . 'MonthlyReportSummaryAssemblyService.php';
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Services' . DIRECTORY_SEPARATOR . 'MonthlyReportSummaryApplyService.php';
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Services' . DIRECTORY_SEPARATOR . 'SpecialistReportContentWorkflowService.php';
...
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . 'MonthlyReportWorkEntryController.php';
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . 'MonthlyReportAssemblyController.php';
require_once ISEO_APP_PATH . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . 'MonthlyReportContentWorkflowController.php';
