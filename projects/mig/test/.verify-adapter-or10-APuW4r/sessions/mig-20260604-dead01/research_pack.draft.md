...
| Field | Value |
|-------|-------|
| Session ID | mig-20260604-dead01 |
| Stage | draft |
...
| Field | Value |
|-------|-------|
| Discovery pass | 2026-06-03T19:59:26.769Z |
| Phase | 2 |
...
|----|------|--------|-------|----------|-------|-------------|
| mig-20260604-dead01-c001 | Манипулятор-Сервис Краснодар | manipulator-krd.ru | serp_organic | single | B | аренда манипулятора Краснодар |

**Rules:** rule_serp_organic_top_n

| mig-20260604-dead01-c002 | Кран-Логистик | kran-logistik.ru | serp_organic | single | B | аренда манипулятора Краснодар |

**Rules:** rule_serp_organic_top_n

| mig-20260604-dead01-c003 | Авито — аренда спецтехники | avito.ru | serp_organic, aggregator, marketplace_listing | multi_surface | B | аренда манипулятора Краснодар |
...
|----------|------------|-----|--------|-------|--------|
| mig-20260604-dead01-ws001 | mig-20260604-dead01-c001 | https://manipulator-krd.ru/ | failed | X | unknown |
| mig-20260604-dead01-ws002 | mig-20260604-dead01-c002 | https://kran-logistik.ru/uslugi | failed | X | unknown |

Session coverage: **minimal** · Section grade: **X**

## Website observations

### mig-20260604-dead01-ws001 (manipulator-krd.ru)

- Ref: `snapshots/sites/mig-20260604-dead01-ws001/website_snapshot.json`

### mig-20260604-dead01-ws002 (kran-logistik.ru)

- Ref: `snapshots/sites/mig-20260604-dead01-ws002/website_snapshot.json`
