...
| **This repository (`C:\MARS Phenix\AI MARS`)** | **Architecture / contracts / knowledge** — documentation packs, integration boundaries, and governance alignment. **MARS does not execute MetaBOT workflows.** |
