...
> **Production supersession (2026-08-17):** Live card actions include ✅ Обработано · 🚫 Спам · 📄 Исходная заявка (literal source, not field reconstruction). Canonical: [baselines/PRODUCTION-STABLE-BASELINE-2026-08-17.md](../baselines/PRODUCTION-STABLE-BASELINE-2026-08-17.md).
