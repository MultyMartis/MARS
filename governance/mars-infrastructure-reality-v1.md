...
| **Localhost runtime (execution, out-of-git)** | `D:\MARS-Localhost` | Shared Windows local web runtime: Laragon at `D:\MARS-Localhost\laragon`, MLI tools under `tools\`, CMS sites under `sites\`, databases, logs. **Not** MARS brain, **not** Git authority. MLI-03 WordPress synthetic runtime MLI-WP-SYN-001 active (2026-06-23). Governed from [projects/mars-localhost-infrastructure/](../projects/mars-localhost-infrastructure/OPERATIONAL-INDEX.md). |
