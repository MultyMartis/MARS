...
| C16 | **Website Factory (strategic planned)** | **Documentation-first** target for **multi-agent static website production** (intake → delivery): registries, workflow map, QA gates, **Gulp Frontend Agent** as documented production specialist (**legacy-bridge** in registry), **Validator** integration — **not** a runtime-ready factory or autonomous studio. **Identity:** planned factory **`agent_id`** rows in [../agents/registry.md](../agents/registry.md) §4.1; dependency-map entities **`mars_website_factory`**, **`website_factory_*`**, **`website_factory_workflow_v0`** ([dependency-map.md](dependency-map.md) §4) — **agent cards** are **future** work. | [../projects/mars-website-factory/README.md](../projects/mars-website-factory/README.md), [../projects/mars-website-factory/workflow-map.md](../projects/mars-website-factory/workflow-map.md); [../agents/registry.md](../agents/registry.md); [../workflows/execution-flow.md](../workflows/execution-flow.md); [dependency-map.md](dependency-map.md) |
