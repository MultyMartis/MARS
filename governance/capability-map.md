...
| C16 | **Website Factory (strategic planned)** | **Documentation-first** target for **multi-agent static website production** (intake → delivery): registries, workflow map, **Artifact Architecture Layer v0** (normalized artifact/semantics docs — **not** executable schemas), QA gates, **Gulp Frontend Agent** as documented production specialist (**legacy-bridge** in registry), **Validator** integration — **not** a runtime-ready factory or autonomous studio. **Agent identity normalization (documentation):** stable planned **`agent_id`** rows in [../agents/registry.md](../agents/registry.md) §4.1, cross-linked factory **`entity_id`** rows in [dependency-map.md](dependency-map.md) §4 (**`mars_website_factory`**, **`website_factory_*`**, **`website_factory_workflow_v0`**) — **no** runtime; **core pipeline agent cards** v0 in [../agents/cards/](../agents/cards/) (documentation-only). | [../projects/mars-website-factory/README.md](../projects/mars-website-factory/README.md), [../projects/mars-website-factory/artifact-architecture-overview-v0.md](../projects/mars-website-factory/artifact-architecture-overview-v0.md), [../projects/mars-website-factory/workflow-map.md](../projects/mars-website-factory/workflow-map.md); [../agents/registry.md](../agents/registry.md); [../workflows/execution-flow.md](../workflows/execution-flow.md); [dependency-map.md](dependency-map.md) |
...
| C16 Website Factory (strategic planned) | **Planned** specialist agents (intake, strategy, IA, blueprint, design, **Gulp Frontend**, QA lanes) as **documentation**; **Validator** for cross-cutting checks; **Artifact Architecture Layer v0** (artifact types, objective/CTA/trust/section semantics, SEO/conversion intent, frontend artifacts, QA payload concepts — **conceptual only**); **agent identity normalization** via §4.1 **`agent_id`** rows + [dependency-map.md](dependency-map.md) §4 **`entity_id`** s + **core** v0 **cards** in [../agents/cards/](../agents/cards/) (**not** runtime) | Factory workflow in [../projects/mars-website-factory/workflow-map.md](../projects/mars-website-factory/workflow-map.md); artifact overview in [../projects/mars-website-factory/artifact-architecture-overview-v0.md](../projects/mars-website-factory/artifact-architecture-overview-v0.md); align with `execution-flow` stages | **Cursor** / human execution today per `execution-model.md`; future **Execution Bridge** — **SAFE UNKNOWN** wire format for factory |
