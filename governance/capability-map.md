...
| v0 | 2026-05-11 | **C16** — **Website Factory (strategic planned)**: `projects/mars-website-factory/` doc pack; multi-agent **documentation-first** website production; **not** runtime-ready; §2 table + §3 matrix row. |
