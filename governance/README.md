...
| [mars-infrastructure-reality-v1.md](mars-infrastructure-reality-v1.md) | **Infrastructure sync v1** — canonical workspace root (`C:\MARS Phenix\AI MARS`) vs bulk storage (`C:\MARS Phenix\AI MARS STORAGE`); path reality matrix — **not** deployment/cloud topology. |
