...
| [mars-infrastructure-reality-v1.md](mars-infrastructure-reality-v1.md) | **Infrastructure sync v1** — canonical workspace root (`X:\AI MARS\`) vs bulk storage (`X:\AI MARS STORAGE\`); path reality matrix — **not** deployment/cloud topology. |
