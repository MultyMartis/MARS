...
| **Status** | **done-docs** |
| **What exists now** | `registry.md`, `agent-card-template.md`, `agent-factory-v0.md`, `agent-builder-contract.md`, folder README, [`../agents/cards/`](../agents/cards/) **Website Factory** planned-role agent cards v0 (`*-agent-v0.md`, documentation-only; full set per `registry.md` §4.1). |
...
| **What exists now** | Roadmap markdown; example `mars-core` row in project registry; **`mars-website-factory`** — **strategic planned** documentation pack under [`../projects/mars-website-factory/`](../projects/mars-website-factory/) for **multi-agent website production** (architecture/registries/workflows/**Artifact Architecture Layer v0**/**Prompt Standards Layer v0**/**Execution Semantics Layer v0**/**Reference Project Layer v0**/**Semantic Relationship Layer v0**/QA/HITL); **Reference Project Layer v0** adds reference project model, artifact tree, lifecycle, HITL governance, QA matrix, delivery packages, and multi-page orchestration semantics (**documentation only** — **not** storage, **not** a project database, **not** an orchestration engine); **Semantic Relationship Layer v0** adds cross-artifact semantic objects, dependency/inheritance/consistency rules, conceptual site semantic graph, freeze, and semantic QA docs ([overview](../projects/mars-website-factory/semantic-relationship-overview-v0.md) + linked v0 files; **not** a graph database, **not** a vector semantic engine, **not** autonomous reasoning); **Artifact Bus Layer v0** — document-first **transfer / routing / lineage / publication / consumption / governance / delivery movement / transfer QA** ([artifact-bus-overview-v0.md](../projects/mars-website-factory/artifact-bus-overview-v0.md) + linked v0 bus docs; **not** a queue, **not** an event bus, **not** Kafka/Rabbit-style transport, **not** async execution infrastructure); **Validation Runtime Model v0** ([validation-runtime-overview-v0.md](../projects/mars-website-factory/validation-runtime-overview-v0.md) + linked validation docs — **documentation only**, **not** a validator engine, **not** CI, **not** background validation, **not** Lighthouse/crawl automation); **Operational Templates Layer v0** ([operational-template-overview-v0.md](../projects/mars-website-factory/operational-template-overview-v0.md) + linked `*-template-v0.md` — reusable operational doc shells; **not** runtime automation, **not** executable workflows); **documentation-first**; **not** runtime-ready or autonomous studio. **`metabot-seo-content-agent`** — **canonical** documentation pack for **MetaBOT — SEO Content Agent** under [`../projects/metabot-seo-content-agent/`](../projects/metabot-seo-content-agent/) — **external multi-workflow AI system** (Intake / Worker / Admin; future File Export; **n8n** owns execution); **in-repo knowledge only** (incl. `exports/`, integration contracts, bridge notes); **not** a claim that MARS core **fully** integrates or dispatches production MetaBOT. **`seo-content-agent`** — **legacy** early spec / bridge tree under [`../projects/seo-content-agent/`](../projects/seo-content-agent/) (retained for migration); **do not** extend as canonical docs. **SAFE UNKNOWN:** whether experimental **Execution Bridge** / adapter code in `mars-runtime/` matches live MetaBOT endpoints or payload shapes. |
| **What is missing** | Named pilot **charter**, success metrics, and **lifecycle** entries for pilot **phase transitions**; explicit **completion** of migration from legacy `seo-content-agent/` artifacts into the canonical pack; **SAFE UNKNOWN** whether any remaining **`seo-content-agent`** material stays indefinitely as archive or is retired after migration. |
...
| 2026-05-04 | **Project documentation** — **SEO Content Agent** (`project_id` **seo-content-agent**): pack under [../projects/seo-content-agent/](../projects/seo-content-agent/); registry row in [../registry/project-registry.md](../registry/project-registry.md); **documentation-only** — **no** runtime, n8n workflows, or secrets in-repo; Stage 16 table **“What exists now”** updated accordingly. |
| 2026-05-10 | **Project documentation** — **MetaBOT — SEO Content Agent** (`project_id` **metabot-seo-content-agent**): pack under [../projects/metabot-seo-content-agent/](../projects/metabot-seo-content-agent/); registry row; **classification:** **external multi-workflow AI system** (not a simple tool / not MARS runtime owner); Stage 16 **“What exists now”** and root **README** `projects/` line updated. |
| 2026-05-11 | **SEO Content Agent folder consolidation (documentation):** `projects/metabot-seo-content-agent/` marked **canonical**; `projects/seo-content-agent/` marked **legacy**; sanitized export and bridge artifacts **copied** into canonical `exports/`, `integrations/`, and `integration-contract-legacy.md` / `legacy/`; Stage 16 table, **registry**, **capability-map**, **architecture-map**, and root **README** aligned; **no** claim of completed live runtime integration. |
| 2026-05-11 | **Website Factory registration (documentation):** `projects/mars-website-factory/` pack added — **strategic planned** multi-agent **documentation-first** website production system (**not** runtime-ready); **project-registry** row `mars-website-factory`; **capability-map** **C16**; **agents/registry** §8 cross-ref; **workflows/README**, **architecture-map**, root **README**, Stage 16 **“What exists now”** updated. |
| 2026-05-11 | **Website Factory Phase 1 registries (documentation):** [Site Type Registry v0](../projects/mars-website-factory/site-type-registry-v0.md) and [Block Registry v0](../projects/mars-website-factory/block-registry-v0.md) in `projects/mars-website-factory/` — **Markdown contracts only**; **no** runtime enforcement; **registries** / **implementation-phase-1** / pack **README** cross-links updated. |
| 2026-05-11 | **Website Factory Artifact Architecture Layer v0 (documentation):** normalized artifact/objective/CTA/trust/section/SEO/conversion semantics + frontend artifact + QA payload concept docs under [`../projects/mars-website-factory/`](../projects/mars-website-factory/) ([overview](../projects/mars-website-factory/artifact-architecture-overview-v0.md)); **not** executable schemas or automation; **capability-map** C16 + Stage 16 table + pack index aligned. |
| 2026-05-11 | **Website Factory Prompt Standards Layer v0 (documentation):** operational prompt / execution / reporting / HITL / SAFE UNKNOWN / artifact-transfer / QA / frontend discipline docs under [`../projects/mars-website-factory/`](../projects/mars-website-factory/) ([overview](../projects/mars-website-factory/prompt-standards-overview-v0.md), [structure](../projects/mars-website-factory/prompt-structure-standard-v0.md), [agent behavior](../projects/mars-website-factory/agent-prompt-behavior-v0.md), [Cursor execution](../projects/mars-website-factory/cursor-execution-standard-v0.md), [reporting](../projects/mars-website-factory/reporting-standard-v0.md), [HITL boundary](../projects/mars-website-factory/hitl-prompt-boundary-v0.md), [SAFE UNKNOWN](../projects/mars-website-factory/safe-unknown-prompt-rules-v0.md), [artifact transfer](../projects/mars-website-factory/artifact-transfer-prompt-rules-v0.md), [QA prompts](../projects/mars-website-factory/qa-prompt-rules-v0.md), [frontend discipline](../projects/mars-website-factory/frontend-prompt-discipline-v0.md)); **not** a prompt engine or runtime; **capability-map** C16 + Stage 16 “What exists now” aligned. |
| 2026-05-11 | **Website Factory Execution Semantics Layer v0 (documentation):** operational methodology and runtime-preparation architecture for stage / artifact / approval / revision / regeneration / dependency-invalidation / orchestration-signal / QA-gating / delivery lifecycle under [`../projects/mars-website-factory/`](../projects/mars-website-factory/) ([overview](../projects/mars-website-factory/execution-semantics-overview-v0.md), [stage state model](../projects/mars-website-factory/stage-state-model-v0.md), [artifact state model](../projects/mars-website-factory/artifact-state-model-v0.md), [approval semantics](../projects/mars-website-factory/approval-semantics-v0.md), [revision semantics](../projects/mars-website-factory/revision-semantics-v0.md), [regeneration semantics](../projects/mars-website-factory/regeneration-semantics-v0.md), [dependency invalidation](../projects/mars-website-factory/dependency-invalidation-v0.md), [orchestration signals](../projects/mars-website-factory/orchestration-signals-v0.md), [QA gating semantics](../projects/mars-website-factory/qa-gating-semantics-v0.md), [delivery lifecycle](../projects/mars-website-factory/delivery-lifecycle-v0.md)); **not** a runtime engine / scheduler / queue / workflow daemon / autonomous execution platform; aligned with [system-signals-dictionary.md](system-signals-dictionary.md), [`../mars-runtime/run-lifecycle-v0.md`](../mars-runtime/run-lifecycle-v0.md), and Website Factory **HITL** / **Validator** philosophy; **capability-map** C16 + Stage 16 “What exists now” aligned. |
| 2026-05-12 | **Website Factory Reference Project Layer v0 (documentation):** reference project model, artifact tree, lifecycle, HITL governance, QA matrix, delivery packages, multi-page orchestration under [`../projects/mars-website-factory/`](../projects/mars-website-factory/) — **operational reference and site-level semantics only**; **not** storage, **not** runtime persistence, **not** a workflow daemon; **capability-map** C16 + Stage 16 “What exists now” aligned. |
| 2026-05-12 | **Website Factory Semantic Relationship Layer v0 (documentation):** semantic relationship overview, object model, cross-artifact semantics, semantic dependency rules, inheritance, consistency, conceptual site semantic graph, freeze semantics, semantic QA under [`../projects/mars-website-factory/`](../projects/mars-website-factory/) — **documentation-only vocabulary**; **not** a graph database, **not** a vector engine, **not** a semantic automation/runtime layer, **not** autonomous reasoning; **dependency-map** §4 `website_factory_semantic_relationship_layer_v0`; **capability-map** C16 + Stage 16 “What exists now” aligned. |
| 2026-05-12 | **Website Factory Artifact Bus Layer v0 (documentation):** artifact bus overview, envelope model, routing rules, transfer/lineage/publication/consumption semantics, governance, delivery bus, transfer QA under [`../projects/mars-website-factory/`](../projects/mars-website-factory/) — **document-first movement discipline**; **not** a queue, **not** an event engine, **not** a runtime message bus, **not** async execution infrastructure; **dependency-map** §4 `website_factory_artifact_bus_layer_v0`; **capability-map** C16 + Stage 16 “What exists now” aligned. |
| 2026-05-12 | **Website Factory Artifact Bus Layer v0** — doc hardening: [layer-map.md](../projects/mars-website-factory/layer-map.md) §8 cross-layer placement; [artifact-bus-overview-v0.md](../projects/mars-website-factory/artifact-bus-overview-v0.md) **artifact state propagation**; [artifact-routing-rules-v0.md](../projects/mars-website-factory/artifact-routing-rules-v0.md) invalidation shorthand; [artifact-governance-rules-v0.md](../projects/mars-website-factory/artifact-governance-rules-v0.md) AGENTS link repair. **No** new runtime claims. |
| 2026-05-12 | **Website Factory Validation Runtime Model v0 (documentation):** validation semantics, lifecycle, evidence, result/failure/waiver/escalation/consistency, honesty boundary under [`../projects/mars-website-factory/`](../projects/mars-website-factory/) ([overview](../projects/mars-website-factory/validation-runtime-overview-v0.md)); **not** a validator engine, **not** CI, **not** background validation; **capability-map** C16 + Stage 16 “What exists now” aligned. |
