...
| **What exists now** | Roadmap markdown; example `mars-core` row in project registry; **documentation pack** for **`seo-content-agent`** (SEO Content Agent) under [`../projects/seo-content-agent/`](../projects/seo-content-agent/) — **documentation / planned MVP only**; **no** in-pack runtime or n8n workflows. |
