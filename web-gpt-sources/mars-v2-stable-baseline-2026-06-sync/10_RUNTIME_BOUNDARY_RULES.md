# MARS — Runtime boundary rules (Sync Pack 2026-06)
...
**Unchanged by:** Post-cleanup alignment, awareness pass, or this sync pack.
...
| ATLAS/OPS **documentation** registries | Deployed CRM/ERP/automation engines |
...
- MetaBOT / Factory / ORCA / ATLAS / OPS automated by MARS core  
- ATLAS population Waves = live business data platform  
- OPS WF pilots = production back-office automation  
- File exists → fleet operational  
- Sync pack upload → new MARS version shipped  
...
| ATLAS population registers | **Documented / human-attested** — not persistence engine |
| OPS WF-01/WF-02 pilots | **Partial human pilots** — not automation product |
...
## Cross-cutting boundary (GitGuard, IdeaBox, Incoming)

| Surface | Boundary |
|---------|----------|
| **GitGuard** | Human-invoked survivability helpers — not autonomous backup product |
| **IdeaBox** | Optional capture — not agent memory or orchestration |
| **Incoming** | Staging — not SoT until promoted |
| **Lifecycle Log** | Event history — not implementation telemetry |
...
- Awareness-aligned visibility ≠ runtime registration  

---

*Runtime boundary — sync pack 2026-06 — mythology-pressure zone; honesty mandatory.*
