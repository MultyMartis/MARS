#!/usr/bin/env python3
"""FP-0002 V8 CF-005 before/after visual parity comparison."""
...
STORAGE = Path(r"C:\MARS Phenix\AI MARS STORAGE\website-factory\fp-0002-shpigovsky-v8\cf-005-evidence")
AUDIT = Path(__file__).resolve().parents[2] / "audits" / "cf-005-specialists"

PAGES = ["home", "service-subdivision", "service-leaf"]
VIEWPORTS = ["desktop", "mobile"]
KINDS = ["specialists_crop", "specialists_context"]
...
def main() -> None:
    ...
    for page in PAGES:
        for viewport in VIEWPORTS:
            for kind in KINDS:
                ...
                suffix = "-specialists-crop.png" if kind == "specialists_crop" else "-specialists-context.png"
    ...
    payload = {
        "manifest_id": "CF-005-VISUAL-PARITY-MATRIX",
        "overall": overall,
        "matrix": matrix,
    }
    (AUDIT / "CF-005-VISUAL-PARITY-MATRIX.json").write_text(
