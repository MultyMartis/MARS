#!/usr/bin/env python3
"""FP-0002 V8 CF-006 before/after visual parity comparison."""
...
STORAGE = Path(r"C:\MARS Phenix\AI MARS STORAGE\website-factory\fp-0002-shpigovsky-v8\cf-006-evidence")
AUDIT = Path(__file__).resolve().parents[2] / "audits" / "cf-006-comfort"

PAGES = ["home", "uslugi", "uslugi-v2", "service-subdivision", "service-leaf"]
VIEWPORTS = ["desktop", "mobile"]
KINDS = ["comfort_crop", "comfort_context"]
...
def main() -> None:
    ...
    for page in PAGES:
        for viewport in VIEWPORTS:
            for kind in KINDS:
                ...
                suffix = "-comfort-crop.png" if kind == "comfort_crop" else "-comfort-context.png"
    ...
    payload = {
        "manifest_id": "CF-006-VISUAL-PARITY-MATRIX",
        "overall": overall,
        "matrix": matrix,
    }
    (AUDIT / "CF-006-VISUAL-PARITY-MATRIX.json").write_text(
