#!/usr/bin/env python3
"""FP-0002 V8 CF-004 before/after visual parity comparison."""
...
STORAGE = Path(r"C:\MARS Phenix\AI MARS STORAGE\website-factory\fp-0002-shpigovsky-v8\cf-004-evidence")
AUDIT = Path(__file__).resolve().parents[2] / "audits" / "cf-004-founder-quote"

PAGES = ["home", "services-hub", "service-subdivision", "service-leaf", "services-legacy"]
VIEWPORTS = ["desktop", "mobile"]
KINDS = ["quote_crop", "quote_context"]
...
def main() -> None:
    ...
    for page in PAGES:
        for viewport in VIEWPORTS:
            for kind in KINDS:
                ...
                suffix = "-quote-crop.png" if kind == "quote_crop" else "-quote-context.png"
    ...
    payload = {
        "manifest_id": "CF-004-VISUAL-PARITY-MATRIX",
        "overall": overall,
        "matrix": matrix,
    }
    (AUDIT / "CF-004-VISUAL-PARITY-MATRIX.json").write_text(
