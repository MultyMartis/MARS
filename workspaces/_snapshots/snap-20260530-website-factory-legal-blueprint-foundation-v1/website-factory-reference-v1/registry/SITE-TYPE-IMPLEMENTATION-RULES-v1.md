...
|-------|--------------------------|
| **SEO strategy** | [SITE-TYPE-SEO-MAPPING-v1.md](SITE-TYPE-SEO-MAPPING-v1.md) |
| **Legal generation** | [SITE-TYPE-LEGAL-MAPPING-v1.md](SITE-TYPE-LEGAL-MAPPING-v1.md) + LEGAL-IMPLEMENTATION-RULES |
| **Page architecture / IA** | [SITE-TYPE-REGISTRY-v1.md](SITE-TYPE-REGISTRY-v1.md) + matrix |
| **Design generation** | complexity, UX model from registry + matrix |
| **Frontend generation** | [SITE-TYPE-BLOCK-MAPPING-v1.md](SITE-TYPE-BLOCK-MAPPING-v1.md) |
