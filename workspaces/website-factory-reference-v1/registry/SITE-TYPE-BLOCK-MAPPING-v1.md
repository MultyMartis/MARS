...
**Статус:** documentation only — block **roles** for planning; canonical `block_id` registry in `projects/mars-website-factory/block-registry-v0.md` remains separate vocabulary until Block Registry v1 is chartered.
