...
**Связь:** [BLOCK-REGISTRY-v1.md](BLOCK-REGISTRY-v1.md), [../blueprints/BLUEPRINT-GAPS-v1.md](../blueprints/BLUEPRINT-GAPS-v1.md)
...
| Gap | Status | Notes |
|-----|--------|-------|
| SITE-TYPE-BLOCK-MAPPING-v1 update | **PENDING** | Still references v0 registry; should link to block-registry/ |
...
| FOOTER | layout (implicit) | No dedicated section partial in inventory |
...
|----------|------|------------|
| 1 | Update SITE-TYPE-BLOCK-MAPPING-v1 → v2 pointer | Registry hygiene |
