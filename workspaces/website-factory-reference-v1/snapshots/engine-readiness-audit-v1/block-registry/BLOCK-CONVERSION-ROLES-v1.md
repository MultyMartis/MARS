...
**Связь:** [BLOCK-REGISTRY-v1.md](BLOCK-REGISTRY-v1.md), [BLOCK-CATEGORY-SYSTEM-v1.md](BLOCK-CATEGORY-SYSTEM-v1.md)
...
| `FEATURES` | INFORMATIONAL | Capability / spec highlights |
| `SERVICES` | INFORMATIONAL | Service discovery |
| `CATEGORIES` | INFORMATIONAL | Catalog entry / taxonomy |
| `CATEGORY_GRID` | INFORMATIONAL | Visual category entry on home |
...
| `REVIEWS` | TRUST_SUPPORT | UGC ratings and review lists |
