...
- Blueprints reference block **roles** aligned with [SITE-TYPE-BLOCK-MAPPING-v1.md](../registry/SITE-TYPE-BLOCK-MAPPING-v1.md) (historical narrative)
- Canonical `block_id`: [block-registry/BLOCK-REGISTRY-v1.md](../block-registry/BLOCK-REGISTRY-v1.md) — **ACCEPTED** (2026-05-31); legacy `projects/mars-website-factory/block-registry-v0.md` — **not canon**
...
- **ACCEPTED:** [seo-architecture/](../seo-architecture/) — SEO Architecture Layer v2
- [SITE-TYPE-SEO-MAPPING-v2.md](../seo-architecture/SITE-TYPE-SEO-MAPPING-v2.md) — canonical site profiles
- [registry/SITE-TYPE-SEO-MAPPING-v1.md](../registry/SITE-TYPE-SEO-MAPPING-v1.md) — superseded hints only
- Blueprints `seo_requirements` **Source:** v2 mapping

**Remaining (content/generation — out of architecture scope):**

- Faceted SEO addendum for CATALOG (content charter)
- Schema template library (generation charter)
- Indexation rule engine (even as documentation checklist v2)

**Blocks SEO automation until:** Content/Generation contracts (charter) — architecture layer **ACCEPTED**.

**Note:** SEO **strategy** from Blueprint + seo-architecture/; SEO **pack generation** — future charter.
