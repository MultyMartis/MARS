...
- **Канон:** [seo-architecture/SITE-TYPE-SEO-MAPPING-v2.md](../seo-architecture/SITE-TYPE-SEO-MAPPING-v2.md), [seo-architecture/PAGE-SEO-CONTRACT-v1.md](../seo-architecture/PAGE-SEO-CONTRACT-v1.md)
- Исторические hints: [SITE-TYPE-SEO-MAPPING-v1.md](../registry/SITE-TYPE-SEO-MAPPING-v1.md) — superseded
...
- **Канон `block_id`:** [block-registry/BLOCK-REGISTRY-v1.md](../block-registry/BLOCK-REGISTRY-v1.md), [block-registry/BLUEPRINT-BLOCK-MAPPING-v1.md](../block-registry/BLUEPRINT-BLOCK-MAPPING-v1.md)
- Роли блоков (historical): [SITE-TYPE-BLOCK-MAPPING-v1.md](../registry/SITE-TYPE-BLOCK-MAPPING-v1.md) — superseded for `block_id`
- Blueprint `required_blocks` / `optional_blocks` **выравниваются** с BLUEPRINT-BLOCK-MAPPING и SITE-TYPE-BLOCK-MATRIX-v2
- Legacy external: `projects/mars-website-factory/block-registry-v0.md` — **не канон**; см. [BLUEPRINT-GAPS-v1.md](BLUEPRINT-GAPS-v1.md)
