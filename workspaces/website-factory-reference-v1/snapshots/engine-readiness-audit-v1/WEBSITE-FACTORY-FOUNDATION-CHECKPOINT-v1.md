...
> **HISTORICAL — superseded by:** [WEBSITE-FACTORY-FOUNDATION-v1-FREEZE.md](WEBSITE-FACTORY-FOUNDATION-v1-FREEZE.md), [ARCHITECTURE-FOUNDATION-v1.md](ARCHITECTURE-FOUNDATION-v1.md). Status tables below reflect **2026-05-30** point-in-time only — not current maturity. **Do not delete**; retained for audit trail.
...
**Snapshot (historical reference):** `../_snapshots/snap-20260530-website-factory-legal-blueprint-foundation-v1/` — **path not present in this repo clone** (2026-06-01). Treat as external/historical artefact if restored elsewhere; do not fabricate paths.

**Не является:** runtime, CI-валидатором, production deploy authorization, юридической экспертизой, текущим foundation status.
...
Подробности (historical): `../_snapshots/snap-20260530-website-factory-legal-blueprint-foundation-v1/reports/website-factory-legal-blueprint-foundation-checkpoint-v1.md` — **legacy path; not verified in-repo**. Current consolidation: [WEBSITE-FACTORY-FOUNDATION-v1-FREEZE.md](WEBSITE-FACTORY-FOUNDATION-v1-FREEZE.md) §10.
