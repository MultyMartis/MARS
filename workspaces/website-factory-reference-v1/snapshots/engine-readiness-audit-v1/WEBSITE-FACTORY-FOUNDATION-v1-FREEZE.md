...
**Post-freeze acceptance (не меняет freeze scope):** SEO v2 **ACCEPTED** 2026-06-01; Design → Content → Generation → Production QA → Runtime v1 **ACCEPTED** 2026-06-04 — [FOUNDATION-FINALIZATION-PASS-v1.md](FOUNDATION-FINALIZATION-PASS-v1.md). **Status register:** [WEBSITE-FACTORY-NEXT-PRIORITIES-v1.md](WEBSITE-FACTORY-NEXT-PRIORITIES-v1.md). **Next charter:** Factory Engine Architecture v1 — **NOT QUEUED**.
