...
| [WEBSITE-FACTORY-NEXT-PRIORITIES-v1.md](WEBSITE-FACTORY-NEXT-PRIORITIES-v1.md) | Authoritative status register; priorities #6–11 ACCEPTED; current workstream = Factory Engine NOT QUEUED |
