...
| `HANDOFF_READINESS` | Frontend handoff package structure; implementation QA must enforce [WF-GRID-DISCIPLINE-v1.md](../frontend-rules/WF-GRID-DISCIPLINE-v1.md) and [WF-LAYOUT-DISCIPLINE-v1.md](../frontend-rules/WF-LAYOUT-DISCIPLINE-v1.md) before visual PASS |
...
| [WF-GRID-DISCIPLINE-v1.md](../frontend-rules/WF-GRID-DISCIPLINE-v1.md) | Mandatory Frontend grid discipline (downstream of handoff) |
| [WF-LAYOUT-DISCIPLINE-v1.md](../frontend-rules/WF-LAYOUT-DISCIPLINE-v1.md) | Mandatory Frontend inner-zone layout discipline (downstream of handoff) |
