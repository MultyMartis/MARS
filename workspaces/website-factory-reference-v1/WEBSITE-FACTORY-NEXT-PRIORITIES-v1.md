...
**Версия:** v1 (checkpoint update 2026-05-30 — Legal + Blueprint foundation)  
...
**Контекст:** **Website Factory Legal Pack v1 FROZEN** (2026-05-30) — see [legal/LEGAL-PACK-v1-FREEZE.md](legal/LEGAL-PACK-v1-FREEZE.md); foundation checkpoint — [WEBSITE-FACTORY-FOUNDATION-CHECKPOINT-v1.md](WEBSITE-FACTORY-FOUNDATION-CHECKPOINT-v1.md); Triumph Legal Pilot Phase 2 complete; **SITE-TYPE-BLUEPRINTS-v1** + **BLOCK REGISTRY ALIGNMENT v1** authored — **IN PROGRESS**; next: brain polishing / consistency pass.
...
## Sequence after checkpoint

| Phase | Workstream | Status |
|-------|------------|--------|
| **Now** | Brain polishing / registry consistency pass | **NEXT** |
| **Then 1** | Page Architecture Contracts | **APPROVED — QUEUED** |
| **Then 2** | SITE-TYPE-SEO-MAPPING-v2 | **APPROVED — QUEUED** |
| **Then 3** | DESIGN SYSTEM MAPPING | **APPROVED — QUEUED** |
...
| **3** | PAGE ARCHITECTURE CONTRACTS | Page-level contracts ↔ Blueprints ↔ Block Registry | **APPROVED — QUEUED** (after consistency pass) |
| **4** | SITE-TYPE-SEO-MAPPING-v2 | SEO mapping upgrade (successor to v1 in registry) | **APPROVED — QUEUED** |
| **5** | DESIGN SYSTEM MAPPING | Design tokens / components ↔ site types | **APPROVED — QUEUED** |
...
## Priority 3 — PAGE ARCHITECTURE CONTRACTS

**Goal:** Page-level architecture contracts bridging Blueprints, Block Registry, and frontend page structure.

**Inputs:** Blueprints v1, Block Registry v1, Site Type Registry v1.

**Not in scope:** Runtime page generator; Triumph workspace changes.

**Status:** **APPROVED — QUEUED** — after brain polishing / consistency pass.

---

## Priority 4 — SITE-TYPE-SEO-MAPPING-v2
...
## Priority 5 — DESIGN SYSTEM MAPPING
...
*Priorities version: v1 (Legal + Blueprint foundation checkpoint 2026-05-30). Canonical location: `workspaces/website-factory-reference-v1/`.*
