...
**Связь:** [DESIGN-SYSTEM-MAPPING-v1.md](DESIGN-SYSTEM-MAPPING-v1.md), [page-block-validation/PAGE-BLOCK-VALIDATION-RULES-v1.md](../page-block-validation/PAGE-BLOCK-VALIDATION-RULES-v1.md), [seo-architecture/SEO-IMPLEMENTATION-RULES-v1.md](../seo-architecture/SEO-IMPLEMENTATION-RULES-v1.md), [frontend-rules/WF-GRID-DISCIPLINE-v1.md](../frontend-rules/WF-GRID-DISCIPLINE-v1.md), [frontend-rules/WF-LAYOUT-DISCIPLINE-v1.md](../frontend-rules/WF-LAYOUT-DISCIPLINE-v1.md)
...
8. **WF Grid Discipline** — section/container separation frozen before Frontend ([WF-GRID-DISCIPLINE-v1.md](../frontend-rules/WF-GRID-DISCIPLINE-v1.md); promoted from SITE-001 WF-V3)  
9. **WF Layout Discipline** — inner-zone layout authority frozen before Frontend ([WF-LAYOUT-DISCIPLINE-v1.md](../frontend-rules/WF-LAYOUT-DISCIPLINE-v1.md); promoted from SITE-001 WF-V3 Layout Review)
