"""GROUP 4 operator checkpoint backup from committed GROUP 3 HEAD."""
import hashlib
import io
import os
import shutil
...
zip_path = out_dir / "FP-0002-V7-PG-004-SERVICE-LEAF-GROUP-4-BEFORE-SOURCE.zip"
staging = out_dir / "_staging-pg004-group4"
...
manifest = f"""# BACKUP-MANIFEST — FP-0002 PG-004 SERVICE LEAF GROUP 4
...
- HEAD: {head}
- group_3_commit: {head}
- task_scope: FP-0002-PG-004 SERVICE LEAF GROUP 4 (four-direction program block)
- timestamp_utc: {ts}
...
4. GROUP 3 commit baseline: `{head}`.
5. This backup is pre–Service Leaf GROUP 4 implementation.
""",
    encoding="utf-8",
)
