...
zip_path = out_dir / "FP-0002-V7-PG-004-SERVICE-LEAF-GROUP-1-BEFORE-SOURCE.zip"
staging = out_dir / "_staging-pg004-group1"
...
manifest = f"""# BACKUP-MANIFEST — FP-0002 PG-004 SERVICE LEAF GROUP 1

- repository: C:\\MARS Phenix\\AI MARS
- workspace: workspaces/fp-0002-shpigovsky-v7
- branch: {branch}
- HEAD: {head}
- planning_commit: 624492b3
...
- task_scope: FP-0002-PG-004 SERVICE LEAF GROUP 1 (header through cta-01)
- timestamp_utc: {ts}
...
4. Service Subdivision reference remains commit `eb10c71b` / tag `fp-0002-v7-service-subdivision-internal-page-reference-01`.
5. This backup is pre–Service Leaf GROUP 1 implementation.
""",
    encoding="utf-8",
)
