# FP-0002 V7 Restore Instructions
...
1. Create a clean directory outside active V7 workspaces.
2. Extract `FP-0002-V7-PRE-FINAL-POLISH-OPERATOR-STABLE-01-SOURCE.zip`.
3. Verify file checksums against `CHECKSUMS-SHA256.txt`.
4. Place workspace under `workspaces/fp-0002-shpigovsky-v7/` **or** keep isolated for test restore.
...
- [ ] Favicon assets exist in dist
- [ ] Social preview image exists in dist
