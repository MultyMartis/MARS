# FP-0002 V6 Block Inventory (JPG-grounded)
...
| CMP-007 clinical-image-square-4 | BLOCK-005 | SECTION-002 | NOT STARTED · draft archived only |
| CMP-008+ | BLOCK-009+ | SECTION-003+ | NOT STARTED |

**Active dependency chain:** CMP-001–CMP-003 only. CMP-005/CMP-007 removed from active build; retained as draft research in archive.

**Variable-First note:** Foundation mechanics verified on aborted noncanonical block attempt; no canonical post-Hero content section approved.
