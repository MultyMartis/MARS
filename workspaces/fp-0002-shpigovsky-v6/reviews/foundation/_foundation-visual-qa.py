"""FP-0002 V6 global foundation — SECTION-001 visual capture @ 1398px."""
...
OUT_PNG = Path(__file__).resolve().parent / "visual" / "FP-0002-V6-GLOBAL-FOUNDATION-SECTION-001.png"
OUT_JSON = Path(__file__).resolve().parent / "visual" / "_foundation-computed-styles.json"
