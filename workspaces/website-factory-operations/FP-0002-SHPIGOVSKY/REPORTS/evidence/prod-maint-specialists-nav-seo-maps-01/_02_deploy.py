# -*- coding: utf-8 -*-
"""Deploy exact files for specialists nav + SEO meta + contacts maps wave."""
...
WT = Path(
    r"X:\AI MARS\worktrees\fp0002-specialists-nav-seo-maps-01\workspaces"
...
UPLOADS = [
    ...
    (
        WT / "WORDPRESS/plugins/shpigovsky-core/src/Typography/TypographyFilters.php",
        f"{DOCROOT}/wp-content/plugins/shpigovsky-core/src/Typography/TypographyFilters.php",
    ),
    (
    ...
    (
        WT / "WORDPRESS/theme/shpigovsky/inc/seo-entity-meta.php",
        f"{DOCROOT}/wp-content/themes/shpigovsky/inc/seo-entity-meta.php",
    ),
    (
        WT / "WORDPRESS/theme/shpigovsky/inc/yandex-map-embed.php",
        f"{DOCROOT}/wp-content/themes/shpigovsky/inc/yandex-map-embed.php",
    ),
    (
        WT / "WORDPRESS/theme/shpigovsky/inc/contacts-helpers.php",
        f"{DOCROOT}/wp-content/themes/shpigovsky/inc/contacts-helpers.php",
    ),
    (
        WT / "WORDPRESS/theme/shpigovsky/template-parts/contacts/location-card.php",
        f"{DOCROOT}/wp-content/themes/shpigovsky/template-parts/contacts/location-card.php",
    ),
    (
        WT / "WORDPRESS/acf-json/group_fp02_page_contacts.json",
...
def main() -> None:
    ...
    if parsed.get("core_version") != "0.3.29-specialists-nav-seo-maps-01":
