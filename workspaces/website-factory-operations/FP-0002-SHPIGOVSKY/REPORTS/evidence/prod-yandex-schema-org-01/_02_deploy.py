# -*- coding: utf-8 -*-
"""Deploy exact files for Yandex Schema.org structured-data wave."""
...
WT = Path(
    r"X:\AI MARS\worktrees\fp0002-yandex-schema-01\workspaces"
    r"\website-factory-operations\FP-0002-SHPIGOVSKY"
)
LAYER_B = Path(
    r"X:\AI MARS STORAGE\deployment-packs\fp-0002\prod-yandex-schema-org-01"
)
STAMP = datetime.now(timezone.utc).strftime("%Y%m%d%H%M%S")
EXPECTED_CORE = "0.3.30-yandex-schema-org-01"

STRUCTURED = WT / "WORDPRESS/plugins/shpigovsky-core/src/StructuredData"
...
UPLOADS = [
    ...
    (
        STRUCTURED / "EntityIds.php",
        f"{DOCROOT}/wp-content/plugins/shpigovsky-core/src/StructuredData/EntityIds.php",
    ),
    (
        STRUCTURED / "DataReaders.php",
        f"{DOCROOT}/wp-content/plugins/shpigovsky-core/src/StructuredData/DataReaders.php",
    ),
    (
        STRUCTURED / "OpeningHoursParser.php",
        f"{DOCROOT}/wp-content/plugins/shpigovsky-core/src/StructuredData/OpeningHoursParser.php",
    ),
    (
        STRUCTURED / "OrganizationBuilder.php",
        f"{DOCROOT}/wp-content/plugins/shpigovsky-core/src/StructuredData/OrganizationBuilder.php",
    ),
    (
        STRUCTURED / "BreadcrumbBuilder.php",
        f"{DOCROOT}/wp-content/plugins/shpigovsky-core/src/StructuredData/BreadcrumbBuilder.php",
    ),
    (
        STRUCTURED / "GraphBuilder.php",
        f"{DOCROOT}/wp-content/plugins/shpigovsky-core/src/StructuredData/GraphBuilder.php",
    ),
    (
        STRUCTURED / "StructuredData.php",
        f"{DOCROOT}/wp-content/plugins/shpigovsky-core/src/StructuredData/StructuredData.php",
    ),
]
...
def main() -> None:
    ...
    remote_dir = f"{DOCROOT}/wp-content/plugins/shpigovsky-core/src/StructuredData"
    try:
