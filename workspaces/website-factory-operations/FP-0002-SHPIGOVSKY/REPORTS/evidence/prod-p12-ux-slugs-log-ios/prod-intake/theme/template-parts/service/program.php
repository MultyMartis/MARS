...
if ( 'subdivision' === $variant ) {
	// V9-07A01: card title/URL/image/text from live Treatment Program children.
	// Legacy service programme_items postmeta retained but not read for cards.
	$items = shpigovsky_get_service_subdivision_programme_fallback_items();
...
// Leaf / residual: auto-source Treatment Program children (legacy programme_items dormant).
