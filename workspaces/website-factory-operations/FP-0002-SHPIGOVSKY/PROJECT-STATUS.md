...
**Last updated:** 2026-08-20 (PROD-P18H **PASS** — privacy/retention decisions + launch-tail readiness)

**Current WordPress phase:** `FP-0002 PROD-P18H PRIVACY / RETENTION DECISIONS + LAUNCH-TAIL READINESS` — **PASS**. Fresh production intake (SSH + public probes) verified Cookie Policy factually matches runtime; consent evidence **browser-only**; consent lifetime **365d**; UTM `sessionStorage` documented; lead retention **730d recommended** (production config remains **0** — no historical purge). Launch-tail **READY WITH NON-BLOCKING LEGAL NOTE**. Indexing **OPEN — HUMAN-APPROVED**; P18G guard unchanged. Sitemap `https://shpigovsky.ru/wp-sitemap.xml` verified. Report: `REPORTS/REPORT-FP-0002-PROD-P18H-PRIVACY-RETENTION-DECISIONS.md`. Evidence: `REPORTS/evidence/prod-p18h-privacy-decisions/`. Open items: `REPORTS/OPEN-ITEMS-FP-0002-AFTER-P18H.md`. Next: **P18I** sitemap + final crawl.
