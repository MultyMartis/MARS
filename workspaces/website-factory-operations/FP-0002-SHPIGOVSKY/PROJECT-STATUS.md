...
**Last updated:** 2026-07-10 (V9-06E29B-FIX2C ACF location rule repair PARTIAL PASS)

**Current WordPress phase:** V9-06E29B-FIX2C ACF Location Rule Repair **PARTIAL PASS** — hub/child ACF groups with location rules; **9→1** page #11 group attachment; duplicate institutional DB cleanup; frontend parity PASS; operator admin screenshot recheck required. V9-06E29B-FIX O-Centre Admin UI Field Visibility **PASS** — stale ACF DB/JSON repaired; page #11 edit screen exposes full `/o-centre/` block model + shared-block guidance; frontend parity PASS; placeholders #12–16 untouched. V9-06E29B O-Centre Admin Parity Implementation **PASS** — page #11 hero_media/founder/clinic ACF seeded + template binding. E29A Placeholder Pages And O-Centre Admin Parity Decision Audit **PASS** @ remote baseline `49ffdafe` — 5 institutional child placeholders classified KEEP_PLACEHOLDER_FOR_LATER_PORT. **Next: CREATE_V9_06E29B_OPERATOR_OCENTRE_ADMIN_RECHECK_TASK**. Reports: `WORDPRESS/reports/FP-0002-V9-06E29B-FIX-OCENTRE-ADMIN-UI-FIELD-VISIBILITY-REPORT-v1.md`, `WORDPRESS/reports/FP-0002-V9-06E29A-PLACEHOLDER-PAGES-AND-OCENTRE-ADMIN-PARITY-DECISION-AUDIT-REPORT-v1.md`, `WORDPRESS/reports/FP-0002-V9-06E29B-OCENTRE-ADMIN-PARITY-IMPLEMENTATION-REPORT-v1.md`. Prior E28: PASS @ `7457e50d` ancestor.
