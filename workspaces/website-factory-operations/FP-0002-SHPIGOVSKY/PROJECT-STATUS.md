...
**Last updated:** 2026-09-13 (Service child-cards adaptive layout + default section title 01)
...
**Current production-code phase:** `FP-0002 SERVICE CHILD-CARDS ADAPTIVE LAYOUT 01` — **PASS_WITH_RESIDUALS**. Service-stack child tile block: content-aware CSS Grid, optional deterministic featured image card (first child with service-owned image), compact title-only cards, default heading `Состояния, которые мы лечим` when ACF override empty. Scoped CSS only. No editorial DB rewrite; robots/indexing unchanged. Report: `REPORTS/REPORT-FP-0002-SERVICE-CHILD-CARDS-ADAPTIVE-LAYOUT-01.md`. Evidence: `REPORTS/evidence/prod-maint-service-child-cards-01/`.
