...
**Primary authority rule (E10/E11/E12):** Static V9 HTML (`fp-0002-shpigovsky-v9/src/` + `dist/`) is primary layout/copy authority. WordPress must achieve direct section-stack parity — not semantic PHP reconstruction. No visual PASS without screenshot pair. Alcohol leaf is first route with direct V9 port (E12).
