...
**Surface:** `WORDPRESS/`  
**Status:** V9-06D8-A SITE OPTIONS SEED BLOCKED — planning gates PASS; apply blocked (DB/HTTP unavailable)
**Classification:** CONTENT MODEL RUNTIME DELIVERED — D8-A ALLOWLIST/PAYLOAD READY — OPTIONS NOT SEEDED — RE-RUN APPLY AFTER LOCAL STACK UP
