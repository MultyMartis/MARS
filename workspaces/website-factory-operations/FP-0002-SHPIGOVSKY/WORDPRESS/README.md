...
**Surface:** `WORDPRESS/`  
**Status:** V9-06E29B-FIX2C ACF Location Rule Repair **PARTIAL PASS** — split `group_fp02_page_institutional` into `group_fp02_page_ocentre_hub` (page #11) + `group_fp02_page_institutional_child` (pages #12–16) using supported ACF location rules; removed invalid field conditional logic (`param: page`); cleaned **9** duplicate institutional DB groups; page #11 admin API PASS + HTML label evidence; operator screenshot recheck required. V9-06E29B-FIX O-Centre Admin UI Field Visibility **PASS** — ACF DB/JSON synced with `FieldGroups.php`; page #11 admin exposes hero/founder/clinic/narrative/who-we-treat/approach/program/infrastructure + shared-block guidance; child repeaters hidden on hub; frontend parity PASS. V9-06E29A Placeholder Pages And O-Centre Admin Parity Decision Audit **PASS** @ `49ffdafe` — 5/5 named placeholders inventoried; `/o-centre/` public PASS / admin PARTIAL at audit time. V9-06E29B O-Centre Admin Parity Implementation **PASS** @ `ee6c8d8b` — page #11 hero_media/founder/clinic ACF seeded + template binding; shared blocks documented; frontend parity PASS; placeholders #12–16 untouched. Evidence: `validation/v9-06e29b-fix-ocentre-admin-ui-field-visibility/`, `validation/v9-06e29a-placeholder-pages-and-ocentre-admin-parity-decision-audit/`, `validation/v9-06e29b-ocentre-admin-parity-implementation/`. Reports: `reports/FP-0002-V9-06E29B-FIX-OCENTRE-ADMIN-UI-FIELD-VISIBILITY-REPORT-v1.md`, `reports/FP-0002-V9-06E29A-PLACEHOLDER-PAGES-AND-OCENTRE-ADMIN-PARITY-DECISION-AUDIT-REPORT-v1.md`, `reports/FP-0002-V9-06E29B-OCENTRE-ADMIN-PARITY-IMPLEMENTATION-REPORT-v1.md`. NEXT: **CREATE_V9_06E29B_OPERATOR_OCENTRE_ADMIN_RECHECK_TASK**. Prior E28: PASS @ `7457e50d` ancestor.
