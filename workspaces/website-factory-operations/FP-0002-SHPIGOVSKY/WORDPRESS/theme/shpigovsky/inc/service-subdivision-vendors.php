...
/**
 * Whether the current request is a service subdivision layout page with sliders.
 *
 * @return bool
 */
function shpigovsky_is_service_subdivision_slider_page() {
	...
	return 'subdivision' === shpigovsky_resolve_service_layout_variant();
}

/**
 * Enqueue Swiper vendor on subdivision routes for specialists/reviews slider parity.
 */
function shpigovsky_enqueue_service_subdivision_vendors() {
	if ( ! shpigovsky_is_service_subdivision_slider_page() ) {
		return;
	}
