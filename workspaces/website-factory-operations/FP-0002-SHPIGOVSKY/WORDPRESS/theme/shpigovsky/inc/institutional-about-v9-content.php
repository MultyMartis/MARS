...
function shpigovsky_get_v9_about_program_copy() {
	return array(
		...
		'lead'    => 'Боль бывает очень похожей у разных людей — но путь к восстановлению всегда индивидуален. Поэтому в центре нет одной «стандартной» программы для всех.',
		'intro'   => 'Каждый человек приходит со своей историей. Мы собираем программу из направлений, которые реально нужны в конкретной ситуации.',
		'intro2'  => 'Направления можно комбинировать и уточнять после консультации — с учётом целей, состояния и формата помощи.',
		'items'   => array(
			array(
