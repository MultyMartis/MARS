<?php
/**
 * About hub vendor enqueue — Swiper, Fancybox, Inputmask (V9-06E26A).
 *
 * @package Shpigovsky
 */
...
/**
 * Enqueue interaction vendors on /o-centre/ hub page.
 */
function shpigovsky_enqueue_institutional_vendors() {
...
add_action( 'shpigovsky_enqueue_theme_assets', 'shpigovsky_enqueue_institutional_vendors' );
