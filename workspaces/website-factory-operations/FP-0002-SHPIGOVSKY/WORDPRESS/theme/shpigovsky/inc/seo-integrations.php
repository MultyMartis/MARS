...
function shpigovsky_sitemap_admin_urls_html() {
	...
	$note     = $indexing
		? '<p>Индексация сайта в настройках WordPress сейчас <strong>разрешена</strong>.</p>'
		: '<p><strong>Важно:</strong> сейчас сайт закрыт от индексации (временный домен / «Видимость для поисковых систем»). Генерация карты готова, но массовое индексирование ещё не включено — это отдельный шаг при переезде на shpigovsky.ru.</p>';
