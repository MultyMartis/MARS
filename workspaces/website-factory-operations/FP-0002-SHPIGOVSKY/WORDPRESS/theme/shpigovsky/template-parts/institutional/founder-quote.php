...
$context = shpigovsky_get_about_founder_quote_context( $page_id );
?>
<section data-reveal class="founder-quote founder-quote--variant-b founder-quote--institutional-context" aria-labelledby="founder-quote-label">
	<div class="container">
		<div class="founder-quote__layout">
			...
			<figure class="founder-quote__figure">
				<span class="visually-hidden" id="founder-quote-label"><?php echo esc_html( $context['label'] ); ?></span>
				<img
					class="founder-quote__photo"
					src="<?php echo esc_url( $context['photo']['url'] ); ?>"
					width="<?php echo (int) $context['photo']['width']; ?>"
					height="<?php echo (int) $context['photo']['height']; ?>"
					alt="<?php echo esc_attr( $context['photo']['alt'] ); ?>"
				>
				<figcaption class="founder-quote__author">
					<p class="founder-quote__name"><?php echo esc_html( $context['name'] ); ?></p>
					<p class="founder-quote__role"><?php echo esc_html( $context['role'] ); ?></p>
					<button
						type="button"
						class="btn founder-quote__cta"
						data-modal-open="consultation"
						data-modal-source="founder-quote"
						data-modal-title="<?php esc_attr_e( 'Записаться на консультацию', 'shpigovsky' ); ?>"
						data-modal-submit-text="<?php esc_attr_e( 'Записаться на консультацию', 'shpigovsky' ); ?>"
					><?php echo esc_html( $context['cta_label'] ); ?></button>
				</figcaption>
			</figure>
		</div>
	</div>
