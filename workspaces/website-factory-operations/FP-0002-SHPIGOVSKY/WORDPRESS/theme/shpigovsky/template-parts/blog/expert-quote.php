...
$quote = shpigovsky_get_blog_archive_expert_quote();
?>
<section data-reveal class="blog-expert-quote" aria-labelledby="blog-expert-quote-label">
	<div class="container blog-expert-quote__container">
		<h2 class="blog-expert-quote__heading visually-hidden" id="blog-expert-quote-label"><?php esc_html_e( 'Слово спецу', 'shpigovsky' ); ?></h2>
		<div class="blog-expert-quote__layout">
			<blockquote class="blog-expert-quote__quote">
				<svg class="blog-expert-quote__mark" width="70" height="55" viewBox="0 0 70 55" aria-hidden="true" focusable="false">
				...
				<p class="blog-expert-quote__text"><?php echo esc_html( $quote['quote_text'] ); ?></p>
			</blockquote>

			<figure class="blog-expert-quote__figure">
				<img
					class="blog-expert-quote__photo"
					src="<?php echo esc_url( $quote['photo_url'] ); ?>"
					width="<?php echo esc_attr( $quote['photo_width'] ); ?>"
					height="<?php echo esc_attr( $quote['photo_height'] ); ?>"
					alt="<?php echo esc_attr( $quote['photo_alt'] ); ?>"
					loading="lazy"
					decoding="async"
				>
				<div class="blog-expert-quote__card">
					<p class="blog-expert-quote__name"><?php echo esc_html( $quote['name'] ); ?></p>
					<p class="blog-expert-quote__role"><?php echo esc_html( $quote['role'] ); ?></p>
					<button
						type="button"
						class="btn blog-expert-quote__cta"
						data-modal-open="consultation"
						data-modal-source="blog-expert-quote"
						data-modal-title="<?php echo esc_attr( $quote['cta_label'] ); ?>"
						data-modal-submit-text="<?php echo esc_attr( $quote['cta_label'] ); ?>"
					><?php echo esc_html( $quote['cta_label'] ); ?></button>
				</div>
			</figure>
		</div>
	</div>
