<?php
/**
 * Blog single conclusion / founder quote — V9-06E26C.
 *
 * @package Shpigovsky
 */
...
$conclusion = shpigovsky_get_article_conclusion( get_the_ID() );

if ( empty( $conclusion['quote'] ) ) {
	return;
}

$heading = $conclusion['heading'];
$quote   = $conclusion['quote'];
$photo   = $conclusion['photo'];
?>
<section class="blog-article-conclusion" aria-labelledby="blog-article-conclusion-heading">
	<div class="blog-article-conclusion__container container">
		<h2 class="blog-article-conclusion__heading" id="blog-article-conclusion-heading"><?php echo esc_html( $heading ); ?></h2>
	</div>
	<section class="founder-quote founder-quote--variant-b" aria-labelledby="blog-article-founder-quote-label">
		<div class="container">
			<div class="founder-quote__layout">
				<blockquote class="founder-quote__quote">
					...
					<p class="founder-quote__text"><span><?php echo wp_kses_post( $quote ); ?></span></p>
				</blockquote>
				<figure class="founder-quote__figure">
					<span class="visually-hidden" id="blog-article-founder-quote-label"><?php esc_html_e( 'Заключение автора', 'shpigovsky' ); ?></span>
					<img
					...
					<figcaption class="founder-quote__author">
						<p class="founder-quote__name"><?php echo esc_html( $conclusion['name'] ); ?></p>
						<p class="founder-quote__role"><?php echo esc_html( $conclusion['role'] ); ?></p>
					</figcaption>
				</figure>
			</div>
		</div>
