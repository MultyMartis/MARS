<?php
/**
 * Service alcohol-special stack orchestrator.
 *
 * @package Shpigovsky
 */
...
?>
<article <?php post_class( 'shpigovsky-skeleton__service shpigovsky-skeleton__service--alcohol' ); ?>>
	<?php
	...
	get_template_part( 'template-parts/service/comfort' );
