...
require_once SHPIGOVSKY_THEME_DIR . '/inc/fancybox-vendors.php';
...
require_once SHPIGOVSKY_THEME_DIR . '/inc/services-hub-vendors.php';
...
require_once SHPIGOVSKY_THEME_DIR . '/inc/service-section-helpers.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/service-general-helpers.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/service-template-loader.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/yandex-map-embed.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/contacts-helpers.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/reviews-helpers.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/blog-helpers.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/pagination-seo.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/seo-integrations.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/seo-entity-meta.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/sitemap-helpers.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/search-helpers.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/reusable-blocks-helpers.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/specialist-helpers.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/institutional-about-v9-content.php';
require_once SHPIGOVSKY_THEME_DIR . '/inc/program-direction-helpers.php';
