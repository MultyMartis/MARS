/**
 * FP-0002 V9-06E57-FIX02 — scroll-progress lifebuoy parallax
 *
...
(function () {
  ...
  function applyState(metrics) {
    ...
    root.style.setProperty('--fp02-lb-x', x.toFixed(3) + '%');
    root.style.setProperty('--fp02-lb-y', y.toFixed(3) + 'vh');
    root.style.setProperty('--fp02-lb-scale', scale.toFixed(4));
    root.style.setProperty('--fp02-lb-rotate', rotate.toFixed(3) + 'deg');
