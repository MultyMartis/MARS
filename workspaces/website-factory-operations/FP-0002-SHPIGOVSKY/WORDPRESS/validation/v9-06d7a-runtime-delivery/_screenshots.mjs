/**
 * FP-0002 V9-06D7-A — post-delivery screenshot capture via Chrome headless.
 */
...
for (const vp of viewports) {
  for (const route of routes) {
    const file = `${vp.name}-${route.slug}-after-d7a.png`;
...
const screenshotManifest = {
  ...
  evidence_root: 'WORDPRESS/validation/v9-06d7a-runtime-delivery/screenshots/',
  browser: chrome,
...
const visualResult = {
  ...
  styled_shell_visible: captured > 0,
