...
$state_before = MailOps::state();
echo "[P18D] State before activation: " . $state_before . "\n";

if ( MailOps::STATE_VERIFIED_READY !== $state_before ) {
...
$ok = MailOps::activate_delivery();
if ( $ok ) {
	echo "[P18D] DELIVERY ACTIVATED.\n";
	echo "  State is now: " . MailOps::state() . "\n";
	echo "  MailOps::should_suppress() = " . ( MailOps::should_suppress() ? 'true (suppressed)' : 'false (mail flows)' ) . "\n";
	echo "\n";
