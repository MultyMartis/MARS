/**
 * FP-0002 V9-06D7-B — post-delivery screenshot capture via Chrome headless.
 */
...
for (const vp of viewports) {
  for (const route of routes) {
    const file = `${vp.name}-${route.slug}-after-d7b.png`;
...
const screenshotManifest = {
  ...
  evidence_root: 'WORDPRESS/validation/v9-06d7b-runtime-delivery/screenshots/',
  browser: chrome,
...
const visualResult = {
  ...
  home_d7b_sections_visible: captured > 0,
  ...
  deferred_sections_12_of_20: true,
