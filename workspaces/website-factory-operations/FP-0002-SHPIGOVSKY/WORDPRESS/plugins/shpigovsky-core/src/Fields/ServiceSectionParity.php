		...
		return array(
			...
			'fields'                => array(
				...
				array(
					...
					'type'              => 'repeater',
					'instructions'      => __( 'До 6 карточек. Заполнено демо-контентом. При необходимости замените вручную. Если очистить, карточки на сайте могут скрыться. Аварийный резерв — только технический запас.', 'shpigovsky-core' ),
					'required'          => 0,
					'conditional_logic' => self::when_section(),
					'layout'            => 'row',
					'button_label'      => __( 'Добавить карточку', 'shpigovsky-core' ),
