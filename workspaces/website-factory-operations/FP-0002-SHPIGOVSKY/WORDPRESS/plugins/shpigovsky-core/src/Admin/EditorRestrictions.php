...
final class EditorRestrictions implements ModuleInterface {
	...
	public static function register() {
		...
		add_action( 'add_meta_boxes', array( __CLASS__, 'remove_specialist_clutter' ), 30 );
	...
	public static function filter_block_editor( $use, $post_type ) {
		if ( Service::POST_TYPE === $post_type || Specialist::POST_TYPE === $post_type ) {
			return false;
		}
	...
	/**
	 * PROD-P11: keep Specialist editor free of page-like clutter.
	 */
	public static function remove_specialist_clutter() {
		remove_meta_box( 'commentsdiv', Specialist::POST_TYPE, 'normal' );
		remove_meta_box( 'commentstatusdiv', Specialist::POST_TYPE, 'normal' );
		remove_meta_box( 'trackbacksdiv', Specialist::POST_TYPE, 'normal' );
		remove_meta_box( 'postcustom', Specialist::POST_TYPE, 'normal' );
		remove_meta_box( 'revisionsdiv', Specialist::POST_TYPE, 'normal' );
		remove_meta_box( 'postexcerpt', Specialist::POST_TYPE, 'normal' );
		remove_meta_box( 'authordiv', Specialist::POST_TYPE, 'normal' );
	}
