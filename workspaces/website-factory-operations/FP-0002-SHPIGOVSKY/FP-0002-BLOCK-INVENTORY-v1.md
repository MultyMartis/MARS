...
| **PG-005** About | 001, 002, 005, 006, 007ˢ, 036, 037, 038, 020, 022, 023, 026, 015, 019, 003 + 004 |
...
**Reconciliation 2026-06-29:** PG-005 row corrected — removed `018`. BLK-018 row (line 80) never listed PG-005; prior PG-005 row was inconsistent with Spig_v1.2 O-Centre Figma (frame `1:2310` is who-we-treat, not steps).
