...
| О центре | `src/pages/o-centre.html` | `/o-centre/` | `dist/o-centre.html` | Header + footer | **IMPLEMENTED_PENDING_OPERATOR_REVIEW** — 2026-06-29; see `audits/o-centre-implementation/` |
