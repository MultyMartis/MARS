#!/usr/bin/env python3
"""FP-0002 V8 CF-007 post-implementation hash guard."""
...
def main() -> None:
    pre = json.loads((AUDIT / "cf-007-source-hash-guard-pre.json").read_text(encoding="utf-8"))
    post = {
    ...
    (AUDIT / "cf-007-source-hash-guard-post.json").write_text(
