#!/usr/bin/env python3
"""FP-0002 V8 CF-009 post-implementation hash guard."""
...
def main() -> None:
    pre = json.loads((AUDIT / "cf-009-source-hash-guard-pre.json").read_text(encoding="utf-8"))
    post = {
    ...
    (AUDIT / "cf-009-source-hash-guard-post.json").write_text(
